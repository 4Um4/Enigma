...
| Я не могу оторвать от тебя взгляд. | FLIRT | build_rapport | assert | ('FLIRT', 'build_rapport', 'UNDEFINED', False, False) |
...
| Phrase | Action | Social Intent | Speech Act | Causal Class |
|--------|--------|---------------|------------|--------------|
| Всё будет хорошо, не плачь. | UNCERTAIN | comfort | compliment | ('UNCERTAIN', 'comfort', 'player', False, False) |
