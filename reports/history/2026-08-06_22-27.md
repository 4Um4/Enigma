# ENIGMA Session State — 2026-08-06 22:27
...
_Сессия: 0.4 мин | Тиков: 21 | LLM-вызовов: 61_
...
| **CVS** (Causal Velocity) | 148.76/мин | ↑ +148.8 | ✅ 148.76/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 140 (idx=6.67) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 127 (broken=0) | → | ✅ Давление доходит |
| **NEI** (Need Urgency) | 0 (critical=0) | → | ⚠️ NPC слишком комфортны (NEI=0) |
| **DRI** (Response Integrity) | 79% | ↓ -21.3% | ⚠️ Деградация: 13 провалов LLM. Ответы нестабильны |
| **DPI** (Dialogue Pipeline) | 100% | → +0.0% | ✅ Конвейер диалогов стабилен |

_История: `reports/dna_history.jsonl` — 927 записей_
...
**Tick Pipeline:**
Тиков: 21 | Decisions > 0: 1/21 | LLM: 61 вызовов / 44 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.760 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | ambush | 0.239 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | flee | 0.240 | ❌ | x=10.5 y=6.5 | ❌ |
| merchant_goran | request_service | 0.669 | ❌ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.278 | ❌ | None | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.249 | ❌ | x=10.5 y=6.5 | ❌ |
