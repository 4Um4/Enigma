# ENIGMA Session State — 2026-05-30 10:52
...
_История: `reports/dna_history.jsonl` — 225 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.316 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.505 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.445 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.425 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.410 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.196 | ❌ узел не найден | None | ❌ |
