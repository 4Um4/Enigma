# ENIGMA Session State — 2026-09-24 23:13
...
_Сессия: 6.6 мин | Тиков: 107 | LLM-вызовов: 22_
...
| **CVS** (Causal Velocity) | 3.33/мин | ↓ -15.7 | ✅ 3.33/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 640 (idx=5.98) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 742 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1203 записей_
...
**Tick Pipeline:**
Тиков: 107 | Decisions > 0: 1/107 | LLM: 22 вызовов / 24 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.202 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | talk | 1.245 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.452 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | flee | 0.794 | ✅ | x=10.5 y=3.0 | ❌ |
| player | trade | 0.715 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.450 | ✅ | x=17.9 y=5.0 | ❌ |
| thief_shadow | observe | 0.695 | ✅ | x=11.5 y=11.0 | ❌ |
