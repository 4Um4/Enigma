# ENIGMA Session State — 2026-05-28 21:33
...
_История: `reports/dna_history.jsonl` — 118 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.685 | ✅ | None | ❌ |
| guard_borko | FLEE | 0.809 | ✅ | x=2.2 y=1.8 | ❌ |
| maid_lusya | FLEE | 1.619 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.841 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.917 | ✅ | None | ❌ |
