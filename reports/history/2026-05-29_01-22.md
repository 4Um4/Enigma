# ENIGMA Session State — 2026-05-29 01:22
...
_История: `reports/dna_history.jsonl` — 150 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.097 | ✅ | None | ❌ |
| guard_borko | FLEE | 1.108 | ✅ | None | ❌ |
| maid_lusya | FLEE | 1.691 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.032 | ✅ | x=5.7 y=6.4 | ❌ |
| tavern_keeper_tornin | FLEE | 1.173 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.770 | ❌ узел не найден | None | ❌ |
