# ENIGMA Session State — 2026-06-04 00:43
...
| **NPI** (NPC Pipeline) | 33% | ↓ -16.7% | ⚠️ 2/6 NPC с координатами: spatial pipeline частично сломан |
...
_История: `reports/dna_history.jsonl` — 326 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ATTACK | 0.951 | ❌ | None | ❌ |
| guard_borko | ATTACK | 1.328 | ❌ | x=19.4 y=3.1 | ❌ |
| maid_lusya | OBSERVE | 1.300 | ❌ узел не найден | None | ❌ |
| merchant_goran | OBSERVE | 1.320 | ❌ | x=17.1 y=5.6 | ❌ |
| tavern_keeper_tornin | ATTACK | 1.315 | ❌ узел не найден | None | ❌ |
| thief_shadow | OBSERVE | 1.162 | ❌ узел не найден | None | ❌ |
...
**NPC с разрывом в pipeline (intent есть, traversal нет):**
  ...
  - `tavern_keeper_tornin`: intent=ATTACK, traversal=❌, coords=None
  - `blacksmith_orm`: intent=ATTACK, traversal=❌, coords=None
