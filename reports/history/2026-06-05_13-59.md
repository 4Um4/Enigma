# ENIGMA Session State — 2026-06-05 13:59
...
_Сессия: 1.2 мин | Тиков: 10 | LLM-вызовов: 12_
...
| **CVS** (Causal Velocity) | 10.32/мин | ↑ +8.6 | ✅ 10.32/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 110% | ↓ +60.0% | ⛔ 11 пред-шинных отказов — pipeline молча умирает, CDS слеп |
...
_История: `reports/dna_history.jsonl` — 350 записей_
...
**Предупреждения:**
  ...
  - ⚠️ КРИТИЧНО: 11 пред-шинных отказов (pipeline=0, causality=0, phase8=0, tick_orch=11) — CDS слеп к этим багам без Инварианта 3

**Movement Pipeline (по NPC):**
| NPC | Intent | Score | Traversal | Координаты | Виден игроку |
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.447 | ❌ | None | ❌ |
| guard_borko | AMBUSH | 0.330 | ❌ узел не найден | None | ❌ |
| maid_lusya | CHANGE_ROLE | 0.253 | ❌ | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.438 | ❌ | x=16.8 y=3.5 | ❌ |
| tavern_keeper_tornin | SPREAD_RUMOR | 0.323 | ❌ | x=4.0 y=2.5 | ❌ |
| thief_shadow | OFFER_JOB | 0.375 | ❌ | None | ❌ |
