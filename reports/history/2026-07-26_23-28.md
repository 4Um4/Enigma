# ENIGMA Session State — 2026-07-26 23:28
...
_Сессия: 4.0 мин | Тиков: 2 | LLM-вызовов: 42_
...
| **CVS** (Causal Velocity) | 10.49/мин | ↑ +10.5 | ✅ 10.49/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 838 записей_
...
- NPC с известными координатами (6):
  ...
  - `merchant_goran`: x=9.9 y=2.5
  - `maid_lusya`: x=14.5 y=5.7
  - `blacksmith_orm`: x=10.3 y=6.3
  - `thief_shadow`: x=10.1 y=2.9
  - `tavern_keeper_tornin`: x=6.1 y=5.5
...
**Tick Pipeline:**
Тиков: 2 | Decisions > 0: 3/2 | LLM: 42 вызовов / 42 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.744 | ❌ | x=10.3 y=6.3 | ❌ |
| guard_borko | flee | 0.241 | ❌ | x=7.0 y=6.0 | ❌ |
| maid_lusya | idle | 0.000 | ❌ | x=14.5 y=5.7 | ❌ |
| merchant_goran | idle | 0.218 | ❌ | x=9.9 y=2.5 | ❌ |
| player | idle | 0.220 | ❌ | None | ❌ |
| tavern_keeper_tornin | flee | 0.197 | ❌ | x=6.1 y=5.5 | ❌ |
| thief_shadow | observe | 0.251 | ❌ | x=10.1 y=2.9 | ❌ |
