# ENIGMA Session State — 2026-06-07 22:43
...
_История: `reports/dna_history.jsonl` — 415 записей_
...
| guard_borko | CALL_FOR_HELP | 0.366 | ❌ | x=5.7 y=7.9 | ❌ |
| maid_lusya | CALL_FOR_HELP | 0.235 | ❌ | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.374 | ❌ | x=6.4 y=13.7 | ❌ |
| tavern_keeper_tornin | CALL_FOR_HELP | 0.262 | ❌ | None | ❌ |
| thief_shadow | REQUEST_SERVICE | 0.428 | ✅ | None | ❌ |
