# ENIGMA Session State — 2026-07-05 23:07
...
_Сессия: 2.9 мин | Тиков: 4 | LLM-вызовов: 8_
...
| **CVS** (Causal Velocity) | 2.76/мин | → +0.3 | ✅ 2.76/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 657 записей_
...
- NPC с известными координатами (6):
  ...
  - `thief_shadow`: x=11.5 y=7.0
  - `tavern_keeper_tornin`: x=7.5 y=4.0
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | change_role | 0.488 | ❌ | x=10.5 y=5.0 | ❌ |
| guard_borko | spread_rumor | 0.248 | ❌ | x=18.0 y=7.2 | ❌ |
| maid_lusya | call_for_help | 0.192 | ❌ | x=8.0 y=7.0 | ❌ |
| merchant_goran | offer_job | 0.330 | ❌ | x=12.0 y=10.0 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.243 | ❌ | x=7.5 y=4.0 | ❌ |
| thief_shadow | change_role | 0.264 | ❌ | x=11.5 y=7.0 | ❌ |
