# ENIGMA Session State — 2026-05-29 15:24
...
_История: `reports/dna_history.jsonl` — 175 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.168 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.190 | ❌ | x=13.7 y=2.3 | ❌ |
| maid_lusya | FLEE | 1.676 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.248 | ❌ | x=13.7 y=1.6 | ❌ |
| tavern_keeper_tornin | FLEE | 1.300 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.050 | ❌ узел не найден | None | ❌ |
