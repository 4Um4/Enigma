# ENIGMA Session State — 2026-06-08 00:02
...
| **NPI** (NPC Pipeline) | 33% | ↑ +4.7% | ⚠️ 2/6 NPC с координатами: spatial pipeline частично сломан |
...
_История: `reports/dna_history.jsonl` — 420 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.271 | ✅ | None | ❌ |
| guard_borko | REPORT | 0.336 | ✅ | x=9.3 y=3.1 | ❌ |
| maid_lusya | OBSERVE | 0.390 | ✅ | None | ❌ |
| merchant_goran | OBSERVE | 0.271 | ✅ | x=9.3 y=3.1 | ❌ |
| tavern_keeper_tornin | REPORT | 0.306 | ✅ | None | ❌ |
| thief_shadow | OBSERVE | 0.469 | ✅ | None | ❌ |
