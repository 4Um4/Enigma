# ENIGMA Session State — 2026-08-01 10:06
...
_История: `reports/dna_history.jsonl` — 899 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.819 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | spread_rumor | 0.322 | ❌ | x=17.9 y=3.4 | ❌ |
| maid_lusya | change_role | 0.267 | ❌ | x=16.7 y=2.4 | ❌ |
| merchant_goran | offer_job | 0.725 | ❌ | x=6.5 y=5.5 | ❌ |
