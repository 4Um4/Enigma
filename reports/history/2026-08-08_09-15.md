# ENIGMA Session State — 2026-08-08 09:15
...
_Сессия: 0.6 мин | Тиков: 11 | LLM-вызовов: 102_
...
| **CVS** (Causal Velocity) | 159.77/мин | ↑ +69.7 | ✅ 159.77/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 70 (idx=6.36) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 66 (broken=0) | → | ✅ Давление доходит |
| **NEI** (Need Urgency) | 0 (critical=0) | → | ⚠️ NPC слишком комфортны (NEI=0) |
| **DRI** (Response Integrity) | 82% | ↓ -17.6% | ⚠️ Деградация: 18 провалов LLM. Ответы нестабильны |
| **DPI** (Dialogue Pipeline) | 100% | → +0.0% | ✅ Конвейер диалогов стабилен |

_История: `reports/dna_history.jsonl` — 933 записей_
...
**Tick Pipeline:**
Тиков: 11 | Decisions > 0: 1/11 | LLM: 102 вызовов / 80 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.746 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | ambush | 0.241 | ❌ | x=10.5 y=3.0 | ❌ |
| maid_lusya | flee | 0.226 | ❌ | x=10.5 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.677 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | talk | 0.245 | ❌ | x=10.5 y=3.0 | ❌ |
| thief_shadow | approach | 0.178 | ❌ | x=10.5 y=3.0 | ❌ |
