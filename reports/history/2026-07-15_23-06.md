# ENIGMA Session State — 2026-07-15 23:06
...
_История: `reports/dna_history.jsonl` — 705 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.923 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | talk | 0.265 | ❌ | None | ❌ |
| maid_lusya | request_service | 0.269 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | request_service | 0.414 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.255 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | change_role | 0.332 | ❌ | x=11.6 y=9.8 | ❌ |
