# ENIGMA Session State — 2026-05-29 21:12
...
_История: `reports/dna_history.jsonl` — 201 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.264 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.468 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.367 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.371 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.423 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.037 | ❌ узел не найден | None | ❌ |
