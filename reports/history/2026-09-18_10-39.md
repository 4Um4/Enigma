# ENIGMA Session State — 2026-09-18 10:39
...
_Сессия: 1.3 мин | Тиков: 25 | LLM-вызовов: 32_
...
| **CVS** (Causal Velocity) | 24.95/мин | ↑ +13.7 | ✅ 24.95/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 216 (idx=8.64) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 174 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1142 записей_
...
**Tick Pipeline:**
Тиков: 25 | Decisions > 0: 1/25 | LLM: 32 вызовов / 32 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.093 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | help | 0.632 | ✅ | x=12.0 y=3.0 | ❌ |
| maid_lusya | flee | 1.358 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | warn | 0.509 | ✅ | x=6.5 y=5.5 | ❌ |
| player | flee | 0.501 | ✅ | None | ❌ |
| tavern_keeper_tornin | help | 0.773 | ✅ | x=10.5 y=6.5 | ❌ |
| thief_shadow | observe | 0.599 | ✅ | None | ❌ |
