# ENIGMA Session State — 2026-06-01 23:18
...
_История: `reports/dna_history.jsonl` — 275 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.475 | ✅ | None | ❌ |
| guard_borko | FLEE | 0.497 | ✅ | None | ❌ |
| maid_lusya | FLEE | 1.436 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.513 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.588 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.716 | ✅ | None | ❌ |
