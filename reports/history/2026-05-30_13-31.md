# ENIGMA Session State — 2026-05-30 13:31
...
_История: `reports/dna_history.jsonl` — 233 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.324 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.671 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.325 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.554 | ❌ | x=16.0 y=4.5 | ❌ |
| tavern_keeper_tornin | FLEE | 1.567 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.139 | ❌ узел не найден | None | ❌ |
