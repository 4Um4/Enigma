# ENIGMA Session State — 2026-07-16 22:01
...
| **CVS** (Causal Velocity) | 3.53/мин | ↓ -3.9 | ✅ 3.53/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 728 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.969 | ❌ | x=3.9 y=3.9 | ❌ |
| guard_borko | block_path | 0.286 | ❌ | None | ❌ |
| maid_lusya | call_for_help | 0.225 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | request_service | 0.323 | ❌ | x=3.4 y=3.5 | ❌ |
| player | talk | 0.301 | ❌ | None | ❌ |
| tavern_keeper_tornin | idle | 0.000 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | block_path | 0.368 | ❌ | x=7.5 y=6.8 | ❌ |
