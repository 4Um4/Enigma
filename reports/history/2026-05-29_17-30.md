# ENIGMA Session State — 2026-05-29 17:30
...
_История: `reports/dna_history.jsonl` — 177 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.326 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.341 | ❌ | x=2.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 0.363 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.396 | ❌ | x=2.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.383 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.274 | ❌ узел не найден | None | ❌ |
