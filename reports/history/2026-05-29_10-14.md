# ENIGMA Session State — 2026-05-29 10:14
...
| **CVS** (Causal Velocity) | 2.48/мин | ↑ +2.5 | ✅ 2.48/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 152 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | WARN | 0.552 | ❌ | None | ❌ |
| guard_borko | WARN | 0.558 | ❌ | x=14.3 y=1.7 | ❌ |
| maid_lusya | FLEE | 1.804 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.395 | ❌ | x=14.2 y=1.7 | ❌ |
| tavern_keeper_tornin | WARN | 0.865 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.436 | ❌ узел не найден | None | ❌ |
