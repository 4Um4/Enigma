# ENIGMA Session State — 2026-05-27 23:17
...
| **SCF** (Spatial Coherence) | 0.3 | → +0.3 | ✅ пространство целостно: граф загружен корректно |
...
_История: `reports/dna_history.jsonl` — 111 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.214 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.314 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.332 | ❌ | None | ❌ |
| merchant_goran | FLEE | 0.267 | ❌ | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.236 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.327 | ❌ | None | ❌ |
