# ENIGMA Session State — 2026-06-07 21:30
...
_История: `reports/dna_history.jsonl` — 410 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.412 | ✅ | None | ❌ |
| guard_borko | WARN | 0.421 | ✅ | x=4.0 y=2.5 | ❌ |
| maid_lusya | OBSERVE | 0.515 | ✅ | None | ❌ |
| merchant_goran | OBSERVE | 0.289 | ✅ | None | ❌ |
| tavern_keeper_tornin | WARN | 0.339 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.443 | ✅ | None | ❌ |
