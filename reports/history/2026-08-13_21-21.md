# ENIGMA Session State — 2026-08-13 21:21

Кампания: `Open_road` | Игрок: `Last person`
...
_Сессия: 2.4 мин | Тиков: 82 | LLM-вызовов: 138_
...
| **CVS** (Causal Velocity) | 58.44/мин | ↑ +58.4 | ✅ 58.44/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 1014 (idx=12.37) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 536 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1015 записей_
...
**Tick Pipeline:**
Тиков: 82 | Decisions > 0: 4/82 | LLM: 138 вызовов / 136 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.566 | ✅ | x=9.2 y=6.2 | ❌ |
| guard_borko | idle | 0.194 | ✅ | x=8.1 y=13.0 | ❌ |
| maid_lusya | idle | 0.161 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | request_service | 0.421 | ✅ | x=10.5 y=3.0 | ❌ |
| player | call_for_help | 0.178 | ✅ | None | ❌ |
| tavern_keeper_tornin | flee | 0.156 | ✅ | x=13.5 y=3.0 | ❌ |
