# ENIGMA Session State — 2026-07-26 20:18
...
_Сессия: 0.4 мин | Тиков: 1 | LLM-вызовов: 12_
...
| **CVS** (Causal Velocity) | 30.51/мин | ↑ +10.0 | ✅ 30.51/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 806 записей_
