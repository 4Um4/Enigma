# ENIGMA Session State — 2026-07-15 22:32
...
_История: `reports/dna_history.jsonl` — 700 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.993 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | block_path | 0.327 | ❌ | None | ❌ |
| maid_lusya | talk | 0.223 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | offer_job | 0.367 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.260 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | offer_job | 0.306 | ❌ | x=11.6 y=9.8 | ❌ |
