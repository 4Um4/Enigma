# ENIGMA Session State — 2026-05-29 00:48
...
_История: `reports/dna_history.jsonl` — 139 записей_
...
- NPC с известными координатами (2):
  - `guard_borko`: x=14.2 y=1.9
  - `merchant_goran`: x=14.1 y=1.7
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.154 | ✅ | None | ❌ |
| guard_borko | FLEE | 1.246 | ✅ | x=14.2 y=1.9 | ❌ |
| maid_lusya | FLEE | 2.379 | ✅ | None | ❌ |
| merchant_goran | FLEE | 1.176 | ✅ | x=14.1 y=1.7 | ❌ |
| tavern_keeper_tornin | FLEE | 1.355 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.968 | ✅ | None | ❌ |
