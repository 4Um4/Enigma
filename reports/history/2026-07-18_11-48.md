# ENIGMA Session State — 2026-07-18 11:48
...
_История: `reports/dna_history.jsonl` — 746 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | offer_job | 0.493 | ❌ | x=10.5 y=5.0 | ❌ |
| guard_borko | call_for_help | 0.211 | ❌ | None | ❌ |
| maid_lusya | flee | 0.230 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | request_service | 0.255 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | flee | 0.226 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | block_path | 0.265 | ❌ | x=11.6 y=9.8 | ❌ |
