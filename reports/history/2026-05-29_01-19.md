# ENIGMA Session State — 2026-05-29 01:19
...
_Сессия: 0.7 мин | Тиков: 1 | LLM-вызовов: 1_
...
| **CVS** (Causal Velocity) | 1.34/мин | ↑ +1.3 | ✅ 1.34/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 149 записей_
...
**Tick Pipeline:**
Тиков: 1 | Decisions > 0: 0/1 | LLM: 1 вызовов / 0 ответов | Симуляция: ❌ МЕРТВА
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | WARN | 0.539 | ❌ | None | ❌ |
| guard_borko | WARN | 0.600 | ❌ | x=1.9 y=1.9 | ❌ |
| maid_lusya | FLEE | 1.808 | ✅ | None | ❌ |
| merchant_goran | APPROACH | 0.372 | ❌ | x=5.7 y=6.4 | ❌ |
| tavern_keeper_tornin | WARN | 0.720 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.464 | ✅ | None | ❌ |
