# ENIGMA Session State — 2026-06-03 00:01
...
_История: `reports/dna_history.jsonl` — 309 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.940 | ❌ | x=16.4 y=5.5 | ❌ |
| guard_borko | ATTACK | 1.075 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | OBSERVE | 1.066 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.879 | ❌ | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | ATTACK | 1.468 | ❌ узел не найден | x=4.5 y=2.5 | ❌ |
| thief_shadow | OBSERVE | 1.130 | ❌ | None | ❌ |
