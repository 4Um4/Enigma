# ENIGMA Session State — 2026-08-14 23:37

Кампания: `Open_road` | Игрок: `Персона 2`
...
_Сессия: 1.5 мин | Тиков: 30 | LLM-вызовов: 66_
...
| **CVS** (Causal Velocity) | 44.56/мин | ↑ +44.6 | ✅ 44.56/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 382 (idx=12.73) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 192 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1016 записей_
...
**Tick Pipeline:**
Тиков: 30 | Decisions > 0: 5/30 | LLM: 66 вызовов / 64 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.886 | ✅ | x=5.5 y=6.0 | ❌ |
| guard_borko | observe | 0.163 | ✅ | x=11.0 y=10.0 | ❌ |
| maid_lusya | observe | 0.199 | ✅ | x=16.7 y=2.4 | ❌ |
| merchant_goran | offer_job | 0.666 | ✅ | x=6.0 y=8.0 | ❌ |
| player | observe | 0.201 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 0.183 | ✅ | x=13.5 y=3.0 | ❌ |
| thief_shadow | approach | 0.175 | ✅ | x=8.1 y=13.0 | ❌ |
