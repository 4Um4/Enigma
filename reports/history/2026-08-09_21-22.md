# ENIGMA Session State — 2026-08-09 21:22
...
_Сессия: 0.7 мин | Тиков: 8 | LLM-вызовов: 12_
...
| **CVS** (Causal Velocity) | 17.64/мин | ↑ +17.6 | ✅ 17.64/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 56 (idx=7.00) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 42 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1003 записей_
...
**Tick Pipeline:**
Тиков: 8 | Decisions > 0: 2/8 | LLM: 12 вызовов / 8 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.000 | ❌ | x=7.8 y=4.7 | ❌ |
| guard_borko | spread_rumor | 0.219 | ❌ | x=12.0 y=3.0 | ❌ |
| maid_lusya | call_for_help | 0.200 | ❌ | x=10.5 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.564 | ❌ | x=7.8 y=5.8 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.222 | ❌ | x=6.5 y=5.5 | ❌ |
| thief_shadow | block_path | 0.566 | ❌ | x=12.0 y=3.0 | ❌ |
