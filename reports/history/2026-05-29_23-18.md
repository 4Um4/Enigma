# ENIGMA Session State — 2026-05-29 23:18
...
_История: `reports/dna_history.jsonl` — 207 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.309 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.418 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.378 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.387 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.560 | ❌ узел не найден | None | ❌ |
