# ENIGMA Session State — 2026-05-27 22:58
...
| **CVS** (Causal Velocity) | 4.80/мин | ↑ +4.8 | ✅ 4.80/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 106 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | TRADE | 0.326 | ❌ | None | ❌ |
| guard_borko | TALK | 0.394 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 1.061 | ❌ узел не найден | None | ❌ |
| merchant_goran | APPROACH | 0.374 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | REPORT | 0.349 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.272 | ❌ узел не найден | None | ❌ |
...
**NPC с разрывом в pipeline (intent есть, traversal нет):**
  ...
  - `tavern_keeper_tornin`: intent=REPORT, traversal=❌, coords=None
