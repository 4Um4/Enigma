# ENIGMA Session State — 2026-05-27 23:25
...
_История: `reports/dna_history.jsonl` — 112 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.839 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.771 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 1.642 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.832 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.137 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.757 | ❌ узел не найден | None | ❌ |
