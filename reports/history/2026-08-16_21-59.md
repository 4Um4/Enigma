# ENIGMA Session State — 2026-08-16 21:59
...
_Сессия: 0.7 мин | Тиков: 5 | LLM-вызовов: 8_
...
| **CVS** (Causal Velocity) | 10.70/мин | ↑ +10.7 | ✅ 10.70/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 56 (idx=11.20) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 30 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1041 записей_
...
- NPC с известными координатами (6):
  ...
  - `tavern_keeper_tornin`: x=6.3 y=2.0
...
**Tick Pipeline:**
Тиков: 5 | Decisions > 0: 1/5 | LLM: 8 вызовов / 8 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.837 | ✅ | x=10.5 y=3.0 | ❌ |
| guard_borko | ambush | 0.188 | ✅ | x=13.5 y=3.0 | ❌ |
| maid_lusya | observe | 0.224 | ✅ | x=13.5 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.585 | ✅ | x=10.5 y=3.0 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.219 | ✅ | x=6.3 y=2.0 | ❌ |
