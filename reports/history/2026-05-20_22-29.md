# ENIGMA Session State — 2026-05-20 22:29
...
_История: `reports/dna_history.jsonl` — 23 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.363 | ❌ | x=16.4 y=5.5 | ❌ |
| guard_borko | FLEE | 0.397 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.347 | ✅ | x=4.5 y=5.0 | ❌ |
| merchant_goran | FLEE | 0.299 | ❌ | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | FLEE | 0.250 | ✅ | x=4.0 y=4.0 | ❌ |
| thief_shadow | FLEE | 0.276 | ✅ | None | ❌ |
