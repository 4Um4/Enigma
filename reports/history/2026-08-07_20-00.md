# ENIGMA Session State — 2026-08-07 20:00
...
_Сессия: 0.6 мин | Тиков: 18 | LLM-вызовов: 66_
...
| **CVS** (Causal Velocity) | 119.05/мин | ↑ +119.0 | ✅ 119.05/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 105 (idx=5.83) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 108 (broken=0) | → | ✅ Давление доходит |
| **NEI** (Need Urgency) | 0 (critical=0) | → | ⚠️ NPC слишком комфортны (NEI=0) |
| **DRI** (Response Integrity) | 94% | ↓ -6.1% | ✅ LLM отвечает на все запросы |
| **DPI** (Dialogue Pipeline) | 100% | → +0.0% | ✅ Конвейер диалогов стабилен |

_История: `reports/dna_history.jsonl` — 930 записей_
...
**Tick Pipeline:**
Тиков: 18 | Decisions > 0: 1/18 | LLM: 66 вызовов / 58 ответов | Симуляция: ✅ живёт
...
| guard_borko | block_path | 0.225 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | flee | 0.220 | ❌ | x=10.5 y=6.5 | ❌ |
| merchant_goran | request_service | 0.630 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.178 | ❌ | x=10.5 y=4.8 | ❌ |
