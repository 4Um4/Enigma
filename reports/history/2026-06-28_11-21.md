# ENIGMA Session State — 2026-06-28 11:21
...
| **CVS** (Causal Velocity) | 2.85/мин | ↑ +0.8 | ✅ 2.85/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 611 записей_
...
| guard_borko | ambush | 0.292 | ✅ | x=4.0 y=4.0 | ❌ |
| maid_lusya | offer_job | 0.200 | ✅ | x=4.0 y=4.0 | ❌ |
| merchant_goran | change_role | 0.402 | ✅ | x=4.0 y=4.0 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.257 | ✅ | x=4.0 y=4.0 | ❌ |
| thief_shadow | offer_job | 0.458 | ✅ | x=4.0 y=4.0 | ❌ |
