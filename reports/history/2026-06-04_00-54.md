# ENIGMA Session State — 2026-06-04 00:54
...
_История: `reports/dna_history.jsonl` — 327 записей_
...
- NPC с известными координатами (3):
  - `tavern_keeper_tornin`: x=16.7 y=6.7
  - `guard_borko`: x=16.4 y=6.9
  - `merchant_goran`: x=18.1 y=3.9
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ATTACK | 1.092 | ❌ | None | ❌ |
| guard_borko | ATTACK | 1.222 | ❌ | x=16.4 y=6.9 | ❌ |
| maid_lusya | OBSERVE | 1.131 | ❌ узел не найден | None | ❌ |
| merchant_goran | OBSERVE | 0.993 | ❌ | x=18.1 y=3.9 | ❌ |
| tavern_keeper_tornin | ATTACK | 1.602 | ❌ узел не найден | x=16.7 y=6.7 | ❌ |
| thief_shadow | OBSERVE | 1.192 | ❌ узел не найден | None | ❌ |
