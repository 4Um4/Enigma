# ENIGMA Session State — 2026-07-23 20:18
...
_Сессия: 1.6 мин | Тиков: 2 | LLM-вызовов: 32_
...
| **CVS** (Causal Velocity) | 20.52/мин | ↓ -5.4 | ✅ 20.52/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 765 записей_
...
**Tick Pipeline:**
Тиков: 2 | Decisions > 0: 3/2 | LLM: 32 вызовов / 32 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.721 | ❌ | x=10.8 y=9.8 | ❌ |
| guard_borko | block_path | 0.256 | ❌ | x=11.4 y=10.4 | ❌ |
| maid_lusya | observe | 0.155 | ❌ | x=11.0 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.352 | ❌ | x=10.4 y=9.6 | ❌ |
| player | ambush | 0.315 | ❌ | None | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.182 | ❌ | x=11.6 y=2.5 | ❌ |
| thief_shadow | request_service | 0.223 | ❌ | x=10.6 y=2.9 | ❌ |
