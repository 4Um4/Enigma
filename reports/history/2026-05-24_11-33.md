# ENIGMA Session State — 2026-05-24 11:33
...
_История: `reports/dna_history.jsonl` — 49 записей_
...
- NPC без координат (lerp не работает, 5):
  ...
  - `tavern_keeper_tornin` (intent=IDLE)
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | TRADE | 0.507 | ❌ | None | ❌ |
| guard_borko | TALK | 0.590 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 0.812 | ✅ | None | ❌ |
| merchant_goran | TRADE | 0.442 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | IDLE | 0.448 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.101 | ✅ | x=16.0 y=4.0 | ❌ |
