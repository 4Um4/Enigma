# ENIGMA Session State — 2026-09-23 19:34
...
_Сессия: 0.5 мин | Тиков: 437 | LLM-вызовов: 23_
...
| **CVS** (Causal Velocity) | 46.35/мин | ↑ +46.4 | ✅ 46.35/мин: активная сессия |
...
| **BPI** (Break Progress) | 3048 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1167 записей_
...
**Tick Pipeline:**
Тиков: 437 | Decisions > 0: 1/437 | LLM: 23 вызовов / 23 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.656 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | report | 0.582 | ✅ | x=16.7 y=2.4 | ❌ |
| maid_lusya | idle | 0.179 | ✅ | x=15.2 y=6.4 | ❌ |
| merchant_goran | offer_job | 0.929 | ✅ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.898 | ✅ | None | ❌ |
| tavern_keeper_tornin | trade | 0.933 | ✅ | x=18.4 y=6.3 | ❌ |
