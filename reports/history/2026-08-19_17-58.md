# ENIGMA Session State — 2026-08-19 17:58
...
_Сессия: 0.9 мин | Тиков: 23 | LLM-вызовов: 26_
...
| **CVS** (Causal Velocity) | 29.47/мин | ↑ +29.5 | ✅ 29.47/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 292 (idx=12.70) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 144 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1048 записей_
...
**Tick Pipeline:**
Тиков: 23 | Decisions > 0: 2/23 | LLM: 26 вызовов / 24 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | warn | 0.914 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | warn | 0.694 | ✅ | x=5.5 y=6.0 | ❌ |
| maid_lusya | warn | 0.851 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | request_service | 0.507 | ✅ | x=6.5 y=5.5 | ❌ |
| player | warn | 0.984 | ⏸ | None | ❌ |
| tavern_keeper_tornin | warn | 0.782 | ✅ | x=7.8 y=5.8 | ❌ |
| thief_shadow | warn | 1.496 | ✅ | x=8.1 y=13.0 | ❌ |

**NPC с разрывом в pipeline (intent есть, traversal нет):**
  - `player`: intent=warn, traversal=❌, coords=None
