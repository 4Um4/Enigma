# ENIGMA Session State — 2026-07-28 21:57
...
_Сессия: 0.2 мин | Тиков: 0 | LLM-вызовов: 3_
...
| **CVS** (Causal Velocity) | 18.39/мин | ↑ +12.2 | ✅ 18.39/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 878 записей_
...
- NPC с известными координатами (6):
  ...
  - `maid_lusya`: x=12.2 y=3.2
  - `blacksmith_orm`: x=9.0 y=6.0
...
**Tick Pipeline:**
Тиков: 0 | Decisions > 0: 1/0 | LLM: 3 вызовов / 2 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.736 | ❌ | x=9.0 y=6.0 | ❌ |
| guard_borko | idle | 0.208 | ❌ | x=10.9 y=5.2 | ❌ |
| maid_lusya | observe | 0.233 | ❌ | x=12.2 y=3.2 | ❌ |
| merchant_goran | flee | 0.256 | ❌ | x=9.9 y=6.0 | ❌ |
