# ENIGMA Session State — 2026-05-29 11:34
...
_История: `reports/dna_history.jsonl` — 166 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.179 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.515 | ❌ | None | ❌ |
| maid_lusya | FLEE | 2.297 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.272 | ❌ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.407 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.019 | ❌ узел не найден | None | ❌ |
