# ENIGMA Session State — 2026-05-27 23:00
...
_История: `reports/dna_history.jsonl` — 107 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.753 | ❌ | None | ❌ |
| guard_borko | OBSERVE | 0.751 | ❌ | None | ❌ |
| maid_lusya | FLEE | 1.663 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.638 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.907 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.616 | ❌ узел не найден | None | ❌ |
...
**NPC с разрывом в pipeline (intent есть, traversal нет):**
  ...
  - `guard_borko`: intent=OBSERVE, traversal=❌, coords=None
