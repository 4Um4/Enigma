# ENIGMA Session State — 2026-06-01 17:48
...
_Сессия: 1.0 мин | Тиков: 5 | LLM-вызовов: 10_
...
| **CVS** (Causal Velocity) | 9.86/мин | ↑ +9.9 | ✅ 9.86/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 261 записей_
...
**Tick Pipeline:**
Тиков: 5 | Decisions > 0: 0/5 | LLM: 10 вызовов / 10 ответов | Симуляция: ❌ МЕРТВА
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.327 | ❌ | None | ❌ |
| guard_borko | OBSERVE | 0.270 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 1.399 | ❌ | None | ❌ |
| merchant_goran | FLEE | 0.344 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.314 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.238 | ❌ узел не найден | None | ❌ |
