# ENIGMA Session State — 2026-07-26 17:53
...
_Сессия: 0.9 мин | Тиков: 2 | LLM-вызовов: 8_
...
| **CVS** (Causal Velocity) | 9.13/мин | ↑ +9.1 | ✅ 9.13/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 794 записей_
...
- NPC с известными координатами (6):
  - `maid_lusya`: x=5.5 y=6.5
  - `blacksmith_orm`: x=10.4 y=4.7
  - `thief_shadow`: x=11.0 y=10.0
  - `tavern_keeper_tornin`: x=4.5 y=2.5
  - `guard_borko`: x=11.0 y=8.5
  - `merchant_goran`: x=10.2 y=4.5
...
**Tick Pipeline:**
Тиков: 2 | Decisions > 0: 3/2 | LLM: 8 вызовов / 8 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.801 | ❌ | x=10.4 y=4.7 | ❌ |
| guard_borko | report | 0.210 | ❌ | x=11.0 y=8.5 | ❌ |
| maid_lusya | observe | 0.253 | ❌ | x=5.5 y=6.5 | ❌ |
| merchant_goran | offer_job | 0.181 | ❌ | x=10.2 y=4.5 | ❌ |
| player | idle | 0.223 | ❌ | None | ❌ |
| tavern_keeper_tornin | observe | 0.249 | ❌ | x=4.5 y=2.5 | ❌ |
| thief_shadow | observe | 0.455 | ❌ | x=11.0 y=10.0 | ❌ |
