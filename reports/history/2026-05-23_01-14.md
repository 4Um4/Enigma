# ENIGMA Session State — 2026-05-23 01:14
...
_История: `reports/dna_history.jsonl` — 40 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.326 | ❌ | x=16.4 y=5.5 | ❌ |
| guard_borko | FLEE | 0.373 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 0.473 | ❌ | None | ❌ |
| merchant_goran | FLEE | 0.257 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.243 | ✅ | None | ❌ |
| thief_shadow | CHANGE_ROLE | 0.252 | ✅ | x=8.0 y=7.0 | ❌ |
