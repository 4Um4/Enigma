# ENIGMA Session State — 2026-09-24 20:41
...
_Сессия: 2.8 мин | Тиков: 180 | LLM-вызовов: 50_
...
| **CVS** (Causal Velocity) | 18.04/мин | ↓ -5.1 | ✅ 18.04/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 1350 (idx=7.50) | → | ✅ Убеждения формируются |
...
_История: `reports/dna_history.jsonl` — 1198 записей_
...
**Tick Pipeline:**
Тиков: 180 | Decisions > 0: 3/180 | LLM: 50 вызовов / 52 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.169 | ✅ | x=10.5 y=4.8 | ❌ |
| guard_borko | talk | 1.538 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.449 | ✅ | x=10.5 y=4.8 | ❌ |
| merchant_goran | flee | 0.914 | ✅ | x=10.5 y=4.8 | ❌ |
