# ENIGMA Session State — 2026-09-17 12:30
...
_Сессия: 1.0 мин | Тиков: 99 | LLM-вызовов: 16_
...
| **CVS** (Causal Velocity) | 15.78/мин | ↓ -3.2 | ✅ 15.78/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 405 (idx=4.09) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 686 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1129 записей_
...
**Tick Pipeline:**
Тиков: 99 | Decisions > 0: 1/99 | LLM: 16 вызовов / 18 ответов | Симуляция: ✅ живёт
...
| guard_borko | block_path | 0.646 | ✅ | x=35.0 y=7.0 | ❌ |
| maid_lusya | flee | 1.450 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | flee | 0.985 | ✅ | x=10.5 y=3.0 | ❌ |
| player | trade | 0.630 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.041 | ✅ | x=7.8 y=5.8 | ❌ |
| thief_shadow | observe | 0.711 | ⏸ | None | ❌ |
