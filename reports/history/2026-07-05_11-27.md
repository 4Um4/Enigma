# ENIGMA Session State — 2026-07-05 11:27
...
| **CVS** (Causal Velocity) | 1.67/мин | ↓ -2.9 | ✅ 1.67/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 650 записей_
...
- NPC с известными координатами (6):
  - `guard_borko`: x=15.7 y=5.3
  - `merchant_goran`: x=15.7 y=5.3
  - `maid_lusya`: x=15.7 y=5.3
  - `blacksmith_orm`: x=15.7 y=5.3
  - `thief_shadow`: x=15.7 y=5.3
  - `tavern_keeper_tornin`: x=15.7 y=5.3
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.804 | ❌ | x=15.7 y=5.3 | ❌ |
| guard_borko | request_service | 0.534 | ❌ | x=15.7 y=5.3 | ❌ |
| maid_lusya | offer_job | 0.684 | ❌ | x=15.7 y=5.3 | ❌ |
| merchant_goran | request_service | 0.589 | ❌ | x=15.7 y=5.3 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.531 | ❌ | x=15.7 y=5.3 | ❌ |
| thief_shadow | offer_job | 0.646 | ❌ | x=15.7 y=5.3 | ❌ |
