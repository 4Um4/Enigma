# ENIGMA Session State — 2026-07-15 23:12
...
_История: `reports/dna_history.jsonl` — 707 записей_
...
| maid_lusya | spread_rumor | 0.212 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | request_service | 0.387 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.165 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | ambush | 0.343 | ❌ | x=11.6 y=9.8 | ❌ |
