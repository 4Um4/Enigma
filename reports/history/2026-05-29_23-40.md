# ENIGMA Session State — 2026-05-29 23:40
...
_История: `reports/dna_history.jsonl` — 209 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.311 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.504 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.451 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.401 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.415 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.092 | ❌ узел не найден | None | ❌ |
