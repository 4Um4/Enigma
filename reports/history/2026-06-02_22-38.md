# ENIGMA Session State — 2026-06-02 22:38
...
_История: `reports/dna_history.jsonl` — 299 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.744 | ❌ | x=8.0 y=7.0 | ❌ |
| guard_borko | FLEE | 0.779 | ❌ | x=8.0 y=7.0 | ❌ |
| maid_lusya | FLEE | 1.006 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.830 | ❌ | x=8.0 y=7.0 | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.858 | ❌ узел не найден | x=8.0 y=7.0 | ❌ |
| thief_shadow | FLEE | 1.134 | ❌ | None | ❌ |
