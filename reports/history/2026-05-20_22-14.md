# ENIGMA Session State — 2026-05-20 22:14
...
_Сессия: 0.9 мин | Тиков: 12 | LLM-вызовов: 0_
...
_История: `reports/dna_history.jsonl` — 21 записей_
...
- NPC с известными координатами (2):
  - `tavern_keeper_tornin`: x=4.3 y=2.3
...
**Tick Pipeline:**
Тиков: 12 | Decisions > 0: 0/12 | LLM: 0 вызовов / 0 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.307 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.276 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.462 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.393 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.351 | ✅ | x=4.3 y=2.3 | ❌ |
| thief_shadow | FLEE | 0.578 | ✅ | None | ❌ |
