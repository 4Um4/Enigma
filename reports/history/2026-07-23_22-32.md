# ENIGMA Session State — 2026-07-23 22:32
...
_Сессия: 1.5 мин | Тиков: 0 | LLM-вызовов: 14_
...
| **CVS** (Causal Velocity) | 9.37/мин | ↓ -3.7 | ✅ 9.37/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 774 записей_
...
**Tick Pipeline:**
Тиков: 0 | Decisions > 0: 1/0 | LLM: 14 вызовов / 14 ответов | Симуляция: ✅ живёт
- LLM "Ничего не произошло": 0 раз
- LLM CJK-галлюцинации: 16 строк
- Стартап backend: ✅
- LLM сервер: ✅

**Предупреждения:**
  - ⚠️ LLM галлюцинирует на китайском: 16 строк

**Movement Pipeline (по NPC):**
| NPC | Intent | Score | Traversal | Координаты | Виден игроку |
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.659 | ❌ | x=10.8 y=9.8 | ❌ |
| guard_borko | block_path | 0.256 | ❌ | x=11.4 y=10.4 | ❌ |
| maid_lusya | call_for_help | 0.158 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | flee | 0.208 | ❌ | x=10.4 y=2.5 | ❌ |
| player | call_for_help | 0.318 | ❌ | None | ❌ |
| tavern_keeper_tornin | idle | 0.239 | ❌ | x=11.6 y=2.5 | ❌ |
| thief_shadow | request_service | 0.167 | ❌ | x=10.6 y=2.9 | ❌ |
