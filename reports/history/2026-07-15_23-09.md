# ENIGMA Session State — 2026-07-15 23:09
...
_История: `reports/dna_history.jsonl` — 706 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.865 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | ambush | 0.262 | ❌ | x=12.4 y=10.4 | ❌ |
| maid_lusya | change_role | 0.290 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | request_service | 0.393 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | talk | 0.205 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | request_service | 0.330 | ❌ | x=11.6 y=9.8 | ❌ |
