# ENIGMA Session State — 2026-09-26 14:31
...
_Сессия: 1.2 мин | Тиков: 32 | LLM-вызовов: 22_
...
| **CVS** (Causal Velocity) | 18.36/мин | ↓ -4.8 | ✅ 18.36/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 220 (idx=6.88) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 223 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1248 записей_
...
**Tick Pipeline:**
Тиков: 32 | Decisions > 0: 2/32 | LLM: 22 вызовов / 22 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | warn | 1.830 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | block_path | 0.668 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | spread_rumor | 2.391 | ✅ | x=16.7 y=2.4 | ❌ |
| merchant_goran | warn | 2.639 | ✅ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | talk | 1.104 | ✅ | x=16.7 y=2.4 | ❌ |
