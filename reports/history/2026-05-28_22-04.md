# ENIGMA Session State — 2026-05-28 22:04
...
| **NPI** (NPC Pipeline) | 33% | ↑ +16.6% | ⚠️ 2/6 NPC с координатами: spatial pipeline частично сломан |
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -5.2 | LLM не вызывалась: сессия без действий игрока |

**Системные сигналы (требуют внимания):**
- SCF упал с 1.0 до 0.0: spatial fallback + node_not_found = регрессия spatial слоя

_История: `reports/dna_history.jsonl` — 123 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.956 | ✅ | None | ❌ |
| guard_borko | FLEE | 0.980 | ✅ | x=2.2 y=1.8 | ❌ |
| maid_lusya | FLEE | 1.767 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.801 | ✅ | x=4.2 y=4.8 | ❌ |
| tavern_keeper_tornin | FLEE | 1.113 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.816 | ❌ узел не найден | None | ❌ |
