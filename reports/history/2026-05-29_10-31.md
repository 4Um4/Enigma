# ENIGMA Session State — 2026-05-29 10:31
...
_История: `reports/dna_history.jsonl` — 157 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.157 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.327 | ❌ | x=1.9 y=1.9 | ❌ |
| maid_lusya | FLEE | 2.466 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.385 | ❌ | x=2.1 y=2.1 | ❌ |
| tavern_keeper_tornin | FLEE | 1.504 | ❌ узел не найден | None | ❌ |
