# ENIGMA Session State — 2026-06-08 01:08
...
_История: `reports/dna_history.jsonl` — 423 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.254 | ❌ | None | ❌ |
| guard_borko | WARN | 0.330 | ❌ | x=9.3 y=3.1 | ❌ |
| maid_lusya | OBSERVE | 0.519 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.426 | ❌ | x=17.4 y=3.4 | ❌ |
| tavern_keeper_tornin | WARN | 0.386 | ❌ | None | ❌ |
| thief_shadow | OBSERVE | 0.458 | ✅ | None | ❌ |
