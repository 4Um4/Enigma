# ENIGMA Session State — 2026-08-08 21:51
...
_Сессия: 1.4 мин | Тиков: 97 | LLM-вызовов: 95_
...
| **CVS** (Causal Velocity) | 66.01/мин | ↑ +66.0 | ✅ 66.01/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 203 (idx=2.09) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 584 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 962 записей_
...
**Tick Pipeline:**
Тиков: 97 | Decisions > 0: 3/97 | LLM: 95 вызовов / 94 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.804 | ❌ | x=10.5 y=6.5 | ❌ |
| guard_borko | ambush | 0.263 | ❌ | x=13.5 y=9.5 | ❌ |
| maid_lusya | idle | 0.000 | ❌ | x=11.7 y=2.6 | ❌ |
| merchant_goran | offer_job | 0.650 | ❌ | x=10.5 y=3.0 | ❌ |
| player | observe | 0.201 | ❌ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.244 | ❌ | x=10.5 y=3.0 | ❌ |
| thief_shadow | ambush | 0.484 | ❌ | x=10.8 y=8.0 | ❌ |
