# ENIGMA Session State — 2026-05-30 00:38
...
_История: `reports/dna_history.jsonl` — 212 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.404 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.623 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.382 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.464 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.519 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.106 | ❌ узел не найден | None | ❌ |
