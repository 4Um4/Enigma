# ENIGMA Session State — 2026-05-30 10:17
...
_История: `reports/dna_history.jsonl` — 224 записей_
...
| guard_borko | FLEE | 1.255 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 1.696 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.178 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.339 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.057 | ❌ узел не найден | None | ❌ |
