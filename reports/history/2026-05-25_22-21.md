# ENIGMA Session State — 2026-05-25 22:21
...
_История: `reports/dna_history.jsonl` — 75 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.633 | ✅ | None | ❌ |
| guard_borko | AMBUSH | 0.602 | ❌ | None | ❌ |
| maid_lusya | FLEE | 1.511 | ❌ | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.566 | ✅ | None | ❌ |
| tavern_keeper_tornin | SPREAD_RUMOR | 0.411 | ❌ | None | ❌ |
| thief_shadow | FLEE | 1.294 | ❌ | None | ❌ |
