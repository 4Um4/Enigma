# ENIGMA Session State — 2026-09-24 20:52
...
_Сессия: 3.4 мин | Тиков: 257 | LLM-вызовов: 46_
...
| **CVS** (Causal Velocity) | 13.51/мин | ↓ -5.5 | ✅ 13.51/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 1290 (idx=5.02) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 1799 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1199 записей_
...
**Tick Pipeline:**
Тиков: 257 | Decisions > 0: 4/257 | LLM: 46 вызовов / 46 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.331 | ✅ | x=15.2 y=5.7 | ❌ |
| guard_borko | talk | 1.590 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.434 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | flee | 0.905 | ✅ | x=12.0 y=3.0 | ❌ |
| player | observe | 0.794 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.498 | ✅ | x=17.3 y=3.7 | ❌ |
| thief_shadow | observe | 0.753 | ✅ | x=11.5 y=11.0 | ❌ |
