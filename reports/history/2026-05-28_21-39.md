# ENIGMA Session State — 2026-05-28 21:39
...
| **ADR** (Debt Ratio) | 46.00 | ↓ +46.0 | ⛔ 138 TODO / 3 ADR = долг накапливается быстрее документации |
| **CVS** (Causal Velocity) | 0.00/мин | → +0.0 | LLM не вызывалась: сессия без действий игрока |

**Системные сигналы (требуют внимания):**
- ADR вырос на +46.00: TODO добавляются быстрее чем закрываются ADR

_История: `reports/dna_history.jsonl` — 119 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.276 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.403 | ❌ | x=2.2 y=1.8 | ❌ |
| maid_lusya | FLEE | 0.337 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.347 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.327 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.268 | ❌ узел не найден | None | ❌ |
