# ENIGMA Session State — 2026-06-15 19:57
...
_Сессия: 2.0 мин | Тиков: 0 | LLM-вызовов: 6_
...
| **NPI** (NPC Pipeline) | 100% | → +0.0% | ✅ 1/1 NPC с реальными координатами |
...
| **CVS** (Causal Velocity) | 3.00/мин | ↓ -1.5 | ✅ 3.00/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 582 записей_
