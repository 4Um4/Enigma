# ENIGMA Session State — 2026-05-23 00:15
...
| **ADR** (Debt Ratio) | 2.08 | → -0.1 | ⚠️ 137 TODO / 66 ADR = умеренный архитектурный долг |
...
_История: `reports/dna_history.jsonl` — 36 записей_
...
- NPC с известными координатами (6):
  ...
  - `tavern_keeper_tornin`: x=3.9 y=2.6
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.347 | ❌ | x=16.4 y=5.5 | ❌ |
| guard_borko | FLEE | 0.355 | ❌ узел не найден | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.436 | ✅ | x=8.0 y=7.0 | ❌ |
| merchant_goran | FLEE | 0.326 | ❌ узел не найден | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | FLEE | 0.317 | ✅ | x=3.9 y=2.6 | ❌ |
| thief_shadow | FLEE | 0.531 | ✅ | x=8.0 y=12.0 | ❌ |
