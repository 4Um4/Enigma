# ENIGMA Session State — 2026-06-30 05:56
...
| **CVS** (Causal Velocity) | 4.13/мин | ↑ +1.0 | ✅ 4.13/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 638 записей_
...
| guard_borko | block_path | 0.427 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | offer_job | 0.200 | ❌ | x=4.5 y=5.0 | ❌ |
