# ENIGMA Session State — 2026-09-19 20:49
...
_Сессия: 6.8 мин | Тиков: 26 | LLM-вызовов: 26_
...
| **CVS** (Causal Velocity) | 3.83/мин | ↓ -3.5 | ✅ 3.83/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 162 (idx=6.23) | → | ✅ Убеждения формируются |
...
_История: `reports/dna_history.jsonl` — 1155 записей_
...
**Tick Pipeline:**
Тиков: 26 | Decisions > 0: 1/26 | LLM: 26 вызовов / 26 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.087 | ✅ | x=5.8 y=7.0 | ❌ |
| guard_borko | observe | 1.295 | ✅ | x=12.0 y=11.5 | ❌ |
| maid_lusya | flee | 1.386 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | warn | 0.450 | ✅ | x=5.5 y=6.0 | ❌ |
| player | flee | 0.608 | ✅ | None | ❌ |
| tavern_keeper_tornin | help | 0.559 | ✅ | x=10.5 y=3.0 | ❌ |
| thief_shadow | observe | 0.480 | ✅ | x=8.1 y=13.0 | ❌ |
