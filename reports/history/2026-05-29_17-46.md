# ENIGMA Session State — 2026-05-29 17:46
...
_История: `reports/dna_history.jsonl` — 180 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.206 | ✅ | None | ❌ |
| guard_borko | FLEE | 1.534 | ✅ | x=2.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.307 | ✅ | None | ❌ |
| merchant_goran | FLEE | 1.285 | ✅ | x=2.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.530 | ✅ | None | ❌ |
| thief_shadow | FLEE | 2.085 | ✅ | None | ❌ |
