# ENIGMA Session State — 2026-06-30 05:15
...
| **CVS** (Causal Velocity) | 4.70/мин | ↑ +1.4 | ✅ 4.70/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 100% | ↓ +100.0% | ⛔ 2 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 634 записей_
...
| guard_borko | block_path | 0.302 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | offer_job | 0.167 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | offer_job | 0.385 | ❌ | x=9.0 y=9.0 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.282 | ❌ | x=4.5 y=2.5 | ❌ |
| thief_shadow | request_service | 0.402 | ❌ | x=11.5 y=9.5 | ❌ |
