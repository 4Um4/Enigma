# ENIGMA Session State — 2026-07-05 11:50
...
_История: `reports/dna_history.jsonl` — 655 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.874 | ❌ | x=10.5 y=5.0 | ❌ |
| guard_borko | spread_rumor | 0.666 | ❌ | x=18.0 y=7.2 | ❌ |
| maid_lusya | request_service | 0.576 | ❌ | x=11.0 y=4.0 | ❌ |
| merchant_goran | offer_job | 0.607 | ❌ | x=4.0 y=4.0 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.582 | ❌ | x=16.0 y=4.0 | ❌ |
| thief_shadow | offer_job | 0.738 | ❌ | x=4.0 y=4.0 | ❌ |
