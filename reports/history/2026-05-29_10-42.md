# ENIGMA Session State — 2026-05-29 10:42
...
_История: `reports/dna_history.jsonl` — 160 записей_
...
- NPC с известными координатами (2):
  - `guard_borko`: x=13.9 y=2.0
  - `merchant_goran`: x=13.9 y=2.1
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.169 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.361 | ❌ | x=13.9 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.370 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.233 | ❌ | x=13.9 y=2.1 | ❌ |
| tavern_keeper_tornin | FLEE | 1.429 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.002 | ❌ узел не найден | None | ❌ |
