# ENIGMA Session State — 2026-06-07 20:15
...
_История: `reports/dna_history.jsonl` — 408 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.422 | ❌ | None | ❌ |
| guard_borko | SEEK_ALLY | 0.353 | ❌ | x=4.0 y=2.5 | ❌ |
| maid_lusya | CHANGE_ROLE | 0.277 | ❌ | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.388 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | SPREAD_RUMOR | 0.295 | ✅ | None | ❌ |
| thief_shadow | OFFER_JOB | 0.434 | ❌ | None | ❌ |
