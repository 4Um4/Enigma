# ENIGMA Session State — 2026-05-26 23:57
...
_История: `reports/dna_history.jsonl` — 91 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.507 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.487 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 1.520 | ✅ | None | ❌ |
| merchant_goran | OBSERVE | 0.495 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.809 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.391 | ✅ | None | ❌ |
