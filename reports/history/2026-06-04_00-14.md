# ENIGMA Session State — 2026-06-04 00:14
...
| **CVS** (Causal Velocity) | 1.03/мин | ↑ +1.0 | ✅ 1.03/мин: активная сессия |

_История: `reports/dna_history.jsonl` — 324 записей_
...
- NPC с известными координатами (3):
  - `tavern_keeper_tornin`: x=18.4 y=5.4
  - `guard_borko`: x=17.4 y=4.7
  - `merchant_goran`: x=17.2 y=2.7
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ATTACK | 0.674 | ❌ | None | ❌ |
| guard_borko | ATTACK | 0.819 | ❌ | x=17.4 y=4.7 | ❌ |
| maid_lusya | OBSERVE | 1.033 | ✅ | None | ❌ |
| merchant_goran | OBSERVE | 0.565 | ❌ | x=17.2 y=2.7 | ❌ |
| tavern_keeper_tornin | ATTACK | 1.171 | ❌ узел не найден | x=18.4 y=5.4 | ❌ |
| thief_shadow | ATTACK | 0.975 | ❌ узел не найден | None | ❌ |
