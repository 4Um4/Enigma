# ENIGMA Session State — 2026-05-29 10:28
...
_История: `reports/dna_history.jsonl` — 156 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.068 | ✅ | None | ❌ |
| guard_borko | FLEE | 1.270 | ✅ | x=1.9 y=1.9 | ❌ |
| maid_lusya | FLEE | 2.314 | ✅ | None | ❌ |
| merchant_goran | FLEE | 1.316 | ✅ | x=2.1 y=2.1 | ❌ |
| tavern_keeper_tornin | FLEE | 1.427 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.999 | ✅ | None | ❌ |
