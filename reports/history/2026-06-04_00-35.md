# ENIGMA Session State — 2026-06-04 00:35
...
_История: `reports/dna_history.jsonl` — 325 записей_
...
- NPC с известными координатами (3):
  - `tavern_keeper_tornin`: x=17.1 y=7.8
  - `guard_borko`: x=17.4 y=4.7
  - `merchant_goran`: x=18.3 y=6.3
- NPC без координат (lerp не работает, 3):
  - `maid_lusya` (intent=APPROACH)
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.853 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.799 | ❌ | x=17.4 y=4.7 | ❌ |
| maid_lusya | APPROACH | 2.124 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.986 | ❌ | x=18.3 y=6.3 | ❌ |
| tavern_keeper_tornin | FLEE | 0.925 | ❌ узел не найден | x=17.1 y=7.8 | ❌ |
| thief_shadow | FLEE | 1.187 | ❌ узел не найден | None | ❌ |

**NPC с разрывом в pipeline (intent есть, traversal нет):**
  - `maid_lusya`: intent=APPROACH, traversal=❌, coords=None
