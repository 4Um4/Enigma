# ENIGMA Session State — 2026-08-26 20:57
...
_Сессия: 1.1 мин | Тиков: 15 | LLM-вызовов: 26_
...
| **CVS** (Causal Velocity) | 23.02/мин | ↑ +8.8 | ✅ 23.02/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 14 (idx=0.93) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 93 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1106 записей_
...
**Tick Pipeline:**
Тиков: 15 | Decisions > 0: 3/15 | LLM: 26 вызовов / 24 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.707 | ✅ | x=9.6 y=4.6 | ❌ |
| guard_borko | ambush | 0.449 | ✅ | x=10.5 y=6.5 | ❌ |
| maid_lusya | talk | 0.274 | ✅ | x=13.5 y=3.0 | ❌ |
| merchant_goran | request_service | 0.737 | ✅ | x=10.5 y=3.0 | ❌ |
| player | change_role | 0.320 | ✅ | None | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.352 | ✅ | x=10.5 y=4.8 | ❌ |
| thief_shadow | observe | 0.166 | ✅ | x=8.1 y=13.0 | ❌ |
