# ENIGMA Session State — 2026-05-29 00:58
...
| **CVS** (Causal Velocity) | 4.89/мин | ↑ +4.9 | ✅ 4.89/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 143 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | WARN | 0.631 | ❌ | None | ❌ |
| guard_borko | WARN | 0.570 | ❌ | x=14.1 y=2.0 | ❌ |
| maid_lusya | FLEE | 1.788 | ❌ узел не найден | None | ❌ |
| merchant_goran | WARN | 0.429 | ❌ | x=13.9 y=1.6 | ❌ |
| tavern_keeper_tornin | WARN | 0.821 | ❌ узел не найден | None | ❌ |
| thief_shadow | WARN | 0.344 | ❌ узел не найден | None | ❌ |
