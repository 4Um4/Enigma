# ENIGMA Session State — 2026-06-07 01:25
...
_История: `reports/dna_history.jsonl` — 389 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.408 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.372 | ❌ узел не найден | None | ❌ |
| maid_lusya | CHANGE_ROLE | 0.274 | ❌ | None | ❌ |
| merchant_goran | CHANGE_ROLE | 0.429 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | CALL_FOR_HELP | 0.252 | ❌ | None | ❌ |
| thief_shadow | CHANGE_ROLE | 0.408 | ❌ | None | ❌ |
