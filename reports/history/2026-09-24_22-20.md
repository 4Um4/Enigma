# ENIGMA Session State — 2026-09-24 22:20
...
_Сессия: 1.2 мин | Тиков: 43 | LLM-вызовов: 26_
...
| **CVS** (Causal Velocity) | 21.22/мин | ↑ +8.8 | ✅ 21.22/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 210 (idx=4.88) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 300 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1202 записей_
...
**Tick Pipeline:**
Тиков: 43 | Decisions > 0: 2/43 | LLM: 26 вызовов / 26 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.144 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | block_path | 0.640 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.518 | ✅ | x=10.5 y=6.5 | ❌ |
| merchant_goran | offer_job | 0.716 | ✅ | x=6.5 y=5.5 | ❌ |
| player | flee | 0.596 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.145 | ✅ | x=16.7 y=2.4 | ❌ |
| thief_shadow | observe | 0.606 | ✅ | x=11.5 y=11.0 | ❌ |
