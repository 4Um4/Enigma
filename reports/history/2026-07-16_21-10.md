# ENIGMA Session State — 2026-07-16 21:10
...
_Сессия: 1.5 мин | Тиков: 7 | LLM-вызовов: 14_
...
| **CVS** (Causal Velocity) | 9.51/мин | ↑ +9.5 | ✅ 9.51/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 71% | ↓ +71.4% | ⛔ 5 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 719 записей_
...
- NPC с известными координатами (6):
  ...
  - `maid_lusya`: x=12.0 y=7.2
  - `blacksmith_orm`: x=11.8 y=6.8
...
**Tick Pipeline:**
Тиков: 7 | Decisions > 0: 3/7 | LLM: 14 вызовов / 14 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.032 | ❌ | x=11.8 y=6.8 | ❌ |
| guard_borko | seek_ally | 0.279 | ❌ | x=12.4 y=10.4 | ❌ |
| maid_lusya | call_for_help | 0.250 | ❌ | x=12.0 y=7.2 | ❌ |
| merchant_goran | offer_job | 0.503 | ❌ | x=11.4 y=6.5 | ❌ |
| player | request_service | 0.322 | ❌ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.222 | ❌ | x=12.6 y=9.6 | ❌ |
| thief_shadow | ambush | 0.366 | ❌ | x=11.6 y=6.8 | ❌ |
