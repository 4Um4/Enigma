# ENIGMA Session State — 2026-07-26 23:33
...
_Сессия: 1.1 мин | Тиков: 2 | LLM-вызовов: 18_
...
| **CVS** (Causal Velocity) | 15.91/мин | ↑ +15.9 | ✅ 15.91/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 839 записей_
...
- NPC с известными координатами (6):
  - `guard_borko`: x=10.2 y=5.0
  - `merchant_goran`: x=9.9 y=2.5
  - `maid_lusya`: x=17.0 y=5.7
...
**Tick Pipeline:**
Тиков: 2 | Decisions > 0: 3/2 | LLM: 18 вызовов / 18 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.795 | ❌ | x=10.3 y=2.9 | ❌ |
| guard_borko | block_path | 0.186 | ❌ | x=10.2 y=5.0 | ❌ |
| maid_lusya | flee | 0.268 | ❌ | x=17.0 y=5.7 | ❌ |
| merchant_goran | idle | 0.200 | ❌ | x=9.9 y=2.5 | ❌ |
| player | flee | 0.203 | ❌ | None | ❌ |
| tavern_keeper_tornin | idle | 0.000 | ❌ | x=6.1 y=5.5 | ❌ |
| thief_shadow | idle | 0.197 | ❌ | x=6.0 y=5.3 | ❌ |
