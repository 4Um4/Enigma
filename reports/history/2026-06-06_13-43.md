# ENIGMA Session State — 2026-06-06 13:43
...
_Сессия: 2.5 мин | Тиков: 6 | LLM-вызовов: 4_
...
| **CVS** (Causal Velocity) | 1.57/мин | ↑ +1.6 | ✅ 1.57/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 33% | ↑ -66.7% | ⛔ 2 пред-шинных отказов — pipeline молча умирает, CDS слеп |

**Системные сигналы (требуют внимания):**
- SCF упал с 1.0 до 0.0: spatial fallback + node_not_found = регрессия spatial слоя

_История: `reports/dna_history.jsonl` — 373 записей_
...
**Tick Pipeline:**
Тиков: 6 | Decisions > 0: 4/6 | LLM: 4 вызовов / 4 ответов | Симуляция: ✅ живёт
...
| guard_borko | OBSERVE | 0.339 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 0.594 | ❌ | None | ❌ |
| merchant_goran | OBSERVE | 0.357 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | REPORT | 0.327 | ✅ | None | ❌ |
| thief_shadow | TALK | 0.284 | ❌ | None | ❌ |
