# ENIGMA Session State — 2026-08-08 23:42
...
_Сессия: 1.0 мин | Тиков: 79 | LLM-вызовов: 80_
...
| **CVS** (Causal Velocity) | 82.79/мин | ↑ +82.8 | ✅ 82.79/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 539 (idx=6.82) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 468 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 981 записей_
...
**Tick Pipeline:**
Тиков: 79 | Decisions > 0: 1/79 | LLM: 80 вызовов / 80 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.732 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | seek_ally | 0.166 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | observe | 0.171 | ❌ | x=10.5 y=6.5 | ❌ |
| merchant_goran | offer_job | 0.634 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.199 | ❌ | x=10.5 y=3.0 | ❌ |
| thief_shadow | approach | 0.162 | ❌ | None | ❌ |
