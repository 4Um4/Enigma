# ENIGMA Session State — 2026-06-07 23:39
...
| **NPI** (NPC Pipeline) | 29% | ↓ -4.7% | ⚠️ 2/7 NPC с координатами: spatial pipeline частично сломан |
...
_История: `reports/dna_history.jsonl` — 418 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | TRADE | 0.225 | ✅ | None | ❌ |
| guard_borko | WARN | 0.289 | ✅ | x=15.3 y=3.5 | ❌ |
| maid_lusya | OBSERVE | 0.388 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.258 | ✅ | x=10.2 y=3.9 | ❌ |
| player | ? | 0.000 | ✅ | None | ❌ |
| tavern_keeper_tornin | REPORT | 0.274 | ✅ | None | ❌ |
| thief_shadow | OBSERVE | 0.519 | ✅ | None | ❌ |
