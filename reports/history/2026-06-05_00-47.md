# ENIGMA Session State — 2026-06-05 00:47
...
| **CVS** (Causal Velocity) | 3.25/мин | ↑ +1.1 | ✅ 3.25/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 17% | ↑ -83.3% | ⚠️ 1 пред-шинных отказов — CDS слеп к части крахов |

_История: `reports/dna_history.jsonl` — 334 записей_
...
- NPC с известными координатами (3):
  - `tavern_keeper_tornin`: x=1.6 y=1.7
  - `guard_borko`: x=12.6 y=3.6
  - `merchant_goran`: x=10.9 y=3.4
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ATTACK | 0.778 | ✅ | None | ❌ |
| guard_borko | FLEE | 1.224 | ✅ | x=12.6 y=3.6 | ❌ |
| maid_lusya | FLEE | 1.090 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.729 | ✅ | x=10.9 y=3.4 | ❌ |
| tavern_keeper_tornin | ATTACK | 1.026 | ✅ | x=1.6 y=1.7 | ❌ |
| thief_shadow | FLEE | 0.665 | ✅ | None | ❌ |
