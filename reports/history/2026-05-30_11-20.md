# ENIGMA Session State — 2026-05-30 11:20
...
_История: `reports/dna_history.jsonl` — 227 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.292 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.526 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.428 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.449 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.457 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.179 | ❌ узел не найден | None | ❌ |
