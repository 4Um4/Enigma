# ENIGMA Session State — 2026-06-27 16:05
...
| **CVS** (Causal Velocity) | 3.42/мин | ↓ -0.9 | ✅ 3.42/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | ↑ -350.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 600 записей_
...
| guard_borko | block_path | 0.328 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | spread_rumor | 0.175 | ❌ | x=4.5 y=5.0 | ❌ |
