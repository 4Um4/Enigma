# ENIGMA Session State — 2026-05-29 00:27
...
_История: `reports/dna_history.jsonl` — 134 записей_
...
| guard_borko | FLEE | 1.212 | ❌ | None | ❌ |
| maid_lusya | FLEE | 2.393 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.101 | ❌ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.404 | ❌ узел не найден | None | ❌ |
