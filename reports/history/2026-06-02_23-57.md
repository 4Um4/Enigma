# ENIGMA Session State — 2026-06-02 23:57
...
_История: `reports/dna_history.jsonl` — 308 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 1.020 | ❌ | x=16.4 y=5.5 | ❌ |
| guard_borko | OBSERVE | 1.060 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | OBSERVE | 1.122 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.984 | ❌ | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | ATTACK | 1.588 | ❌ узел не найден | x=4.5 y=2.5 | ❌ |
| thief_shadow | OBSERVE | 1.311 | ❌ | None | ❌ |
