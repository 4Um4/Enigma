# ENIGMA Session State — 2026-05-29 22:42
...
_История: `reports/dna_history.jsonl` — 204 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.278 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.225 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 0.467 | ❌ узел не найден | None | ❌ |
| merchant_goran | OFFER_JOB | 0.243 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.293 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.322 | ❌ узел не найден | None | ❌ |
