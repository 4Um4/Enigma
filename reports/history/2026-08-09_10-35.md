# ENIGMA Session State — 2026-08-09 10:35
...
_Сессия: 0.2 мин | Тиков: 1 | LLM-вызовов: 4_
...
| **CVS** (Causal Velocity) | 17.93/мин | ↑ +16.9 | ✅ 17.93/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 995 записей_
...
**Tick Pipeline:**
Тиков: 1 | Decisions > 0: 0/1 | LLM: 4 вызовов / 2 ответов | Симуляция: ❌ МЕРТВА
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ? | 0.000 | ❌ | x=10.5 y=6.5 | ❌ |
| guard_borko | ? | 0.000 | ❌ | x=11.0 y=10.0 | ❌ |
| maid_lusya | ? | 0.000 | ❌ | x=8.0 y=1.8 | ❌ |
| merchant_goran | ? | 0.000 | ❌ | x=10.5 y=3.0 | ❌ |
