# ENIGMA Session State — 2026-08-08 23:55
...
_Сессия: 1.7 мин | Тиков: 89 | LLM-вызовов: 100_
...
| **CVS** (Causal Velocity) | 58.09/мин | ↓ -24.7 | ✅ 58.09/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 704 (idx=7.91) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 535 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 983 записей_
...
**Tick Pipeline:**
Тиков: 89 | Decisions > 0: 2/89 | LLM: 100 вызовов / 100 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.851 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | block_path | 0.256 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | call_for_help | 0.199 | ❌ | x=10.5 y=6.5 | ❌ |
| merchant_goran | request_service | 0.525 | ❌ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.203 | ❌ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.276 | ❌ | x=10.5 y=6.5 | ❌ |
