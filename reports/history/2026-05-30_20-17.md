# ENIGMA Session State — 2026-05-30 20:17
...
_История: `reports/dna_history.jsonl` — 239 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.434 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.605 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.433 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.438 | ❌ | x=8.0 y=7.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.549 | ✅ | None | ❌ |
| thief_shadow | FLEE | 2.163 | ❌ узел не найден | None | ❌ |
