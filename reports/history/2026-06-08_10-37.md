# ENIGMA Session State — 2026-06-08 10:37
...
_История: `reports/dna_history.jsonl` — 424 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.406 | ❌ | None | ❌ |
| guard_borko | REPORT | 0.300 | ❌ | x=9.3 y=3.1 | ❌ |
| maid_lusya | FLEE | 0.500 | ✅ | None | ❌ |
| merchant_goran | CHANGE_ROLE | 0.362 | ❌ | x=17.4 y=3.4 | ❌ |
| tavern_keeper_tornin | REPORT | 0.388 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.515 | ✅ | None | ❌ |
