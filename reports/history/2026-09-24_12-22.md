# ENIGMA Session State — 2026-09-24 12:22
...
_Сессия: 0.4 мин | Тиков: 16 | LLM-вызовов: 10_
...
| **CVS** (Causal Velocity) | 25.69/мин | ↓ -1.0 | ✅ 25.69/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 90 (idx=5.62) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 111 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1189 записей_
...
- NPC с известными координатами (6):
  ...
  - `tavern_keeper_tornin`: x=15.1 y=2.7
...
**Tick Pipeline:**
Тиков: 16 | Decisions > 0: 2/16 | LLM: 10 вызовов / 10 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | idle | 0.000 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | flee | 0.638 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.437 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | idle | 0.000 | ✅ | x=6.5 y=5.5 | ❌ |
| player | flee | 0.568 | ✅ | None | ❌ |
| tavern_keeper_tornin | idle | 0.000 | ✅ | x=15.1 y=2.7 | ❌ |
| thief_shadow | observe | 0.725 | ✅ | x=11.5 y=11.0 | ❌ |
