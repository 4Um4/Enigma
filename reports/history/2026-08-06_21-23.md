# ENIGMA Session State — 2026-08-06 21:23
...
_(ошибка вычисления: 'MovementHealthReport' object has no attribute 'npc_total')_
...
**Tick Pipeline:**
Тиков: 0 | Decisions > 0: 1/0 | LLM: 138 вызовов / 134 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.731 | ❌ | x=5.5 y=6.0 | ❌ |
| guard_borko | talk | 0.235 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | change_role | 0.171 | ❌ | x=10.5 y=3.0 | ❌ |
| merchant_goran | request_service | 0.615 | ❌ | x=6.5 y=5.5 | ❌ |
| player | idle | 0.215 | ❌ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.165 | ❌ | x=10.5 y=4.8 | ❌ |
