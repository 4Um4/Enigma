# ENIGMA Session State — 2026-06-03 00:55
...
_История: `reports/dna_history.jsonl` — 316 записей_
...
| guard_borko | AMBUSH | 0.238 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.348 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.263 | ❌ | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | FLEE | 0.179 | ❌ узел не найден | x=4.5 y=2.5 | ❌ |
| thief_shadow | FLEE | 0.239 | ❌ | None | ❌ |
