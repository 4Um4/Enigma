# ENIGMA Session State — 2026-06-07 23:29
...
_История: `reports/dna_history.jsonl` — 417 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.271 | ❌ | None | ❌ |
| guard_borko | REPORT | 0.403 | ❌ | x=5.7 y=7.9 | ❌ |
| maid_lusya | FLEE | 0.418 | ✅ | None | ❌ |
| merchant_goran | APPROACH | 0.455 | ✅ | x=10.2 y=3.9 | ❌ |
| tavern_keeper_tornin | FLEE | 0.425 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.387 | ✅ | None | ❌ |
