# ENIGMA Session State — 2026-05-29 12:07
...
_История: `reports/dna_history.jsonl` — 167 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.041 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.120 | ❌ | x=13.7 y=2.3 | ❌ |
| maid_lusya | FLEE | 1.697 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.097 | ❌ | x=13.7 y=1.6 | ❌ |
| tavern_keeper_tornin | FLEE | 1.268 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.836 | ❌ узел не найден | None | ❌ |
