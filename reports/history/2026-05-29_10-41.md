# ENIGMA Session State — 2026-05-29 10:41
...
_История: `reports/dna_history.jsonl` — 159 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.133 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.393 | ❌ | x=13.9 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.485 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.319 | ❌ | x=13.9 y=2.1 | ❌ |
| tavern_keeper_tornin | FLEE | 1.345 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.964 | ❌ узел не найден | None | ❌ |
