# ENIGMA Session State — 2026-06-15 21:06
...
_Сессия: 1.3 мин | Тиков: 0 | LLM-вызовов: 2_
...
| **NPI** (NPC Pipeline) | 50% | ↓ -50.0% | ⚠️ 1/2 NPC с координатами: есть потери в traversal |
...
| **CVS** (Causal Velocity) | 1.57/мин | ↓ -1.4 | ✅ 1.57/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 584 записей_
...
- Узлы не найдены (NPC не могут добраться до цели): 12
