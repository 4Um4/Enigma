# ENIGMA Session State — 2026-05-29 19:24
...
_История: `reports/dna_history.jsonl` — 191 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.163 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.482 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.368 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.333 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.520 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.186 | ❌ узел не найден | None | ❌ |
