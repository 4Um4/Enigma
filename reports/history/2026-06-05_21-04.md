# ENIGMA Session State — 2026-06-05 21:04
...
_Сессия: 2.2 мин | Тиков: 3 | LLM-вызовов: 0_
...
| **PFI** (Pre-Bus Failure) | 167% | ↓ +33.3% | ⛔ 5 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 358 записей_
...
**Tick Pipeline:**
Тиков: 3 | Decisions > 0: 2/3 | LLM: 0 вызовов / 0 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REPORT | 0.335 | ✅ | None | ❌ |
| guard_borko | REPORT | 0.481 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 0.649 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.328 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.410 | ✅ | x=7.1 y=5.4 | ❌ |
