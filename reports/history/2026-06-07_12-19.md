# ENIGMA Session State — 2026-06-07 12:19
...
_Сессия: 1.0 мин | Тиков: 2 | LLM-вызовов: 0_
...
| **PFI** (Pre-Bus Failure) | 200% | ↓ +200.0% | ⛔ 4 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 396 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.453 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.408 | ❌ узел не найден | None | ❌ |
| maid_lusya | OFFER_JOB | 0.183 | ❌ | None | ❌ |
| merchant_goran | CHANGE_ROLE | 0.370 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | SEEK_ALLY | 0.230 | ❌ | None | ❌ |
| thief_shadow | REQUEST_SERVICE | 0.414 | ❌ | None | ❌ |
