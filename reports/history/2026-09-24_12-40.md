# ENIGMA Session State — 2026-09-24 12:40
...
_Сессия: 0.8 мин | Тиков: 46 | LLM-вызовов: 24_
...
| **CVS** (Causal Velocity) | 29.49/мин | ↑ +21.7 | ✅ 29.49/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 180 (idx=3.91) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 315 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1194 записей_
...
**Tick Pipeline:**
Тиков: 46 | Decisions > 0: 3/46 | LLM: 24 вызовов / 24 ответов | Симуляция: ✅ живёт
...
| guard_borko | block_path | 0.651 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.399 | ✅ | x=10.5 y=4.8 | ❌ |
| merchant_goran | offer_job | 0.752 | ✅ | x=6.5 y=5.5 | ❌ |
| player | flee | 0.647 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.179 | ✅ | x=18.4 y=6.3 | ❌ |
| thief_shadow | observe | 0.599 | ✅ | x=11.5 y=11.0 | ❌ |
