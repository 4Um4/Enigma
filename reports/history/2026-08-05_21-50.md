# ENIGMA Session State — 2026-08-05 21:50
...
| **CVS** (Causal Velocity) | 94.13/мин | ↑ +90.4 | ✅ 94.13/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 913 записей_
...
- NPC с известными координатами (4):
  ...
  - `tavern_keeper_tornin`: x=4.0 y=3.0
...
**Tick Pipeline:**
Тиков: 3 | Decisions > 0: 4/3 | LLM: 258 вызовов / 258 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.756 | ❌ | x=10.5 y=3.0 | ❌ |
| guard_borko | idle | 0.205 | ❌ | None | ❌ |
| maid_lusya | flee | 0.192 | ❌ | x=10.5 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.666 | ❌ | x=13.5 y=3.0 | ❌ |
| player | trade | 0.221 | ❌ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.273 | ❌ | x=4.0 y=3.0 | ❌ |
| thief_shadow | warn | 0.159 | ❌ | None | ❌ |
