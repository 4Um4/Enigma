# ENIGMA Session State — 2026-05-20 19:57
...
_Сессия: 0.4 мин | Тиков: 6 | LLM-вызовов: 0_
...
_История: `reports/dna_history.jsonl` — 16 записей_
...
- NPC с известными координатами (2):
  - `tavern_keeper_tornin`: x=4.0 y=2.7
...
**Tick Pipeline:**
Тиков: 6 | Decisions > 0: 0/6 | LLM: 0 вызовов / 0 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.317 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.326 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.363 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.307 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.388 | ✅ | x=4.0 y=2.7 | ❌ |
| thief_shadow | FLEE | 0.399 | ✅ | None | ❌ |
