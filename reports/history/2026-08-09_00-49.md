# ENIGMA Session State — 2026-08-09 00:49
...
| **NPI** (NPC Pipeline) | 100% | ↑ +100.0% | ✅ 5/5 NPC с реальными координатами |
...
| **CVS** (Causal Velocity) | 5.43/мин | ↑ +5.4 | ✅ 5.43/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 991 записей_
...
**Tick Pipeline:**
Тиков: 1 | Decisions > 0: 0/1 | LLM: 5 вызовов / 6 ответов | Симуляция: ❌ МЕРТВА
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ? | 0.000 | ❌ | x=5.5 y=6.0 | ❌ |
| guard_borko | ? | 0.000 | ❌ | x=5.5 y=6.0 | ❌ |
| maid_lusya | ? | 0.000 | ❌ | x=10.5 y=4.8 | ❌ |
| merchant_goran | ? | 0.000 | ❌ | x=5.5 y=6.0 | ❌ |
| tavern_keeper_tornin | ? | 0.000 | ❌ | x=10.5 y=3.0 | ❌ |
