# ENIGMA Session State — 2026-05-24 18:13
...
_История: `reports/dna_history.jsonl` — 58 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | APPROACH | 0.499 | ✅ | None | ❌ |
| guard_borko | TALK | 0.563 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 1.131 | ✅ | None | ❌ |
| merchant_goran | TALK | 0.497 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | IDLE | 0.389 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.166 | ✅ | x=8.0 y=7.0 | ❌ |
