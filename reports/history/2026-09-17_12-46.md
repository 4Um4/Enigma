# ENIGMA Session State — 2026-09-17 12:46
...
_Сессия: 6.3 мин | Тиков: 0 | LLM-вызовов: 0_
...
| **NPI** (NPC Pipeline) | 0% | ↓ -71.4% | ⛔ 0/5 NPC имеют координаты: traversal полностью сломан |
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -15.8 | LLM не вызывалась: сессия без действий игрока |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 96 (AttrErr=0, TypeErr=0) | → | ⚠️ КРИТИЧНО: невидимые регрессии (Tracebacks) |
...
_История: `reports/dna_history.jsonl` — 1131 записей_
