# ENIGMA Session State — 2026-05-29 10:16
...
_История: `reports/dna_history.jsonl` — 153 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.967 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.001 | ❌ | x=14.3 y=1.7 | ❌ |
| maid_lusya | FLEE | 1.763 | ❌ узел не найден | None | ❌ |
| merchant_goran | OBSERVE | 0.965 | ❌ | x=14.2 y=1.7 | ❌ |
| tavern_keeper_tornin | FLEE | 1.098 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.839 | ❌ узел не найден | None | ❌ |
