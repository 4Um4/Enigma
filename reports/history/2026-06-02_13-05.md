# ENIGMA Session State — 2026-06-02 13:05
...
_История: `reports/dna_history.jsonl` — 286 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.555 | ❌ | None | ❌ |
| guard_borko | OBSERVE | 0.693 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 0.935 | ❌ | None | ❌ |
| merchant_goran | OBSERVE | 0.654 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.743 | ❌ | None | ❌ |
| thief_shadow | FLEE | 1.013 | ✅ | None | ❌ |
