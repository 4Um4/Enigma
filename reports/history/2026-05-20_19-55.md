# ENIGMA Session State — 2026-05-20 19:55
...
_Сессия: 0.7 мин | Тиков: 15 | LLM-вызовов: 0_
...
| **SCF** (Spatial Coherence) | 0.0 | ↓ -0.5 | ⛔ РАЗРУШЕНО: узлы не найдены → NPC не могут двигаться |
...
_История: `reports/dna_history.jsonl` — 15 записей_
...
- NPC с известными координатами (2):
  - `tavern_keeper_tornin`: x=3.9 y=2.5
...
**Tick Pipeline:**
Тиков: 15 | Decisions > 0: 0/15 | LLM: 0 вызовов / 0 ответов | Симуляция: ✅ живёт
...
| guard_borko | FLEE | 0.287 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.333 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.332 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.249 | ✅ | x=3.9 y=2.5 | ❌ |
| thief_shadow | CHANGE_ROLE | 0.258 | ✅ | None | ❌ |
