# ENIGMA Session State — 2026-08-17 21:30
...
_Сессия: 2.2 мин | Тиков: 50 | LLM-вызовов: 55_
...
| **CVS** (Causal Velocity) | 24.64/мин | ↑ +24.6 | ✅ 24.64/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 28 (AttrErr=0, TypeErr=0) | → | ⚠️ КРИТИЧНО: невидимые регрессии (Tracebacks) |
| **BCI** (Belief Crystallization) | 406 (idx=8.12) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 332 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1047 записей_
...
**Tick Pipeline:**
Тиков: 50 | Decisions > 0: 3/50 | LLM: 55 вызовов / 53 ответов | Симуляция: ❌ МЕРТВА
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.978 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | observe | 0.172 | ✅ | x=6.0 y=8.0 | ❌ |
| maid_lusya | observe | 0.220 | ✅ | x=6.5 y=5.5 | ❌ |
| merchant_goran | request_service | 0.697 | ✅ | x=6.5 y=5.5 | ❌ |
| player | idle | 0.222 | ✅ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.165 | ✅ | x=6.5 y=5.5 | ❌ |
