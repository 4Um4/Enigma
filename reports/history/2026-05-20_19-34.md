# ENIGMA Session State — 2026-05-20 19:34
...
_Сессия: 1.5 мин | Тиков: 29 | LLM-вызовов: 0_
...
| **NPI** (NPC Pipeline) | 50% | ↓ -33.3% | ⚠️ 3/6 NPC с координатами: есть потери в traversal |
...
_История: `reports/dna_history.jsonl` — 14 записей_
...
**Tick Pipeline:**
Тиков: 29 | Decisions > 0: 0/29 | LLM: 0 вызовов / 0 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.260 | ❌ | x=16.4 y=5.5 | ❌ |
| guard_borko | FLEE | 0.299 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.427 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.359 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.316 | ✅ | x=4.5 y=2.5 | ❌ |
| thief_shadow | FLEE | 0.290 | ✅ | None | ❌ |
