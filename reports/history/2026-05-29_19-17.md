# ENIGMA Session State — 2026-05-29 19:17
...
_История: `reports/dna_history.jsonl` — 189 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.260 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.291 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 0.344 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.393 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.385 | ❌ узел не найден | None | ❌ |
