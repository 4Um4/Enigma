# ENIGMA Session State — 2026-05-26 11:01
...
_История: `reports/dna_history.jsonl` — 85 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | WARN | 0.494 | ❌ | None | ❌ |
| guard_borko | WARN | 0.748 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.286 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.533 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.930 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.590 | ✅ | None | ❌ |
