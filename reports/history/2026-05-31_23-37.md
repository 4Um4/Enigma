# ENIGMA Session State — 2026-05-31 23:37
...
_История: `reports/dna_history.jsonl` — 253 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.105 | ✅ | None | ❌ |
| guard_borko | FLEE | 1.230 | ✅ | None | ❌ |
| maid_lusya | FLEE | 1.617 | ✅ | None | ❌ |
| merchant_goran | FLEE | 1.174 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.149 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.806 | ✅ | None | ❌ |
