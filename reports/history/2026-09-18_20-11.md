# ENIGMA Session State — 2026-09-18 20:11
...
_Сессия: 2.9 мин | Тиков: 71 | LLM-вызовов: 84_
...
| **CVS** (Causal Velocity) | 28.61/мин | ↑ +4.5 | ✅ 28.61/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 450 (idx=6.34) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 496 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1152 записей_
...
- NPC с известными координатами (6):
  ...
  - `tavern_keeper_tornin`: x=7.8 y=4.7
...
**Tick Pipeline:**
Тиков: 71 | Decisions > 0: 1/71 | LLM: 84 вызовов / 84 ответов | Симуляция: ✅ живёт
...
| guard_borko | help | 0.630 | ✅ | x=33.8 y=9.5 | ❌ |
| maid_lusya | flee | 1.360 | ✅ | x=10.5 y=6.5 | ❌ |
| merchant_goran | warn | 0.645 | ✅ | x=6.5 y=5.5 | ❌ |
| player | flee | 0.603 | ✅ | None | ❌ |
| tavern_keeper_tornin | help | 0.926 | ✅ | x=7.8 y=4.7 | ❌ |
| thief_shadow | observe | 0.512 | ⏸ | x=11.5 y=11.0 | ❌ |
