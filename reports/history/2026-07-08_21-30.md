# ENIGMA Session State — 2026-07-08 21:30
...
| **PFI** (Pre-Bus Failure) | 300% | ↓ +50.0% | ⛔ 3 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 680 записей_
...
**Симптом:** За 5 тиков было 20 вербальных интентов, но 0 реплик в recent_dialogues. Цепочка порвана.
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | offer_job | 0.503 | ❌ | x=10.5 y=5.0 | ❌ |
| guard_borko | block_path | 0.302 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | request_service | 0.255 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | request_service | 0.313 | ❌ | x=9.0 y=9.0 | ❌ |
| player | call_for_help | 0.306 | ❌ | None | ❌ |
| tavern_keeper_tornin | seek_ally | 0.202 | ❌ | x=4.5 y=2.5 | ❌ |
| thief_shadow | request_service | 0.305 | ❌ | x=7.5 y=6.8 | ❌ |
