# ENIGMA Session State — 2026-08-08 20:27
...
_Сессия: 0.4 мин | Тиков: 33 | LLM-вызовов: 38_
...
| **CVS** (Causal Velocity) | 87.99/мин | ↑ +88.0 | ✅ 87.99/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 210 (idx=6.36) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 198 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 949 записей_
...
**Tick Pipeline:**
Тиков: 33 | Decisions > 0: 1/33 | LLM: 38 вызовов / 36 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.750 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | spread_rumor | 0.227 | ❌ | x=6.5 y=5.5 | ❌ |
| maid_lusya | observe | 0.244 | ❌ | x=7.8 y=5.8 | ❌ |
| merchant_goran | offer_job | 0.656 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | seek_ally | 0.234 | ❌ | x=10.5 y=4.8 | ❌ |
