# ENIGMA Session State — 2026-05-28 22:12
...
_История: `reports/dna_history.jsonl` — 124 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.827 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.880 | ❌ | x=14.1 y=2.0 | ❌ |
| maid_lusya | FLEE | 1.576 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.730 | ❌ | x=13.7 y=2.3 | ❌ |
| tavern_keeper_tornin | FLEE | 0.975 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.552 | ❌ узел не найден | None | ❌ |
