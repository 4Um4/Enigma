# ENIGMA Session State — 2026-09-26 11:51
...
_Сессия: 1.4 мин | Тиков: 133 | LLM-вызовов: 34_
...
| **CVS** (Causal Velocity) | 23.93/мин | ↓ -2.0 | ✅ 23.93/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 924 (idx=6.95) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 924 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1242 записей_
...
**Tick Pipeline:**
Тиков: 133 | Decisions > 0: 2/133 | LLM: 34 вызовов / 36 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | warn | 1.887 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | talk | 1.567 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | spread_rumor | 2.329 | ✅ | x=16.7 y=2.4 | ❌ |
| merchant_goran | flee | 0.911 | ✅ | x=10.5 y=4.8 | ❌ |
| tavern_keeper_tornin | talk | 1.441 | ✅ | x=16.7 y=2.4 | ❌ |
| thief_shadow | observe | 0.614 | ✅ | x=11.5 y=11.0 | ❌ |
