# ENIGMA Session State — 2026-09-18 19:38
...
_Сессия: 0.6 мин | Тиков: 28 | LLM-вызовов: 14_
...
| **CVS** (Causal Velocity) | 22.92/мин | ↑ +1.1 | ✅ 22.92/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 1149 записей_
...
**Tick Pipeline:**
Тиков: 28 | Decisions > 0: 1/28 | LLM: 14 вызовов / 12 ответов | Симуляция: ✅ живёт
