# ENIGMA Session State — 2026-09-18 19:57
...
_Сессия: 2.2 мин | Тиков: 31 | LLM-вызовов: 54_
...
| **CVS** (Causal Velocity) | 24.13/мин | ↑ +10.7 | ✅ 24.13/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 243 (idx=7.84) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 216 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1150 записей_
...
**Tick Pipeline:**
Тиков: 31 | Decisions > 0: 1/31 | LLM: 54 вызовов / 54 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.067 | ✅ | x=5.8 y=7.0 | ❌ |
| guard_borko | help | 0.519 | ✅ | x=8.1 y=13.0 | ❌ |
| maid_lusya | flee | 1.518 | ✅ | x=10.5 y=6.5 | ❌ |
| merchant_goran | warn | 0.491 | ✅ | x=5.5 y=6.0 | ❌ |
| player | flee | 0.645 | ✅ | None | ❌ |
| tavern_keeper_tornin | help | 0.847 | ✅ | x=10.5 y=4.8 | ❌ |
| thief_shadow | observe | 0.559 | ⏸ | x=11.5 y=11.0 | ❌ |
