# ENIGMA Session State — 2026-07-01 06:22
...
| **CVS** (Causal Velocity) | 4.98/мин | ↑ +5.0 | ✅ 4.98/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 641 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | trade | 0.187 | ❌ | x=10.5 y=5.0 | ❌ |
| guard_borko | warn | 0.273 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | observe | 0.428 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | talk | 0.164 | ❌ | x=9.0 y=9.0 | ❌ |
| tavern_keeper_tornin | report | 0.384 | ❌ | x=4.5 y=2.5 | ❌ |
| thief_shadow | warn | 0.242 | ❌ | x=11.5 y=9.5 | ❌ |
