# ENIGMA Session State — 2026-05-29 18:18
...
_История: `reports/dna_history.jsonl` — 184 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.377 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.366 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | OBSERVE | 0.316 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.257 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.296 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.365 | ❌ узел не найден | None | ❌ |
