# ENIGMA Session State — 2026-05-29 17:56
...
_История: `reports/dna_history.jsonl` — 181 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.261 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.340 | ❌ | x=2.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 0.408 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.329 | ❌ | x=2.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.389 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.287 | ❌ узел не найден | None | ❌ |
