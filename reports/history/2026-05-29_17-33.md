# ENIGMA Session State — 2026-05-29 17:33
...
_История: `reports/dna_history.jsonl` — 179 записей_
...
- NPC с известными координатами (2):
  - `guard_borko`: x=2.0 y=2.0
  - `merchant_goran`: x=2.0 y=2.0
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.321 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.380 | ❌ | x=2.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 0.339 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.371 | ❌ | x=2.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.244 | ❌ узел не найден | None | ❌ |
| thief_shadow | CHANGE_ROLE | 0.271 | ❌ узел не найден | None | ❌ |
