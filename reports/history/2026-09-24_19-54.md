# ENIGMA Session State — 2026-09-24 19:54
...
_Сессия: 2.2 мин | Тиков: 230 | LLM-вызовов: 42_
...
| **CVS** (Causal Velocity) | 18.97/мин | ↓ -0.9 | ✅ 18.97/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 1032 (idx=4.49) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 1610 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1197 записей_
...
**Tick Pipeline:**
Тиков: 230 | Decisions > 0: 3/230 | LLM: 42 вызовов / 44 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.193 | ✅ | x=15.2 y=5.7 | ❌ |
| guard_borko | talk | 1.620 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.442 | ✅ | x=10.5 y=6.5 | ❌ |
| merchant_goran | flee | 0.826 | ✅ | x=12.0 y=3.0 | ❌ |
| player | observe | 0.683 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.487 | ✅ | x=16.7 y=2.4 | ❌ |
| thief_shadow | observe | 0.780 | ✅ | x=11.5 y=11.0 | ❌ |
