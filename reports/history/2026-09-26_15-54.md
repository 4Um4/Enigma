# ENIGMA Session State — 2026-09-26 15:54
...
_Сессия: 1.7 мин | Тиков: 40 | LLM-вызовов: 22_
...
| **CVS** (Causal Velocity) | 13.28/мин | ↑ +9.9 | ✅ 13.28/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 209 (idx=5.22) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 273 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1254 записей_
...
**Tick Pipeline:**
Тиков: 40 | Decisions > 0: 2/40 | LLM: 22 вызовов / 22 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.213 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | block_path | 0.667 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.341 | ✅ | x=10.5 y=4.8 | ❌ |
| merchant_goran | offer_job | 0.610 | ✅ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | talk | 1.122 | ✅ | x=16.7 y=2.4 | ❌ |
