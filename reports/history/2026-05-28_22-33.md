# ENIGMA Session State — 2026-05-28 22:33
...
_История: `reports/dna_history.jsonl` — 128 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.930 | ✅ | None | ❌ |
| guard_borko | FLEE | 0.922 | ✅ | None | ❌ |
| maid_lusya | FLEE | 1.682 | ✅ | None | ❌ |
| merchant_goran | OBSERVE | 0.832 | ❌ | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.992 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.867 | ✅ | None | ❌ |
