# ENIGMA Session State — 2026-06-02 22:35
...
_История: `reports/dna_history.jsonl` — 298 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ATTACK | 1.015 | ❌ | x=8.0 y=7.0 | ❌ |
| guard_borko | ATTACK | 1.027 | ❌ | x=8.0 y=7.0 | ❌ |
| maid_lusya | OBSERVE | 1.158 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.868 | ❌ | x=8.0 y=7.0 | ❌ |
| tavern_keeper_tornin | ATTACK | 1.238 | ❌ узел не найден | x=8.0 y=7.0 | ❌ |
| thief_shadow | OBSERVE | 1.256 | ❌ | None | ❌ |
