# ENIGMA Session State — 2026-06-02 17:58
...
_История: `reports/dna_history.jsonl` — 289 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.657 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.706 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 0.944 | ❌ | None | ❌ |
| merchant_goran | OBSERVE | 0.693 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.832 | ❌ | None | ❌ |
| thief_shadow | FLEE | 1.060 | ❌ | None | ❌ |
