# ENIGMA Session State — 2026-06-07 17:02
...
_История: `reports/dna_history.jsonl` — 401 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.459 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.378 | ❌ узел не найден | None | ❌ |
| maid_lusya | CALL_FOR_HELP | 0.253 | ❌ | None | ❌ |
| merchant_goran | CHANGE_ROLE | 0.445 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | SEEK_ALLY | 0.295 | ❌ | None | ❌ |
| thief_shadow | CHANGE_ROLE | 0.449 | ❌ | None | ❌ |
