# ENIGMA Session State — 2026-07-28 21:23
...
_Сессия: 0.9 мин | Тиков: 0 | LLM-вызовов: 2_
...
| **CVS** (Causal Velocity) | 2.14/мин | → +0.4 | ✅ 2.14/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 874 записей_
...
- NPC с известными координатами (6):
  ...
  - `maid_lusya`: x=10.5 y=3.1
  - `blacksmith_orm`: x=9.7 y=5.0
  - `thief_shadow`: x=10.1 y=6.3
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.801 | ❌ | x=9.7 y=5.0 | ❌ |
| guard_borko | idle | 0.219 | ❌ | x=10.9 y=3.5 | ❌ |
| maid_lusya | idle | 0.193 | ❌ | x=10.5 y=3.1 | ❌ |
| merchant_goran | flee | 0.211 | ❌ | x=3.9 y=6.0 | ❌ |
| tavern_keeper_tornin | flee | 0.186 | ❌ | x=11.1 y=6.0 | ❌ |
| thief_shadow | observe | 0.246 | ❌ | x=10.1 y=6.3 | ❌ |
