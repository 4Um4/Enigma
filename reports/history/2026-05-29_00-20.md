# ENIGMA Session State — 2026-05-29 00:20
...
_История: `reports/dna_history.jsonl` — 132 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.031 | ❌ | None | ❌ |
| guard_borko | OBSERVE | 0.963 | ✅ | None | ❌ |
| maid_lusya | FLEE | 1.768 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.031 | ❌ | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 1.043 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.797 | ❌ узел не найден | None | ❌ |
