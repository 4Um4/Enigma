# ENIGMA Session State — 2026-09-20 13:43
...
_Сессия: 3.5 мин | Тиков: 96 | LLM-вызовов: 104_
...
| **CVS** (Causal Velocity) | 29.67/мин | ↑ +5.4 | ✅ 29.67/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 486 (idx=5.06) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 671 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1160 записей_
...
**Tick Pipeline:**
Тиков: 96 | Decisions > 0: 1/96 | LLM: 104 вызовов / 104 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.236 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | talk | 1.306 | ✅ | x=33.8 y=9.5 | ❌ |
| maid_lusya | flee | 1.408 | ✅ | x=10.5 y=4.8 | ❌ |
| merchant_goran | warn | 0.585 | ✅ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.608 | ✅ | None | ❌ |
| tavern_keeper_tornin | help | 0.661 | ✅ | x=6.5 y=5.5 | ❌ |
| thief_shadow | observe | 0.365 | ✅ | x=33.8 y=9.5 | ❌ |
