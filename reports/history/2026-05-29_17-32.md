# ENIGMA Session State — 2026-05-29 17:32
...
_История: `reports/dna_history.jsonl` — 178 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.336 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.381 | ❌ | x=2.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 0.382 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.403 | ❌ | x=2.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.304 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.258 | ❌ узел не найден | None | ❌ |
