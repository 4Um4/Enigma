# ENIGMA Session State — 2026-06-07 17:23
...
_История: `reports/dna_history.jsonl` — 402 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.501 | ❌ | None | ❌ |
| guard_borko | SEEK_ALLY | 0.342 | ❌ узел не найден | None | ❌ |
| maid_lusya | CALL_FOR_HELP | 0.251 | ❌ | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.426 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | SEEK_ALLY | 0.270 | ❌ | None | ❌ |
| thief_shadow | REQUEST_SERVICE | 0.425 | ❌ | None | ❌ |
