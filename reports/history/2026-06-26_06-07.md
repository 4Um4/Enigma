# ENIGMA Session State — 2026-06-26 06:07
...
_Сессия: 3.9 мин | Тиков: 5 | LLM-вызовов: 14_
...
| **CVS** (Causal Velocity) | 3.58/мин | ↑ +3.6 | ✅ 3.58/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 597 записей_
...
- NPC с известными координатами (6):
  - `maid_lusya`: x=8.0 y=7.1
  - `guard_borko`: x=12.0 y=9.7
  - `blacksmith_orm`: x=11.0 y=3.6
  - `tavern_keeper_tornin`: x=12.2 y=10.1
  - `thief_shadow`: x=8.4 y=7.1
  - `merchant_goran`: x=11.7 y=7.4
...
**Tick Pipeline:**
Тиков: 5 | Decisions > 0: 0/5 | LLM: 14 вызовов / 14 ответов | Симуляция: ❌ МЕРТВА
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | TRADE | 0.000 | ✅ | x=11.0 y=3.6 | ❌ |
| guard_borko | REPORT | 0.000 | ✅ | x=12.0 y=9.7 | ❌ |
| maid_lusya | OBSERVE | 0.000 | ✅ | x=8.0 y=7.1 | ❌ |
| merchant_goran | APPROACH | 0.000 | ✅ | x=11.7 y=7.4 | ❌ |
| tavern_keeper_tornin | WARN | 0.000 | ✅ | x=12.2 y=10.1 | ❌ |
| thief_shadow | WARN | 0.000 | ✅ | x=8.4 y=7.1 | ❌ |
