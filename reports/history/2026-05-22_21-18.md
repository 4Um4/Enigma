# ENIGMA Session State — 2026-05-22 21:18
...
_История: `reports/dna_history.jsonl` — 33 записей_
...
- NPC с известными координатами (5):
  ...
  - `tavern_keeper_tornin`: x=3.9 y=2.1
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.336 | ❌ | x=16.4 y=5.5 | ❌ |
| guard_borko | FLEE | 0.226 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.405 | ✅ | x=8.0 y=7.0 | ❌ |
| merchant_goran | FLEE | 0.318 | ❌ | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.240 | ✅ | x=3.9 y=2.1 | ❌ |
| thief_shadow | CHANGE_ROLE | 0.224 | ✅ | None | ❌ |
