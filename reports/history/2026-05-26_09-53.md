# ENIGMA Session State — 2026-05-26 09:53
...
_История: `reports/dna_history.jsonl` — 83 записей_
...
| guard_borko | OBSERVE | 0.496 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 1.508 | ✅ | None | ❌ |
| merchant_goran | OBSERVE | 0.529 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.737 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.384 | ✅ | None | ❌ |
