# ENIGMA Session State — 2026-07-26 20:58

Кампания: `Open_road` | Игрок: `Дейв`
...
| **CVS** (Causal Velocity) | 20.86/мин | ↑ +1.0 | ✅ 20.86/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 815 записей_
