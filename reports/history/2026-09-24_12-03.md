# ENIGMA Session State — 2026-09-24 12:03
...
_Сессия: 0.7 мин | Тиков: 46 | LLM-вызовов: 18_
...
| **CVS** (Causal Velocity) | 26.64/мин | ↑ +22.8 | ✅ 26.64/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 189 (idx=4.11) | → | ✅ Убеждения формируются |
...
_История: `reports/dna_history.jsonl` — 1186 записей_
...
**Tick Pipeline:**
Тиков: 46 | Decisions > 0: 3/46 | LLM: 18 вызовов / 16 ответов | Симуляция: ✅ живёт
...
| guard_borko | block_path | 0.611 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.443 | ✅ | x=10.5 y=6.5 | ❌ |
| merchant_goran | offer_job | 0.741 | ✅ | x=6.5 y=5.5 | ❌ |
| player | flee | 0.589 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.196 | ✅ | x=18.4 y=6.3 | ❌ |
| thief_shadow | observe | 0.498 | ✅ | x=11.5 y=11.0 | ❌ |
