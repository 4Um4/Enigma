# ENIGMA Session State — 2026-09-20 14:03
...
_Сессия: 3.7 мин | Тиков: 154 | LLM-вызовов: 108_
...
| **CVS** (Causal Velocity) | 28.99/мин | ↓ -0.7 | ✅ 28.99/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 711 (idx=4.62) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 1071 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1162 записей_
...
**Tick Pipeline:**
Тиков: 154 | Decisions > 0: 1/154 | LLM: 108 вызовов / 108 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | help | 0.211 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | talk | 1.470 | ✅ | x=33.8 y=9.5 | ❌ |
| maid_lusya | flee | 1.354 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | flee | 0.870 | ✅ | x=7.8 y=5.8 | ❌ |
| player | observe | 0.708 | ⏸ | None | ❌ |
| tavern_keeper_tornin | talk | 0.792 | ✅ | x=10.5 y=3.0 | ❌ |
| thief_shadow | trade | 0.542 | ✅ | x=33.8 y=9.5 | ❌ |
