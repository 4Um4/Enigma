# ENIGMA Session State — 2026-06-06 01:44
...
_Сессия: 2.3 мин | Тиков: 7 | LLM-вызовов: 6_
...
| **CVS** (Causal Velocity) | 2.62/мин | ↑ +2.6 | ✅ 2.62/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 43% | ↓ +9.5% | ⛔ 3 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 369 записей_
...
**Tick Pipeline:**
Тиков: 7 | Decisions > 0: 5/7 | LLM: 6 вызовов / 6 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.314 | ✅ | None | ❌ |
| guard_borko | REPORT | 0.310 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 0.625 | ❌ | None | ❌ |
| merchant_goran | TALK | 0.370 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.352 | ✅ | None | ❌ |
| thief_shadow | TALK | 0.303 | ❌ | None | ❌ |
...
**NPC с разрывом в pipeline (intent есть, traversal нет):**
  ...
  - `thief_shadow`: intent=TALK, traversal=❌, coords=None
