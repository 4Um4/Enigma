# ENIGMA Session State — 2026-08-06 21:54
...
_Сессия: 1.1 мин | Тиков: 79 | LLM-вызовов: 114_
...
| **CVS** (Causal Velocity) | 108.33/мин | ↓ -4.7 | ✅ 108.33/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 518 (idx=6.56) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 470 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 922 записей_
...
**Tick Pipeline:**
Тиков: 79 | Decisions > 0: 1/79 | LLM: 114 вызовов / 112 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.731 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | talk | 0.220 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | observe | 0.233 | ❌ | x=11.2 y=4.8 | ❌ |
| merchant_goran | request_service | 0.642 | ❌ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.315 | ❌ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.255 | ❌ | x=10.5 y=4.8 | ❌ |
