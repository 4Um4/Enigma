# ENIGMA Session State — 2026-07-05 11:35
...
_История: `reports/dna_history.jsonl` — 652 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | offer_job | 0.818 | ❌ | x=10.5 y=5.0 | ❌ |
| guard_borko | spread_rumor | 0.615 | ❌ | x=18.0 y=7.2 | ❌ |
| maid_lusya | offer_job | 0.684 | ❌ | x=11.0 y=4.0 | ❌ |
| merchant_goran | call_for_help | 0.650 | ❌ | x=11.0 y=4.0 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.585 | ❌ | x=16.0 y=4.0 | ❌ |
| thief_shadow | request_service | 0.605 | ❌ | x=11.0 y=4.0 | ❌ |
