# ENIGMA Session State — 2026-05-29 18:25
...
_История: `reports/dna_history.jsonl` — 187 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.276 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.474 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.378 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.472 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.390 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.030 | ❌ узел не найден | None | ❌ |
