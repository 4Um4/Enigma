# ENIGMA Session State — 2026-07-15 23:46
...
_История: `reports/dna_history.jsonl` — 712 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.868 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | call_for_help | 0.269 | ❌ | x=12.4 y=10.4 | ❌ |
| maid_lusya | seek_ally | 0.250 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | request_service | 0.408 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.255 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | ambush | 0.368 | ❌ | x=11.6 y=9.8 | ❌ |
