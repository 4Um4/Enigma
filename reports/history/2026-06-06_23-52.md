# ENIGMA Session State — 2026-06-06 23:52
...
_История: `reports/dna_history.jsonl` — 383 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.458 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.412 | ❌ узел не найден | None | ❌ |
| maid_lusya | SPREAD_RUMOR | 0.279 | ❌ | None | ❌ |
| merchant_goran | CHANGE_ROLE | 0.448 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | SEEK_ALLY | 0.295 | ❌ | None | ❌ |
| thief_shadow | CHANGE_ROLE | 0.444 | ❌ | None | ❌ |
