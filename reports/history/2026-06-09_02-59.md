# ENIGMA Session State — 2026-06-09 02:59
...
_История: `reports/dna_history.jsonl` — 444 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ATTACK | 0.626 | ❌ | None | ❌ |
| guard_borko | ATTACK | 0.717 | ❌ | None | ❌ |
| maid_lusya | FLEE | 1.224 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.573 | ✅ | x=4.0 y=2.5 | ❌ |
| tavern_keeper_tornin | ATTACK | 1.035 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.613 | ✅ | None | ❌ |
