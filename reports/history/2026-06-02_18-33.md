# ENIGMA Session State — 2026-06-02 18:33
...
_Сессия: 1.9 мин | Тиков: 8 | LLM-вызовов: 8_
...
**Tick Pipeline:**
Тиков: 8 | Decisions > 0: 8/8 | LLM: 8 вызовов / 8 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | APPROACH | 0.454 | ✅ | x=15.6 y=2.9 | ❌ |
| guard_borko | OBSERVE | 0.516 | ✅ | x=16.0 y=4.5 | ❌ |
| maid_lusya | OBSERVE | 0.923 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.482 | ✅ | x=16.0 y=4.5 | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.454 | ✅ | x=16.0 y=4.5 | ❌ |
| thief_shadow | FLEE | 0.523 | ✅ | None | ❌ |
