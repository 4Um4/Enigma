# ENIGMA Session State — 2026-05-29 11:30
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -4.1 | LLM не вызывалась: сессия без действий игрока |

_История: `reports/dna_history.jsonl` — 164 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.071 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.176 | ❌ | x=13.7 y=2.3 | ❌ |
| maid_lusya | FLEE | 1.665 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.080 | ❌ | x=13.7 y=1.6 | ❌ |
| tavern_keeper_tornin | FLEE | 1.190 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.972 | ❌ узел не найден | None | ❌ |
