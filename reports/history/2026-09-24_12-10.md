# ENIGMA Session State — 2026-09-24 12:10
...
_Сессия: 1.7 мин | Тиков: 201 | LLM-вызовов: 46_
...
| **CVS** (Causal Velocity) | 26.65/мин | ↑ +7.4 | ✅ 26.65/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 918 (idx=4.57) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 1400 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1187 записей_
...
**Tick Pipeline:**
Тиков: 201 | Decisions > 0: 3/201 | LLM: 46 вызовов / 48 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.261 | ✅ | x=15.2 y=5.7 | ❌ |
| guard_borko | talk | 1.549 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.408 | ✅ | x=10.5 y=4.8 | ❌ |
| merchant_goran | flee | 0.864 | ✅ | x=10.5 y=3.0 | ❌ |
| player | observe | 0.819 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.460 | ✅ | x=17.3 y=3.7 | ❌ |
| thief_shadow | observe | 0.758 | ✅ | x=11.5 y=11.0 | ❌ |
