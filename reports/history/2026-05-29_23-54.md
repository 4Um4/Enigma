# ENIGMA Session State — 2026-05-29 23:54
...
_История: `reports/dna_history.jsonl` — 210 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.249 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.459 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.346 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.456 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.475 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.177 | ❌ узел не найден | None | ❌ |
