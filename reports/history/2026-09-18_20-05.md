# ENIGMA Session State — 2026-09-18 20:05
...
_Сессия: 2.3 мин | Тиков: 51 | LLM-вызовов: 70_
...
| **CVS** (Causal Velocity) | 30.28/мин | ↑ +7.4 | ✅ 30.28/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 2 (AttrErr=2, TypeErr=0) | → | ⚠️ КРИТИЧНО: невидимые регрессии (Tracebacks) |
| **BCI** (Belief Crystallization) | 351 (idx=6.88) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 363 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1151 записей_
...
**Tick Pipeline:**
Тиков: 51 | Decisions > 0: 1/51 | LLM: 70 вызовов / 70 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.992 | ✅ | x=5.8 y=7.0 | ❌ |
| guard_borko | help | 0.668 | ✅ | x=23.1 y=9.3 | ❌ |
| maid_lusya | flee | 1.420 | ✅ | x=10.5 y=6.5 | ❌ |
| merchant_goran | warn | 0.578 | ✅ | x=6.0 y=8.0 | ❌ |
| player | observe | 0.594 | ✅ | None | ❌ |
| tavern_keeper_tornin | help | 0.761 | ✅ | x=10.5 y=6.5 | ❌ |
| thief_shadow | observe | 0.648 | ⏸ | x=11.5 y=11.0 | ❌ |
