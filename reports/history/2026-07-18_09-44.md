# ENIGMA Session State — 2026-07-18 09:44
...
| **CVS** (Causal Velocity) | 6.50/мин | ↑ +1.4 | ✅ 6.50/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 741 записей_
...
- LLM CJK-галлюцинации: 38 строк
- Стартап backend: ✅
- LLM сервер: ✅

**Предупреждения:**
  - ⚠️ LLM галлюцинирует на китайском: 38 строк

**Movement Pipeline (по NPC):**
| NPC | Intent | Score | Traversal | Координаты | Виден игроку |
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.472 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | ambush | 0.259 | ❌ | None | ❌ |
| maid_lusya | idle | 0.232 | ❌ | x=11.0 y=4.2 | ❌ |
| merchant_goran | offer_job | 0.317 | ❌ | x=10.4 y=3.5 | ❌ |
| player | call_for_help | 0.283 | ❌ | None | ❌ |
| tavern_keeper_tornin | idle | 0.217 | ❌ | x=11.6 y=3.5 | ❌ |
| thief_shadow | block_path | 0.275 | ❌ | x=11.6 y=9.8 | ❌ |
