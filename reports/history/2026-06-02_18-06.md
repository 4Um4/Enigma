# ENIGMA Session State — 2026-06-02 18:06
...
_Сессия: 1.1 мин | Тиков: 4 | LLM-вызовов: 0_
...
_История: `reports/dna_history.jsonl` — 291 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.854 | ❌ | None | ❌ |
| guard_borko | ATTACK | 1.212 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 1.045 | ❌ | None | ❌ |
| merchant_goran | OBSERVE | 0.923 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | ATTACK | 1.180 | ❌ узел не найден | None | ❌ |
| thief_shadow | OBSERVE | 1.167 | ❌ | None | ❌ |

**NPC с разрывом в pipeline (intent есть, traversal нет):**
  - `guard_borko`: intent=ATTACK, traversal=❌, coords=None
