# ENIGMA Session State — 2026-05-26 21:00
...
_История: `reports/dna_history.jsonl` — 87 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.450 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.510 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 1.554 | ✅ | None | ❌ |
| merchant_goran | OBSERVE | 0.472 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.855 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.456 | ✅ | None | ❌ |
