# ENIGMA Session State — 2026-06-16 22:18
...
_История: `reports/dna_history.jsonl` — 588 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.411 | ❌ | None | ❌ |
| guard_borko | AMBUSH | 0.428 | ❌ | None | ❌ |
| maid_lusya | SPREAD_RUMOR | 0.193 | ✅ | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.435 | ❌ | None | ❌ |
| tavern_keeper_tornin | SEEK_ALLY | 0.322 | ❌ | x=4.5 y=2.5 | ❌ |
| thief_shadow | OFFER_JOB | 0.449 | ❌ | None | ❌ |
