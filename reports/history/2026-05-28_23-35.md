# ENIGMA Session State — 2026-05-28 23:35
...
_Сессия: 1.0 мин | Тиков: 3 | LLM-вызовов: 0_
...
_История: `reports/dna_history.jsonl` — 130 записей_
...
- Узлы не найдены (NPC не могут добраться до цели): 21
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.748 | ✅ | None | ❌ |
| guard_borko | FLEE | 0.791 | ✅ | None | ❌ |
| maid_lusya | FLEE | 1.640 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.812 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.983 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.642 | ✅ | None | ❌ |
