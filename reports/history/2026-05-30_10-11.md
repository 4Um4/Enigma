# ENIGMA Session State — 2026-05-30 10:11
...
_История: `reports/dna_history.jsonl` — 221 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.208 | ❌ | None | ❌ |
| guard_borko | AMBUSH | 0.289 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.498 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.405 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.299 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.276 | ❌ узел не найден | None | ❌ |
