# ENIGMA Session State — 2026-08-24 18:25
...
| **CVS** (Causal Velocity) | 2.44/мин | ↓ -20.2 | ✅ 2.44/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 4 (idx=0.80) | → | ✅ Убеждения формируются |
...
_История: `reports/dna_history.jsonl` — 1059 записей_
...
**Tick Pipeline:**
Тиков: 5 | Decisions > 0: 1/5 | LLM: 2 вызовов / 0 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.644 | ✅ | x=10.5 y=3.0 | ❌ |
| guard_borko | talk | 0.367 | ✅ | x=13.5 y=3.0 | ❌ |
| maid_lusya | offer_job | 0.260 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.638 | ✅ | x=10.5 y=3.0 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.383 | ✅ | x=10.5 y=3.0 | ❌ |
| thief_shadow | observe | 0.159 | ✅ | x=8.1 y=13.0 | ❌ |
