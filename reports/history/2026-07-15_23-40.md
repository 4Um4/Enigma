# ENIGMA Session State — 2026-07-15 23:40
...
_История: `reports/dna_history.jsonl` — 710 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.012 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | spread_rumor | 0.232 | ❌ | x=12.4 y=10.4 | ❌ |
| maid_lusya | change_role | 0.300 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | offer_job | 0.444 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.174 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | request_service | 0.250 | ❌ | x=11.6 y=9.8 | ❌ |
