# ENIGMA Session State — 2026-05-29 22:49
...
_История: `reports/dna_history.jsonl` — 205 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.291 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.412 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 0.400 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.287 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.253 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.332 | ❌ узел не найден | None | ❌ |
