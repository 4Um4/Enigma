# ENIGMA Session State — 2026-09-24 01:39
...
_Сессия: 0.4 мин | Тиков: 3 | LLM-вызовов: 4_
...
| **CVS** (Causal Velocity) | 9.53/мин | ↑ +7.3 | ✅ 9.53/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 27 (idx=9.00) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 20 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1178 записей_
...
- NPC с известными координатами (6):
  ...
  - `blacksmith_orm`: x=7.8 y=5.0
  - `thief_shadow`: x=11.5 y=11.0
  - `tavern_keeper_tornin`: x=7.5 y=2.8
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.860 | ✅ | x=7.8 y=5.0 | ❌ |
| guard_borko | block_path | 0.524 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 0.939 | ✅ | x=11.7 y=2.6 | ❌ |
| merchant_goran | offer_job | 0.567 | ✅ | x=6.5 y=5.5 | ❌ |
| player | flee | 0.423 | ✅ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.406 | ✅ | x=7.5 y=2.8 | ❌ |
| thief_shadow | observe | 0.363 | ✅ | x=11.5 y=11.0 | ❌ |
