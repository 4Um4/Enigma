# ENIGMA Session State — 2026-05-29 21:29
...
_История: `reports/dna_history.jsonl` — 203 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.377 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.545 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.399 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.427 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.473 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.209 | ❌ узел не найден | None | ❌ |
