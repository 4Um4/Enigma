# ENIGMA Session State — 2026-05-29 20:53
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -3.1 | LLM не вызывалась: сессия без действий игрока |

_История: `reports/dna_history.jsonl` — 199 записей_
...
| guard_borko | FLEE | 1.146 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 1.720 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.164 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.361 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.994 | ❌ узел не найден | None | ❌ |
