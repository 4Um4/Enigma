# ENIGMA Session State — 2026-06-03 00:48
...
_История: `reports/dna_history.jsonl` — 314 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ATTACK | 1.069 | ❌ | None | ❌ |
| guard_borko | ATTACK | 1.301 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | OBSERVE | 1.121 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.967 | ❌ | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | ATTACK | 1.680 | ❌ узел не найден | x=4.5 y=2.5 | ❌ |
| thief_shadow | OBSERVE | 1.245 | ❌ | None | ❌ |
