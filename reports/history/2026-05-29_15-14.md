# ENIGMA Session State — 2026-05-29 15:14
...
| **SCF** (Spatial Coherence) | 0.3 | → +0.0 | ✅ пространство целостно: граф загружен корректно |
...
_История: `reports/dna_history.jsonl` — 172 записей_
...
| guard_borko | FLEE | 0.339 | ❌ | x=13.7 y=2.3 | ❌ |
| maid_lusya | FLEE | 0.425 | ❌ | None | ❌ |
| merchant_goran | FLEE | 0.373 | ❌ | x=13.7 y=1.6 | ❌ |
| tavern_keeper_tornin | FLEE | 0.371 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.270 | ❌ | None | ❌ |
