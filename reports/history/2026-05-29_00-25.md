# ENIGMA Session State — 2026-05-29 00:25
...
_История: `reports/dna_history.jsonl` — 133 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.984 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.301 | ❌ | None | ❌ |
| maid_lusya | FLEE | 2.364 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.067 | ❌ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.338 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.068 | ❌ узел не найден | None | ❌ |
