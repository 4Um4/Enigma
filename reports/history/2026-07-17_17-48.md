# ENIGMA Session State — 2026-07-17 17:48
...
| **CVS** (Causal Velocity) | 5.33/мин | → -0.4 | ✅ 5.33/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 50% | ↑ -16.7% | ⛔ 1 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 734 записей_
...
| guard_borko | ambush | 0.319 | ❌ | None | ❌ |
| maid_lusya | idle | 0.232 | ❌ | x=4.0 y=2.6 | ❌ |
| merchant_goran | offer_job | 0.317 | ❌ | x=11.4 y=9.6 | ❌ |
| player | call_for_help | 0.283 | ❌ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.215 | ❌ | x=12.6 y=9.6 | ❌ |
| thief_shadow | block_path | 0.360 | ❌ | x=3.5 y=3.9 | ❌ |
