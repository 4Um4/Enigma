# ENIGMA Session State — 2026-06-02 18:50
...
_История: `reports/dna_history.jsonl` — 293 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.737 | ❌ | x=8.5 y=7.7 | ❌ |
| guard_borko | FLEE | 0.844 | ❌ | x=16.0 y=4.5 | ❌ |
| maid_lusya | FLEE | 0.991 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.845 | ❌ | x=16.0 y=4.5 | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.812 | ❌ узел не найден | x=16.0 y=4.5 | ❌ |
| thief_shadow | FLEE | 1.006 | ✅ | None | ❌ |
