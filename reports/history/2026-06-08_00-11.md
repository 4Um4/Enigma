# ENIGMA Session State — 2026-06-08 00:11
...
| **PFI** (Pre-Bus Failure) | 0% | ↑ -500.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 421 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | APPROACH | 0.246 | ✅ | None | ❌ |
| guard_borko | REPORT | 0.452 | ❌ | x=9.3 y=3.1 | ❌ |
| maid_lusya | FLEE | 0.454 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.269 | ✅ | x=16.0 y=4.0 | ❌ |
| tavern_keeper_tornin | REPORT | 0.380 | ✅ | None | ❌ |
| thief_shadow | APPROACH | 0.451 | ✅ | None | ❌ |
