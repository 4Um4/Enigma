# ENIGMA Session State — 2026-09-24 12:46
...
_Сессия: 2.4 мин | Тиков: 246 | LLM-вызовов: 48_
...
| **CVS** (Causal Velocity) | 19.83/мин | ↓ -9.6 | ✅ 19.83/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 1575 (idx=6.40) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 1715 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1195 записей_
...
**Tick Pipeline:**
Тиков: 246 | Decisions > 0: 4/246 | LLM: 48 вызовов / 50 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.234 | ✅ | x=10.5 y=3.0 | ❌ |
| guard_borko | talk | 1.567 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.461 | ✅ | x=10.5 y=4.8 | ❌ |
| merchant_goran | flee | 0.980 | ✅ | x=10.5 y=3.0 | ❌ |
| player | talk | 0.821 | ⏸ | None | ❌ |
| tavern_keeper_tornin | talk | 1.627 | ✅ | x=17.9 y=5.0 | ❌ |
