# ENIGMA Session State — 2026-05-29 15:02
...
_История: `reports/dna_history.jsonl` — 170 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.303 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.357 | ❌ | x=13.7 y=2.3 | ❌ |
| maid_lusya | FLEE | 0.306 | ❌ | None | ❌ |
| merchant_goran | FLEE | 0.364 | ❌ | x=13.7 y=1.6 | ❌ |
| tavern_keeper_tornin | FLEE | 0.374 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.266 | ❌ | None | ❌ |
