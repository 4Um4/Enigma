# ENIGMA Session State — 2026-07-27 22:26

Кампания: `Open_road` | Игрок: `фцка`
...
| **CVS** (Causal Velocity) | 5.91/мин | ↓ -9.0 | ✅ 5.91/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 860 записей_
...
- NPC с известными координатами (5):
  ...
  - `merchant_goran`: x=4.5 y=5.2
  - `maid_lusya`: x=11.5 y=4.9
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.736 | ❌ | x=10.3 y=6.3 | ❌ |
| guard_borko | idle | 0.203 | ❌ | x=11.0 y=10.0 | ❌ |
| maid_lusya | observe | 0.233 | ❌ | x=11.5 y=4.9 | ❌ |
| merchant_goran | flee | 0.256 | ❌ | x=4.5 y=5.2 | ❌ |
| tavern_keeper_tornin | observe | 0.215 | ❌ | x=2.8 y=5.5 | ❌ |
| thief_shadow | idle | 0.199 | ❌ | None | ❌ |
