# ENIGMA Session State — 2026-05-29 18:17
...
_История: `reports/dna_history.jsonl` — 183 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.238 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.471 | ❌ | x=2.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.465 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.414 | ❌ | x=2.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.449 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.120 | ❌ узел не найден | None | ❌ |
