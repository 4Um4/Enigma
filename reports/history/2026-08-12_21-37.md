# ENIGMA Session State — 2026-08-12 21:37

Кампания: `Open_road` | Игрок: `Gustav`
...
_Сессия: 1.4 мин | Тиков: 48 | LLM-вызовов: 72_
...
| **CVS** (Causal Velocity) | 50.19/мин | ↓ -20.4 | ✅ 50.19/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 311 (idx=6.48) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 290 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1010 записей_
...
### Последние изменения (git log -5):
  - 01e495c V.0.5.3.7.6_Начало: обновление лога сцены (scene_changes) — новые записи тестовой сессии
  - 6932659 V.0.5.3.7.6_Начало: обновление лога сцены (scene_changes) — новые записи тестовой сессии
  - 1ab339e V.0.5.3.7.6_Начало: финальный TODO-отчёт о сохранении проекта на GitHub
  - 5b2b09b V.0.5.3.7.6_Начало: обновление лога сцены (scene_changes) после тестовой сессии
  - 0a85e74 V.0.5.3.7.6_Начало: полное сохранение проекта и логов сессии от 2026-08-11
...
**Tick Pipeline:**
Тиков: 48 | Decisions > 0: 3/48 | LLM: 72 вызовов / 70 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.852 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | ambush | 0.193 | ✅ | x=10.5 y=6.5 | ❌ |
| maid_lusya | flee | 0.219 | ✅ | x=6.5 y=5.5 | ❌ |
| merchant_goran | request_service | 0.625 | ✅ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.377 | ⏸ | None | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.183 | ✅ | x=6.5 y=5.5 | ❌ |
