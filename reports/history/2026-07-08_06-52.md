# ENIGMA Session State — 2026-07-08 06:52
...
_История: `reports/dna_history.jsonl` — 676 записей_
...
| guard_borko | ambush | 0.263 | ❌ | x=18.4 y=7.7 | ❌ |
| maid_lusya | offer_job | 0.236 | ❌ | x=11.0 y=4.2 | ❌ |
| merchant_goran | offer_job | 0.275 | ❌ | x=3.4 y=3.5 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.170 | ❌ | x=16.6 y=3.5 | ❌ |
| thief_shadow | request_service | 0.272 | ❌ | x=3.5 y=3.9 | ❌ |
