# ENIGMA Session State — 2026-05-30 00:07
...
_История: `reports/dna_history.jsonl` — 211 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.308 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.480 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.491 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.453 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.467 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.055 | ❌ узел не найден | None | ❌ |
