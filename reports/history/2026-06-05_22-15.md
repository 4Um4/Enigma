# ENIGMA Session State — 2026-06-05 22:15
...
| **PFI** (Pre-Bus Failure) | 40% | ↑ -85.0% | ⛔ 2 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 363 записей_
...
**Tick Pipeline:**
Тиков: 5 | Decisions > 0: 4/5 | LLM: 2 вызовов / 2 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | TRADE | 0.197 | ✅ | None | ❌ |
| guard_borko | TALK | 0.167 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 0.267 | ✅ | None | ❌ |
| merchant_goran | TRADE | 0.189 | ✅ | None | ❌ |
| tavern_keeper_tornin | TALK | 0.275 | ✅ | None | ❌ |
