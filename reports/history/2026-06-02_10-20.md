# ENIGMA Session State — 2026-06-02 10:20
...
| **CVS** (Causal Velocity) | 3.86/мин | → +0.2 | ✅ 3.86/мин: активная сессия |

_История: `reports/dna_history.jsonl` — 280 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.608 | ✅ | None | ❌ |
| guard_borko | FLEE | 0.691 | ✅ | None | ❌ |
| maid_lusya | FLEE | 1.550 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.534 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.547 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.775 | ✅ | None | ❌ |
