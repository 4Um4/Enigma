# ENIGMA Session State — 2026-05-23 01:07
...
_История: `reports/dna_history.jsonl` — 39 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.293 | ❌ | x=16.4 y=5.5 | ❌ |
| guard_borko | FLEE | 0.332 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 0.428 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.326 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.351 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.224 | ✅ | x=8.0 y=7.0 | ❌ |
