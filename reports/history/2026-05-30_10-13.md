# ENIGMA Session State — 2026-05-30 10:13
...
_История: `reports/dna_history.jsonl` — 223 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.308 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.272 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.437 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.298 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.308 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.362 | ❌ узел не найден | None | ❌ |
