# ENIGMA Session State — 2026-06-01 22:11
...
_История: `reports/dna_history.jsonl` — 273 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.581 | ✅ | None | ❌ |
| guard_borko | FLEE | 0.941 | ✅ | None | ❌ |
| maid_lusya | FLEE | 2.051 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.755 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.094 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.071 | ✅ | None | ❌ |
