# ENIGMA Session State — 2026-06-05 14:11
...
| **CVS** (Causal Velocity) | 2.14/мин | ↓ -8.2 | ✅ 2.14/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 120% | ↓ +10.0% | ⛔ 6 пред-шинных отказов — pipeline молча умирает, CDS слеп |
...
_История: `reports/dna_history.jsonl` — 352 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.477 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.453 | ❌ узел не найден | None | ❌ |
| maid_lusya | SEEK_ALLY | 0.265 | ❌ | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.323 | ❌ | x=16.8 y=3.5 | ❌ |
| tavern_keeper_tornin | SEEK_ALLY | 0.295 | ❌ | x=4.0 y=2.5 | ❌ |
| thief_shadow | OFFER_JOB | 0.408 | ❌ | None | ❌ |
