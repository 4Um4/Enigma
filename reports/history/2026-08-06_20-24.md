# ENIGMA Session State — 2026-08-06 20:24
...
_Сессия: 4.3 мин | Тиков: 1 | LLM-вызовов: 153_
...
| **CVS** (Causal Velocity) | 35.92/мин | ↓ -77.1 | ✅ 35.92/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **DRI** (Response Integrity) | 77% | ↓ -14.1% | ⚠️ Деградация: 35 провалов LLM. Ответы нестабильны |
| **DPI** (Dialogue Pipeline) | 100% | → +0.0% | ✅ Конвейер диалогов стабилен |

_История: `reports/dna_history.jsonl` — 918 записей_
...
**Tick Pipeline:**
Тиков: 1 | Decisions > 0: 2/1 | LLM: 153 вызовов / 118 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.801 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | ambush | 0.255 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | idle | 0.165 | ❌ | x=10.5 y=6.5 | ❌ |
| merchant_goran | request_service | 0.665 | ❌ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.338 | ❌ | None | ❌ |
| tavern_keeper_tornin | talk | 0.249 | ❌ | x=10.5 y=3.0 | ❌ |
| thief_shadow | report | 0.151 | ❌ | x=13.5 y=3.0 | ❌ |
