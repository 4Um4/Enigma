# ENIGMA Session State — 2026-06-01 23:33
...
_История: `reports/dna_history.jsonl` — 277 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.019 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.040 | ✅ | None | ❌ |
| maid_lusya | FLEE | 1.650 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.988 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.110 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.482 | ❌ узел не найден | None | ❌ |
