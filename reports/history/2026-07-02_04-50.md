# ENIGMA Session State — 2026-07-02 04:50
...
_Сессия: 1.0 мин | Тиков: 2 | LLM-вызовов: 4_
...
| **CVS** (Causal Velocity) | 3.85/мин | → +0.3 | ✅ 3.85/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 50% | ↓ +50.0% | ⛔ 1 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 645 записей_
...
- NPC с известными координатами (6):
  - `guard_borko`: x=7.2 y=6.0
  - `merchant_goran`: x=4.0 y=4.0
  - `maid_lusya`: x=4.0 y=4.0
  - `blacksmith_orm`: x=10.5 y=5.0
  - `thief_shadow`: x=7.0 y=6.2
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.500 | ❌ | x=10.5 y=5.0 | ❌ |
| guard_borko | ambush | 0.305 | ✅ | x=7.2 y=6.0 | ❌ |
| maid_lusya | offer_job | 0.236 | ✅ | x=4.0 y=4.0 | ❌ |
| merchant_goran | offer_job | 0.395 | ✅ | x=4.0 y=4.0 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.245 | ✅ | x=4.0 y=4.0 | ❌ |
| thief_shadow | request_service | 0.392 | ✅ | x=7.0 y=6.2 | ❌ |
