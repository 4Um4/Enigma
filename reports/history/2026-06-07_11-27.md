# ENIGMA Session State — 2026-06-07 11:27
...
_Сессия: 1.8 мин | Тиков: 1 | LLM-вызовов: 0_
...
| **PFI** (Pre-Bus Failure) | 400% | ↓ +166.7% | ⛔ 4 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 392 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.460 | ❌ | None | ❌ |
| guard_borko | AMBUSH | 0.457 | ❌ узел не найден | None | ❌ |
| maid_lusya | SEEK_ALLY | 0.225 | ❌ | None | ❌ |
| merchant_goran | CHANGE_ROLE | 0.405 | ❌ узел не найден | None | ❌ |
| player | ? | 0.000 | ✅ | None | ❌ |
| tavern_keeper_tornin | SEEK_ALLY | 0.283 | ❌ | None | ❌ |
| thief_shadow | BLOCK_PATH | 0.328 | ❌ | None | ❌ |
