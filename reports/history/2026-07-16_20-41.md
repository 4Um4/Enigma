# ENIGMA Session State — 2026-07-16 20:41
...
_Сессия: 1.1 мин | Тиков: 0 | LLM-вызовов: 0_
...
_История: `reports/dna_history.jsonl` — 717 записей_
...
- LLM CJK-галлюцинации: 20 строк
- Стартап backend: ✅
- LLM сервер: ✅

**Предупреждения:**
  - ⚠️ LLM галлюцинирует на китайском: 20 строк

**Movement Pipeline (по NPC):**
| NPC | Intent | Score | Traversal | Координаты | Виден игроку |
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.965 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | ambush | 0.334 | ❌ | None | ❌ |
| maid_lusya | change_role | 0.223 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | offer_job | 0.444 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.232 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | change_role | 0.336 | ❌ | x=11.6 y=9.8 | ❌ |
