# ENIGMA Session State — 2026-09-16 20:28
...
_Сессия: 1.1 мин | Тиков: 232 | LLM-вызовов: 20_
...
| **CVS** (Causal Velocity) | 17.92/мин | ↑ +8.8 | ✅ 17.92/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 848 (idx=3.66) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 1624 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1120 записей_
...
**Tick Pipeline:**
Тиков: 232 | Decisions > 0: 3/232 | LLM: 20 вызовов / 22 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | talk | 1.023 | ✅ | x=5.5 y=6.0 | ❌ |
| guard_borko | flee | 0.912 | ✅ | x=11.0 y=10.0 | ❌ |
| maid_lusya | flee | 1.433 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | flee | 0.971 | ✅ | x=10.5 y=3.0 | ❌ |
| player | trade | 0.600 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.221 | ✅ | x=10.5 y=6.5 | ❌ |
| thief_shadow | observe | 0.690 | ✅ | None | ❌ |
