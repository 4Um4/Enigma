# ENIGMA Session State — 2026-06-03 00:54
...
_Сессия: 0.5 мин | Тиков: 2 | LLM-вызовов: 0_
...
_История: `reports/dna_history.jsonl` — 315 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.304 | ❌ | None | ❌ |
| guard_borko | SEEK_ALLY | 0.187 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.214 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | FLEE | 0.204 | ❌ | x=14.5 y=5.5 | ❌ |
| player | ? | 0.000 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.272 | ❌ узел не найден | x=4.5 y=2.5 | ❌ |
