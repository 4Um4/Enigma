# ENIGMA Session State — 2026-06-07 12:25
...
_История: `reports/dna_history.jsonl` — 397 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.317 | ❌ | None | ❌ |
| guard_borko | WARN | 0.325 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 0.414 | ❌ | None | ❌ |
| merchant_goran | OBSERVE | 0.273 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.335 | ✅ | None | ❌ |
| thief_shadow | OBSERVE | 0.397 | ❌ | None | ❌ |
