# ENIGMA Session State — 2026-08-08 16:53
...
_Сессия: 1.1 мин | Тиков: 70 | LLM-вызовов: 122_
...
| **CVS** (Causal Velocity) | 107.26/мин | ↓ -52.5 | ✅ 107.26/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 441 (idx=6.30) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 415 (broken=0) | → | ✅ Давление доходит |
| **NEI** (Need Urgency) | 0 (critical=0) | → | ⚠️ NPC слишком комфортны (NEI=0) |
| **DRI** (Response Integrity) | 100% | ↑ +17.6% | ✅ LLM отвечает на все запросы |
| **DPI** (Dialogue Pipeline) | 100% | → +0.0% | ✅ Конвейер диалогов стабилен |

_История: `reports/dna_history.jsonl` — 935 записей_
...
**Tick Pipeline:**
Тиков: 70 | Decisions > 0: 2/70 | LLM: 122 вызовов / 120 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.732 | ❌ | x=7.4 y=6.1 | ❌ |
| guard_borko | ambush | 0.239 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | flee | 0.228 | ❌ | x=10.5 y=3.0 | ❌ |
| merchant_goran | request_service | 0.686 | ❌ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.295 | ❌ | None | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.187 | ❌ | x=7.8 y=5.8 | ❌ |
| thief_shadow | trade | 0.157 | ❌ | x=13.5 y=3.0 | ❌ |
