# ENIGMA Session State — 2026-06-01 16:58
...
_Сессия: 1.5 мин | Тиков: 8 | LLM-вызовов: 8_
...
| **CVS** (Causal Velocity) | 5.43/мин | ↑ +1.4 | ✅ 5.43/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 257 записей_
...
**Tick Pipeline:**
Тиков: 8 | Decisions > 0: 0/8 | LLM: 8 вызовов / 8 ответов | Симуляция: ❌ МЕРТВА
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.375 | ❌ | None | ❌ |
| guard_borko | AMBUSH | 0.264 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 1.482 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.395 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.344 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.310 | ❌ узел не найден | None | ❌ |
