# ENIGMA Session State — 2026-05-26 09:26
...
_История: `reports/dna_history.jsonl` — 79 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | APPROACH | 0.518 | ❌ | None | ❌ |
| guard_borko | TALK | 0.557 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 1.473 | ✅ | None | ❌ |
| merchant_goran | TALK | 0.411 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.728 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.442 | ✅ | None | ❌ |
