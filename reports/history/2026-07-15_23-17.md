# ENIGMA Session State — 2026-07-15 23:17
...
_История: `reports/dna_history.jsonl` — 708 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.915 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | ambush | 0.237 | ❌ | x=12.4 y=10.4 | ❌ |
| maid_lusya | change_role | 0.289 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | offer_job | 0.443 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.268 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | ambush | 0.280 | ❌ | x=11.6 y=9.8 | ❌ |
