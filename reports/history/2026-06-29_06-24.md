# ENIGMA Session State — 2026-06-29 06:24
...
| **PFI** (Pre-Bus Failure) | 0% | ↑ -600.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

**Системные сигналы (требуют внимания):**
- NPI упал на -100%: spatial pipeline деградировал между сессиями

_История: `reports/dna_history.jsonl` — 624 записей_
