# ENIGMA Session State — 2026-08-08 23:41
...
_Сессия: 0.9 мин | Тиков: 14 | LLM-вызовов: 14_
...
| **CVS** (Causal Velocity) | 15.39/мин | ↑ +15.4 | ✅ 15.39/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 84 (idx=6.00) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 78 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 980 записей_
...
**Tick Pipeline:**
Тиков: 14 | Decisions > 0: 1/14 | LLM: 14 вызовов / 14 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.765 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | block_path | 0.246 | ❌ | x=13.5 y=9.5 | ❌ |
| maid_lusya | observe | 0.189 | ❌ | x=10.5 y=4.8 | ❌ |
| merchant_goran | request_service | 0.680 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | seek_ally | 0.223 | ❌ | x=10.5 y=6.5 | ❌ |
| thief_shadow | approach | 0.176 | ❌ | x=13.5 y=3.0 | ❌ |
