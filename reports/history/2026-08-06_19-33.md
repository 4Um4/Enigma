# ENIGMA Session State — 2026-08-06 19:33
...
**Tick Pipeline:**
Тиков: 1 | Decisions > 0: 2/1 | LLM: 118 вызовов / 118 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.697 | ❌ | x=7.1 y=6.1 | ❌ |
| guard_borko | call_for_help | 0.185 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | observe | 0.197 | ❌ | x=10.5 y=4.8 | ❌ |
| merchant_goran | offer_job | 0.673 | ❌ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.240 | ❌ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.280 | ❌ | x=7.8 y=5.8 | ❌ |
