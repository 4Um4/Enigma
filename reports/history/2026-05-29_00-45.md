# ENIGMA Session State — 2026-05-29 00:45
...
_История: `reports/dna_history.jsonl` — 138 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.186 | ✅ | None | ❌ |
| guard_borko | FLEE | 1.463 | ✅ | None | ❌ |
| maid_lusya | FLEE | 2.357 | ✅ | None | ❌ |
| merchant_goran | FLEE | 1.294 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.518 | ✅ | None | ❌ |
| thief_shadow | FLEE | 2.106 | ✅ | None | ❌ |
