# ENIGMA Session State — 2026-06-07 11:23
...
| **PFI** (Pre-Bus Failure) | 300% | ↓ +200.0% | ⛔ 3 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 391 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.418 | ❌ | None | ❌ |
| guard_borko | AMBUSH | 0.343 | ❌ узел не найден | None | ❌ |
| maid_lusya | SPREAD_RUMOR | 0.278 | ❌ | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.442 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | SPREAD_RUMOR | 0.275 | ❌ | None | ❌ |
| thief_shadow | CHANGE_ROLE | 0.400 | ❌ | None | ❌ |
