# ENIGMA Session State — 2026-06-02 17:49
...
_История: `reports/dna_history.jsonl` — 288 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.597 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.839 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 0.969 | ❌ | None | ❌ |
| merchant_goran | OBSERVE | 0.686 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.675 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.950 | ❌ | None | ❌ |
