# ENIGMA Session State — 2026-05-29 15:06
...
| **SCF** (Spatial Coherence) | 0.3 | ↓ -0.7 | ✅ пространство целостно: граф загружен корректно |
...
_История: `reports/dna_history.jsonl` — 171 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.329 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.393 | ❌ | x=13.7 y=2.3 | ❌ |
| maid_lusya | FLEE | 0.295 | ❌ | None | ❌ |
| merchant_goran | FLEE | 0.291 | ❌ | x=13.7 y=1.6 | ❌ |
| tavern_keeper_tornin | FLEE | 0.326 | ❌ | None | ❌ |
| thief_shadow | OFFER_JOB | 0.292 | ❌ | None | ❌ |
