# ENIGMA Session State — 2026-07-11 12:11
...
_Сессия: 1.6 мин | Тиков: 1 | LLM-вызовов: 2_
...
| **CVS** (Causal Velocity) | 1.23/мин | ↑ +1.2 | ✅ 1.23/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 100% | ↓ +100.0% | ⛔ 1 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 688 записей_
...
**Симптом:** За 5 тиков было 23 вербальных интентов, но 0 реплик в recent_dialogues. Цепочка порвана.
...
**Симптом:** game_time_seconds не изменился за 10 тиков: был 480.0, стал 480.0
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | offer_job | 0.490 | ❌ | x=10.5 y=5.0 | ❌ |
| guard_borko | block_path | 0.253 | ❌ | x=4.5 y=4.5 | ❌ |
| maid_lusya | request_service | 0.309 | ❌ | x=11.0 y=4.2 | ❌ |
| merchant_goran | request_service | 0.269 | ❌ | x=10.4 y=3.5 | ❌ |
| player | request_service | 0.309 | ❌ | None | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.192 | ❌ | x=11.6 y=3.5 | ❌ |
| thief_shadow | request_service | 0.297 | ❌ | x=10.6 y=3.9 | ❌ |
