# ENIGMA Session State — 2026-05-31 21:36
...
_История: `reports/dna_history.jsonl` — 247 записей_
...
- Узлы не найдены (NPC не могут добраться до цели): 6
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.366 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.319 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 0.450 | ❌ узел не найден | None | ❌ |
| merchant_goran | OFFER_JOB | 0.242 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.403 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.283 | ❌ узел не найден | None | ❌ |
