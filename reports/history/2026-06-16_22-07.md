# ENIGMA Session State — 2026-06-16 22:07
...
| **NPI** (NPC Pipeline) | 17% | ↓ -33.3% | ⚠️ 1/6 NPC с координатами: spatial pipeline частично сломан |
...
_История: `reports/dna_history.jsonl` — 586 записей_
...
| tavern_keeper_tornin | ? | 0.000 | ✅ | x=4.0 y=2.5 | ❌ |
