# ENIGMA Session State — 2026-08-24 19:16
...
_Сессия: 9.0 мин | Тиков: 4 | LLM-вызовов: 5_
...
| **CVS** (Causal Velocity) | 0.56/мин | ↑ +0.6 | ✅ 0.56/мин: активная сессия |
...
| **BPI** (Break Progress) | 25 (broken=0) | → | ✅ Давление доходит |
| **NEI** (Need Urgency) | 0 (critical=0) | → | ⚠️ NPC слишком комфортны (NEI=0) |
| **DRI** (Response Integrity) | 20% | ↓ -80.0% | 🔴 КРИТИЧНО: LLM не отвечает на 80% запросов (4 провалов) |
| **DPI** (Dialogue Pipeline) | 100% | → +0.0% | ✅ Конвейер диалогов стабилен |

_История: `reports/dna_history.jsonl` — 1066 записей_
...
**Tick Pipeline:**
Тиков: 4 | Decisions > 0: 2/4 | LLM: 5 вызовов / 0 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | approach | 0.263 | ✅ | x=11.2 y=1.9 | ❌ |
| guard_borko | report | 0.394 | ✅ | x=13.5 y=3.0 | ❌ |
| maid_lusya | observe | 0.487 | ✅ | x=13.5 y=3.0 | ❌ |
| merchant_goran | observe | 0.264 | ✅ | x=10.5 y=4.8 | ❌ |
| player | observe | 0.310 | ⏸ | None | ❌ |
| tavern_keeper_tornin | report | 0.307 | ✅ | x=10.5 y=3.0 | ❌ |
| thief_shadow | observe | 0.580 | ✅ | x=8.1 y=13.0 | ❌ |
