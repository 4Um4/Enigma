# ENIGMA Session State — 2026-08-09 21:25
...
_Сессия: 4.6 мин | Тиков: 121 | LLM-вызовов: 108_
...
| **CVS** (Causal Velocity) | 23.65/мин | ↑ +23.6 | ✅ 23.65/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 808 (idx=6.68) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 720 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1004 записей_
...
**Tick Pipeline:**
Тиков: 121 | Decisions > 0: 1/121 | LLM: 108 вызовов / 108 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.963 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | block_path | 0.226 | ❌ | None | ❌ |
| maid_lusya | idle | 0.239 | ❌ | x=16.7 y=2.4 | ❌ |
| merchant_goran | offer_job | 0.693 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.179 | ❌ | x=16.7 y=2.4 | ❌ |
