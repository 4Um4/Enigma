# ENIGMA Session State — 2026-06-05 00:53
...
_Сессия: 1.5 мин | Тиков: 6 | LLM-вызовов: 4_
...
| **CVS** (Causal Velocity) | 2.68/мин | → -0.3 | ✅ 2.68/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 17% | → +0.0% | ⚠️ 1 пред-шинных отказов — CDS слеп к части крахов |

_История: `reports/dna_history.jsonl` — 335 записей_
...
- NPC с известными координатами (3):
  - `tavern_keeper_tornin`: x=17.8 y=5.7
  - `guard_borko`: x=16.0 y=4.0
  - `merchant_goran`: x=16.0 y=2.8
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.695 | ❌ | None | ❌ |
| guard_borko | ATTACK | 0.854 | ✅ | x=16.0 y=4.0 | ❌ |
| maid_lusya | FLEE | 1.284 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.815 | ✅ | x=16.0 y=2.8 | ❌ |
| tavern_keeper_tornin | FLEE | 1.157 | ✅ | x=17.8 y=5.7 | ❌ |
| thief_shadow | FLEE | 0.682 | ✅ | None | ❌ |
