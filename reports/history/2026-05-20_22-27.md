# ENIGMA Session State — 2026-05-20 22:27
...
| **SCF** (Spatial Coherence) | 0.5 | ↑ +0.5 | ⚠️ ДЕГРАДАЦИЯ: location_templates fallback активен |
...
_История: `reports/dna_history.jsonl` — 22 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.376 | ❌ | x=16.4 y=5.5 | ❌ |
| guard_borko | FLEE | 0.376 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.393 | ✅ | x=4.5 y=5.0 | ❌ |
| merchant_goran | FLEE | 0.228 | ❌ | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | FLEE | 0.240 | ✅ | x=4.0 y=4.0 | ❌ |
| thief_shadow | REQUEST_SERVICE | 0.283 | ✅ | None | ❌ |
