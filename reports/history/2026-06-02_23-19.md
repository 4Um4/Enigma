# ENIGMA Session State — 2026-06-02 23:19
...
_История: `reports/dna_history.jsonl` — 303 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.855 | ❌ | x=8.0 y=7.0 | ❌ |
| guard_borko | FLEE | 0.839 | ❌ | x=8.0 y=7.0 | ❌ |
| maid_lusya | FLEE | 0.999 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | FLEE | 0.803 | ❌ | x=8.0 y=7.0 | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.809 | ❌ узел не найден | x=8.0 y=7.0 | ❌ |
| thief_shadow | FLEE | 1.109 | ✅ | None | ❌ |
