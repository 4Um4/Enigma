# ENIGMA Session State — 2026-08-08 23:21
...
_Сессия: 2.0 мин | Тиков: 13 | LLM-вызовов: 16_
...
| **CVS** (Causal Velocity) | 8.02/мин | ↑ +8.0 | ✅ 8.02/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 77 (idx=5.92) | → | ✅ Убеждения формируются |
...
_История: `reports/dna_history.jsonl` — 974 записей_
...
**Tick Pipeline:**
Тиков: 13 | Decisions > 0: 1/13 | LLM: 16 вызовов / 16 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.811 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | spread_rumor | 0.221 | ❌ | x=13.5 y=9.5 | ❌ |
| maid_lusya | flee | 0.214 | ❌ | x=10.5 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.564 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | talk | 0.220 | ❌ | x=10.5 y=6.5 | ❌ |
| thief_shadow | trade | 0.158 | ❌ | x=13.5 y=3.0 | ❌ |
