# ENIGMA Session State — 2026-06-27 18:44
...
_Сессия: 0.5 мин | Тиков: 1 | LLM-вызовов: 1_
...
| **CVS** (Causal Velocity) | 1.90/мин | ↑ +1.9 | ✅ 1.90/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 606 записей_
...
**Tick Pipeline:**
Тиков: 1 | Decisions > 0: 1/1 | LLM: 1 вызовов / 0 ответов | Симуляция: ✅ живёт
...
| guard_borko | block_path | 0.454 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | seek_ally | 0.216 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | request_service | 0.368 | ❌ | x=9.0 y=9.0 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.194 | ❌ | x=4.5 y=2.5 | ❌ |
| thief_shadow | offer_job | 0.453 | ❌ | x=11.5 y=9.5 | ❌ |
