# ENIGMA Session State — 2026-08-06 22:04
...
_Сессия: 1.2 мин | Тиков: 62 | LLM-вызовов: 128_
...
| **CVS** (Causal Velocity) | 105.22/мин | ↓ -8.1 | ✅ 105.22/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 420 (idx=6.77) | → | ✅ Убеждения формируются |
...
_История: `reports/dna_history.jsonl` — 923 записей_
...
**Tick Pipeline:**
Тиков: 62 | Decisions > 0: 1/62 | LLM: 128 вызовов / 126 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.694 | ❌ | x=5.5 y=6.0 | ❌ |
| guard_borko | block_path | 0.214 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | flee | 0.217 | ❌ | x=13.5 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.629 | ❌ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.283 | ❌ | None | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.221 | ❌ | x=16.7 y=2.4 | ❌ |
