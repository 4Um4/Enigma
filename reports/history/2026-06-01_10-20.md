# ENIGMA Session State — 2026-06-01 10:20
...
_История: `reports/dna_history.jsonl` — 256 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.294 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.353 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 0.632 | ✅ | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.271 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.343 | ❌ | None | ❌ |
| thief_shadow | OBSERVE | 0.489 | ❌ узел не найден | None | ❌ |
