# ENIGMA Session State — 2026-06-03 00:38
...
_История: `reports/dna_history.jsonl` — 313 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.285 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.301 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.289 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.259 | ❌ | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.215 | ❌ узел не найден | x=4.5 y=2.5 | ❌ |
| thief_shadow | CHANGE_ROLE | 0.246 | ❌ | None | ❌ |
