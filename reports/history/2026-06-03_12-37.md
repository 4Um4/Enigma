# ENIGMA Session State — 2026-06-03 12:37
...
_История: `reports/dna_history.jsonl` — 321 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.255 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.314 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.360 | ❌ узел не найден | None | ❌ |
| merchant_goran | OFFER_JOB | 0.232 | ❌ | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | FLEE | 0.300 | ❌ узел не найден | x=4.5 y=2.5 | ❌ |
| thief_shadow | CHANGE_ROLE | 0.276 | ❌ | None | ❌ |
