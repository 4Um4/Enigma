# ENIGMA Session State — 2026-06-30 05:54
...
| **CVS** (Causal Velocity) | 3.30/мин | ↓ -4.1 | ✅ 3.30/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 637 записей_
...
| guard_borko | block_path | 0.286 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | offer_job | 0.170 | ❌ | x=4.5 y=5.0 | ❌ |
