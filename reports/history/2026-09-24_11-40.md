# ENIGMA Session State — 2026-09-24 11:40
...
_Сессия: 7.7 мин | Тиков: 963 | LLM-вызовов: 30_
...
| **CVS** (Causal Velocity) | 3.88/мин | ↓ -17.4 | ✅ 3.88/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 6336 (idx=6.58) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 6748 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1184 записей_
...
**Tick Pipeline:**
Тиков: 963 | Decisions > 0: 2/963 | LLM: 30 вызовов / 32 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.434 | ✅ | x=15.2 y=5.7 | ❌ |
| guard_borko | talk | 1.554 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.509 | ✅ | x=10.5 y=4.8 | ❌ |
| merchant_goran | flee | 0.822 | ✅ | x=12.0 y=3.0 | ❌ |
| player | observe | 0.685 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.497 | ✅ | x=17.9 y=5.0 | ❌ |
| thief_shadow | observe | 0.711 | ✅ | x=11.5 y=11.0 | ❌ |
