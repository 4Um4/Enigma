# ENIGMA Session State — 2026-05-27 01:16
...
_История: `reports/dna_history.jsonl` — 94 записей_
...
| guard_borko | FLEE | 0.721 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 1.669 | ✅ | None | ❌ |
| merchant_goran | OBSERVE | 0.634 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.941 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.722 | ✅ | None | ❌ |
