# ENIGMA Session State — 2026-07-26 11:31
...
| **NPI** (NPC Pipeline) | 0% | ↓ -57.1% | нет данных о NPC |
...
- NPI упал на -57%: spatial pipeline деградировал между сессиями

_История: `reports/dna_history.jsonl` — 781 записей_
