# ENIGMA Session State — 2026-07-28 19:36
...
_Сессия: 4.9 мин | Тиков: 0 | LLM-вызовов: 2_
...
| **CVS** (Causal Velocity) | 0.40/мин | ↓ -10.3 | ⚠️ 0.40/мин: редкие взаимодействия или медленный LLM |
...
_История: `reports/dna_history.jsonl` — 865 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.799 | ❌ | x=10.3 y=2.9 | ❌ |
| guard_borko | flee | 0.210 | ❌ | x=10.9 y=3.5 | ❌ |
| maid_lusya | idle | 0.236 | ❌ | x=10.5 y=6.7 | ❌ |
| merchant_goran | idle | 0.240 | ❌ | x=9.9 y=6.0 | ❌ |
| tavern_keeper_tornin | idle | 0.251 | ❌ | x=11.1 y=6.0 | ❌ |
| thief_shadow | flee | 0.206 | ❌ | x=10.1 y=2.9 | ❌ |
