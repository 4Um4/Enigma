# ENIGMA Session State — 2026-05-27 10:29
...
_История: `reports/dna_history.jsonl` — 102 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.548 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.636 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 1.696 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.625 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.830 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.619 | ✅ | None | ❌ |
