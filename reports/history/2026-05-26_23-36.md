# ENIGMA Session State — 2026-05-26 23:36
...
_История: `reports/dna_history.jsonl` — 89 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.416 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.527 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 1.576 | ✅ | None | ❌ |
| merchant_goran | OFFER_JOB | 0.463 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.873 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.344 | ✅ | None | ❌ |
