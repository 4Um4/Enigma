# ENIGMA Session State — 2026-05-29 15:27
...
_Сессия: 1.0 мин | Тиков: 6 | LLM-вызовов: 4_
...
_История: `reports/dna_history.jsonl` — 176 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.348 | ✅ | None | ❌ |
| guard_borko | OBSERVE | 0.422 | ✅ | x=2.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 1.237 | ✅ | None | ❌ |
| merchant_goran | OBSERVE | 0.404 | ✅ | x=13.7 y=1.6 | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.448 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.418 | ✅ | None | ❌ |
