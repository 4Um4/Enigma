# ENIGMA Session State — 2026-06-05 01:27
...
_Сессия: 3.9 мин | Тиков: 7 | LLM-вызовов: 6_
...
| **CVS** (Causal Velocity) | 1.54/мин | ↓ -1.9 | ✅ 1.54/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 29% | ↓ +14.3% | ⛔ 2 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 338 записей_
...
- NPC с известными координатами (3):
  - `tavern_keeper_tornin`: x=8.7 y=4.4
  - `guard_borko`: x=15.3 y=3.7
  - `merchant_goran`: x=9.5 y=12.4
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.307 | ✅ | None | ❌ |
| guard_borko | REPORT | 0.309 | ✅ | x=15.3 y=3.7 | ❌ |
| maid_lusya | FLEE | 0.454 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.307 | ✅ | x=9.5 y=12.4 | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.336 | ✅ | x=8.7 y=4.4 | ❌ |
| thief_shadow | FLEE | 0.314 | ✅ | None | ❌ |
