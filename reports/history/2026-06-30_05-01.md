# ENIGMA Session State — 2026-06-30 05:01
...
| **CVS** (Causal Velocity) | 3.31/мин | ↑ +3.3 | ✅ 3.31/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | ↑ -100.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 632 записей_
...
| maid_lusya | change_role | 0.290 | ❌ | x=4.5 y=5.0 | ❌ |
