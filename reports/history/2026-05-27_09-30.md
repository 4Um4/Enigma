# ENIGMA Session State — 2026-05-27 09:30
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -6.2 | LLM не вызывалась: сессия без действий игрока |

**Системные сигналы (требуют внимания):**
- SCF упал с 1.0 до 0.0: spatial fallback + node_not_found = регрессия spatial слоя

_История: `reports/dna_history.jsonl` — 101 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.701 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.773 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 1.603 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.771 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.028 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.601 | ✅ | None | ❌ |
