# ENIGMA Session State — 2026-08-08 09:11
...
_Сессия: 0.6 мин | Тиков: 17 | LLM-вызовов: 50_
...
| **CVS** (Causal Velocity) | 90.12/мин | ↓ -28.3 | ✅ 90.12/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 93 (idx=5.47) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 96 (broken=0) | → | ✅ Давление доходит |
| **NEI** (Need Urgency) | 0 (critical=0) | → | ⚠️ NPC слишком комфортны (NEI=0) |
| **DRI** (Response Integrity) | 100% | ↑ +1.2% | ✅ LLM отвечает на все запросы |
| **DPI** (Dialogue Pipeline) | 100% | → +0.0% | ✅ Конвейер диалогов стабилен |

_История: `reports/dna_history.jsonl` — 931 записей_
...
**Tick Pipeline:**
Тиков: 17 | Decisions > 0: 1/17 | LLM: 50 вызовов / 48 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.659 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | seek_ally | 0.229 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | observe | 0.213 | ❌ | x=10.5 y=4.8 | ❌ |
| merchant_goran | offer_job | 0.558 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | seek_ally | 0.233 | ❌ | x=10.5 y=6.5 | ❌ |
| thief_shadow | approach | 0.161 | ❌ | x=13.5 y=3.0 | ❌ |
