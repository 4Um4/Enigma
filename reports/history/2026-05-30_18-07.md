# ENIGMA Session State — 2026-05-30 18:07
...
_История: `reports/dna_history.jsonl` — 237 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.016 | ✅ | None | ❌ |
| guard_borko | FLEE | 1.186 | ✅ | None | ❌ |
| maid_lusya | FLEE | 1.612 | ✅ | None | ❌ |
| merchant_goran | FLEE | 1.110 | ✅ | x=16.0 y=4.5 | ❌ |
| tavern_keeper_tornin | FLEE | 1.115 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.750 | ✅ | None | ❌ |
