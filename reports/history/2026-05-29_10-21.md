# ENIGMA Session State — 2026-05-29 10:21
...
_История: `reports/dna_history.jsonl` — 155 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.119 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.936 | ❌ | x=14.3 y=1.7 | ❌ |
| maid_lusya | FLEE | 1.764 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.019 | ❌ | x=14.2 y=1.7 | ❌ |
| tavern_keeper_tornin | FLEE | 1.059 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.771 | ❌ узел не найден | None | ❌ |
