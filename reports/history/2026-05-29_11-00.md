# ENIGMA Session State — 2026-05-29 11:00
...
_История: `reports/dna_history.jsonl` — 163 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.908 | ✅ | None | ❌ |
| guard_borko | FLEE | 0.945 | ❌ | x=13.7 y=2.3 | ❌ |
| maid_lusya | FLEE | 1.622 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.023 | ❌ | x=13.7 y=1.6 | ❌ |
| tavern_keeper_tornin | FLEE | 1.019 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.672 | ❌ узел не найден | None | ❌ |
