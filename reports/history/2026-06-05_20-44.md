# ENIGMA Session State — 2026-06-05 20:44
...
_Сессия: 2.9 мин | Тиков: 7 | LLM-вызовов: 6_
...
| **CVS** (Causal Velocity) | 2.09/мин | ↑ +2.1 | ✅ 2.09/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 57% | ↑ -76.2% | ⛔ 4 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 357 записей_
...
- NPC с известными координатами (1):
  - `tavern_keeper_tornin`: x=6.0 y=7.2
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | APPROACH | 0.320 | ✅ | None | ❌ |
| guard_borko | FLEE | 0.400 | ✅ | None | ❌ |
| maid_lusya | FLEE | 0.552 | ✅ | None | ❌ |
| merchant_goran | TRADE | 0.290 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.424 | ✅ | x=6.0 y=7.2 | ❌ |
| thief_shadow | FLEE | 0.269 | ✅ | None | ❌ |
