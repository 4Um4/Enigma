# ENIGMA Session State — 2026-05-29 00:15
...
_История: `reports/dna_history.jsonl` — 131 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.971 | ✅ | None | ❌ |
| guard_borko | OBSERVE | 0.882 | ❌ | None | ❌ |
| maid_lusya | FLEE | 1.714 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.835 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.115 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.848 | ✅ | None | ❌ |
