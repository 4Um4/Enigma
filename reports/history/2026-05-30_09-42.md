# ENIGMA Session State — 2026-05-30 09:42
...
_История: `reports/dna_history.jsonl` — 215 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.330 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.361 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.369 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.353 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.277 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.339 | ❌ узел не найден | None | ❌ |
