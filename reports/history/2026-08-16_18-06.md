# ENIGMA Session State — 2026-08-16 18:06
...
_Сессия: 0.7 мин | Тиков: 19 | LLM-вызовов: 24_
...
| **CVS** (Causal Velocity) | 32.54/мин | ↓ -29.9 | ✅ 32.54/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 5 (AttrErr=0, TypeErr=5) | → | ⚠️ КРИТИЧНО: невидимые регрессии (Tracebacks) |
| **BCI** (Belief Crystallization) | 280 (idx=14.74) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 129 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1023 записей_
...
**Tick Pipeline:**
Тиков: 19 | Decisions > 0: 3/19 | LLM: 24 вызовов / 22 ответов | Симуляция: ❌ МЕРТВА
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.028 | ✅ | x=5.5 y=6.0 | ❌ |
| guard_borko | observe | 0.159 | ✅ | x=10.5 y=3.0 | ❌ |
| maid_lusya | idle | 0.213 | ✅ | x=10.5 y=6.5 | ❌ |
| merchant_goran | approach | 0.174 | ✅ | x=5.5 y=6.0 | ❌ |
| player | flee | 0.172 | ✅ | None | ❌ |
| tavern_keeper_tornin | seek_ally | 0.180 | ✅ | x=10.5 y=3.0 | ❌ |
| thief_shadow | trade | 0.193 | ✅ | x=8.1 y=13.0 | ❌ |
