# ENIGMA Session State — 2026-07-30 23:20
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -11.2 | LLM не вызывалась: сессия без действий игрока |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 891 записей_
...
- NPC с известными координатами (6):
  ...
  - `merchant_goran`: x=8.8 y=3.5
  - `maid_lusya`: x=16.7 y=2.5
  - `blacksmith_orm`: x=9.0 y=3.7
  - `thief_shadow`: x=10.1 y=2.9
...
| guard_borko | idle | 0.201 | ❌ | x=17.2 y=4.6 | ❌ |
| maid_lusya | flee | 0.254 | ❌ | x=16.7 y=2.5 | ❌ |
| merchant_goran | observe | 0.192 | ❌ | x=8.8 y=3.5 | ❌ |
| tavern_keeper_tornin | flee | 0.251 | ❌ | x=11.1 y=6.0 | ❌ |
| thief_shadow | idle | 0.000 | ❌ | x=10.1 y=2.9 | ❌ |
