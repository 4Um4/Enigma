# ENIGMA Session State — 2026-06-01 20:35
...
| **CVS** (Causal Velocity) | 1.84/мин | ↓ -1.8 | ✅ 1.84/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 266 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.325 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.412 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 1.121 | ❌ | None | ❌ |
| merchant_goran | FLEE | 0.314 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.374 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.485 | ❌ узел не найден | None | ❌ |
