# ENIGMA Session State — 2026-05-29 19:26
...
_История: `reports/dna_history.jsonl` — 192 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.304 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.322 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 0.400 | ❌ узел не найден | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.286 | ❌ | x=14.0 y=2.0 | ❌ |
