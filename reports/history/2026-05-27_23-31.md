# ENIGMA Session State — 2026-05-27 23:31
...
_История: `reports/dna_history.jsonl` — 114 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.654 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.737 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 1.601 | ❌ | None | ❌ |
| merchant_goran | FLEE | 0.659 | ❌ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.005 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.675 | ❌ | None | ❌ |
