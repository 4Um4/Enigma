# ENIGMA Session State — 2026-08-06 21:20
...
_(ошибка вычисления: 'TickHealthReport' object has no attribute 'npc_total')_
...
**Tick Pipeline:**
Тиков: 0 | Decisions > 0: 1/0 | LLM: 144 вызовов / 144 ответов | Симуляция: ✅ живёт
...
| maid_lusya | idle | 0.000 | ❌ | x=7.8 y=5.8 | ❌ |
| merchant_goran | request_service | 0.691 | ❌ | x=6.5 y=5.5 | ❌ |
| player | help | 0.215 | ❌ | None | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.207 | ❌ | x=7.8 y=5.8 | ❌ |
