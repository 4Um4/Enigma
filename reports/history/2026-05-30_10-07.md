# ENIGMA Session State — 2026-05-30 10:07
...
_Сессия: 0.5 мин | Тиков: 4 | LLM-вызовов: 0_
...
_История: `reports/dna_history.jsonl` — 219 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.360 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.411 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.526 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.348 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.286 | ❌ узел не найден | None | ❌ |
| thief_shadow | OBSERVE | 0.500 | ❌ узел не найден | None | ❌ |
