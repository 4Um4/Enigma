# ENIGMA Session State — 2026-09-18 10:50
...
_Сессия: 0.7 мин | Тиков: 26 | LLM-вызовов: 16_
...
| **CVS** (Causal Velocity) | 24.40/мин | ↓ -0.6 | ✅ 24.40/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 144 (idx=5.54) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 181 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1144 записей_
...
- NPC с известными координатами (5):
  - `guard_borko`: x=27.7 y=8.7
  - `merchant_goran`: x=9.2 y=3.8
  - `maid_lusya`: x=6.5 y=5.5
  - `blacksmith_orm`: x=9.2 y=3.8
...
**Tick Pipeline:**
Тиков: 26 | Decisions > 0: 1/26 | LLM: 16 вызовов / 14 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | help | 0.603 | ✅ | x=9.2 y=3.8 | ❌ |
| guard_borko | observe | 0.767 | ✅ | x=27.7 y=8.7 | ❌ |
| maid_lusya | flee | 1.386 | ✅ | x=6.5 y=5.5 | ❌ |
| merchant_goran | warn | 0.270 | ✅ | x=9.2 y=3.8 | ❌ |
| player | flee | 0.609 | ✅ | None | ❌ |
| tavern_keeper_tornin | help | 0.559 | ✅ | x=10.5 y=3.0 | ❌ |
| thief_shadow | observe | 0.660 | ✅ | None | ❌ |
