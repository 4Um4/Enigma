# ENIGMA Session State — 2026-06-28 13:26
...
| **CVS** (Causal Velocity) | 2.91/мин | → +0.2 | ✅ 2.91/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 619 записей_
...
| maid_lusya | offer_job | 0.164 | ❌ | x=4.5 y=5.0 | ❌ |
