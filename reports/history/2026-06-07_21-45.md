# ENIGMA Session State — 2026-06-07 21:45
...
_История: `reports/dna_history.jsonl` — 411 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.273 | ✅ | None | ❌ |
| guard_borko | WARN | 0.412 | ❌ | x=5.7 y=7.9 | ❌ |
| maid_lusya | OBSERVE | 0.485 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.261 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.398 | ✅ | None | ❌ |
| thief_shadow | OBSERVE | 0.470 | ✅ | None | ❌ |
