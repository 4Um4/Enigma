# ENIGMA Session State — 2026-06-02 11:20
...
_История: `reports/dna_history.jsonl` — 282 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.036 | ✅ | None | ❌ |
| guard_borko | FLEE | 1.267 | ✅ | None | ❌ |
| maid_lusya | FLEE | 1.644 | ✅ | None | ❌ |
| merchant_goran | FLEE | 1.188 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.169 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.486 | ✅ | None | ❌ |
