# ENIGMA Session State — 2026-08-08 18:36
...
_Сессия: 0.9 мин | Тиков: 80 | LLM-вызовов: 84_
...
| **CVS** (Causal Velocity) | 91.16/мин | ↑ +18.1 | ✅ 91.16/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 476 (idx=5.95) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 481 (broken=0) | → | ✅ Давление доходит |
| **NEI** (Need Urgency) | 0 (critical=0) | → | ⚠️ NPC слишком комфортны (NEI=0) |
| **DRI** (Response Integrity) | 100% | ↑ +20.0% | ✅ LLM отвечает на все запросы |
| **DPI** (Dialogue Pipeline) | 100% | → +0.0% | ✅ Конвейер диалогов стабилен |

_История: `reports/dna_history.jsonl` — 939 записей_
...
**Tick Pipeline:**
Тиков: 80 | Decisions > 0: 2/80 | LLM: 84 вызовов / 84 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.817 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | seek_ally | 0.232 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | talk | 0.162 | ❌ | x=10.5 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.630 | ❌ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.260 | ❌ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.232 | ❌ | x=10.5 y=3.0 | ❌ |
| thief_shadow | trade | 0.165 | ❌ | x=13.5 y=3.0 | ❌ |
