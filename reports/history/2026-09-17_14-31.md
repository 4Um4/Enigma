# ENIGMA Session State — 2026-09-17 14:31
...
| **CVS** (Causal Velocity) | 17.52/мин | → +0.0 | ✅ 17.52/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 126 (idx=4.85) | → | ✅ Убеждения формируются |
...
_История: `reports/dna_history.jsonl` — 1141 записей_
...
**Tick Pipeline:**
Тиков: 26 | Decisions > 0: 1/26 | LLM: 6 вызовов / 4 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | help | 0.602 | ✅ | x=7.8 y=4.7 | ❌ |
| guard_borko | talk | 0.690 | ✅ | x=35.0 y=7.0 | ❌ |
| maid_lusya | flee | 1.396 | ✅ | x=10.5 y=6.5 | ❌ |
| merchant_goran | warn | 0.156 | ✅ | x=7.8 y=4.7 | ❌ |
| player | flee | 0.692 | ✅ | None | ❌ |
| tavern_keeper_tornin | help | 0.630 | ✅ | x=10.5 y=3.0 | ❌ |
| thief_shadow | observe | 0.356 | ✅ | None | ❌ |
