# ENIGMA Session State — 2026-09-24 22:13
...
_Сессия: 1.9 мин | Тиков: 219 | LLM-вызовов: 36_
...
| **CVS** (Causal Velocity) | 19.07/мин | ↑ +5.6 | ✅ 19.07/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 1050 (idx=4.79) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 1526 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1201 записей_
...
**Tick Pipeline:**
Тиков: 219 | Decisions > 0: 4/219 | LLM: 36 вызовов / 36 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.227 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | talk | 1.514 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.528 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | flee | 0.969 | ✅ | x=21.0 y=10.0 | ❌ |
| player | talk | 0.678 | ⏸ | None | ❌ |
| tavern_keeper_tornin | talk | 1.524 | ✅ | x=17.9 y=5.0 | ❌ |
| thief_shadow | observe | 0.613 | ✅ | x=11.5 y=11.0 | ❌ |
