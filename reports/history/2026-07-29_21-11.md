# ENIGMA Session State — 2026-07-29 21:11

Кампания: `Open_road` | Игрок: `Венгр`
...
_Сессия: 0.7 мин | Тиков: 0 | LLM-вызовов: 12_
...
| **CVS** (Causal Velocity) | 17.62/мин | ↑ +8.0 | ✅ 17.62/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | ↑ -700.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
...
_История: `reports/dna_history.jsonl` — 884 записей_
...
- NPC с известными координатами (6):
  ...
  - `maid_lusya`: x=13.5 y=3.1
  - `blacksmith_orm`: x=6.3 y=5.3
  - `thief_shadow`: x=16.3 y=4.0
  - `tavern_keeper_tornin`: x=11.1 y=4.3
...
**Tick Pipeline:**
Тиков: 0 | Decisions > 0: 1/0 | LLM: 12 вызовов / 6 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.687 | ❌ | x=6.3 y=5.3 | ❌ |
| guard_borko | idle | 0.232 | ❌ | x=17.2 y=4.6 | ❌ |
| maid_lusya | idle | 0.247 | ❌ | x=13.5 y=3.1 | ❌ |
| merchant_goran | flee | 0.229 | ❌ | x=3.9 y=6.0 | ❌ |
| tavern_keeper_tornin | idle | 0.166 | ❌ | x=11.1 y=4.3 | ❌ |
| thief_shadow | idle | 0.222 | ❌ | x=16.3 y=4.0 | ❌ |
