# ENIGMA Session State — 2026-06-05 11:59
...
| **PFI** (Pre-Bus Failure) | 25% | ↓ +10.7% | ⛔ 1 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 343 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.820 | ❌ | None | ❌ |
| guard_borko | ATTACK | 1.228 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.245 | ✅ | None | ❌ |
| merchant_goran | FLEE | 1.849 | ❌ | x=16.8 y=3.5 | ❌ |
| tavern_keeper_tornin | FLEE | 1.866 | ✅ | x=4.0 y=2.5 | ❌ |
| thief_shadow | FLEE | 2.070 | ✅ | None | ❌ |
