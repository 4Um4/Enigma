# ENIGMA Session State — 2026-05-28 22:24
...
| **CVS** (Causal Velocity) | 6.39/мин | ↑ +6.4 | ✅ 6.39/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 127 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | APPROACH | 0.406 | ❌ | None | ❌ |
| guard_borko | TALK | 0.371 | ❌ | x=14.1 y=2.0 | ❌ |
| maid_lusya | OBSERVE | 1.090 | ❌ узел не найден | None | ❌ |
| merchant_goran | TALK | 0.256 | ❌ | x=13.7 y=2.3 | ❌ |
| tavern_keeper_tornin | REPORT | 0.285 | ❌ узел не найден | None | ❌ |
| thief_shadow | OBSERVE | 0.159 | ❌ узел не найден | None | ❌ |
