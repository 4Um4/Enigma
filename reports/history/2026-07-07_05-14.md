# ENIGMA Session State — 2026-07-07 05:14
...
| **CVS** (Causal Velocity) | 2.12/мин | ↓ -0.6 | ✅ 2.12/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 659 записей_
...
| guard_borko | block_path | 0.209 | ❌ | x=18.0 y=7.2 | ❌ |
| maid_lusya | offer_job | 0.175 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | offer_job | 0.288 | ❌ | x=11.0 y=4.0 | ❌ |
| player | request_service | 0.315 | ❌ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.221 | ❌ | x=16.0 y=4.0 | ❌ |
