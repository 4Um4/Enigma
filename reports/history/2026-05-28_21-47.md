# ENIGMA Session State — 2026-05-28 21:47
...
_История: `reports/dna_history.jsonl` — 120 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.326 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.341 | ❌ | x=2.2 y=1.8 | ❌ |
| maid_lusya | OBSERVE | 0.310 | ❌ узел не найден | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.275 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.294 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.360 | ❌ узел не найден | None | ❌ |
