# ENIGMA Session State — 2026-05-29 23:19
...
_История: `reports/dna_history.jsonl` — 208 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.379 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.440 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.335 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.464 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.520 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.148 | ❌ узел не найден | None | ❌ |
