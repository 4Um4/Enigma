# ENIGMA Session State — 2026-07-05 11:40
...
_История: `reports/dna_history.jsonl` — 653 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.864 | ❌ | x=10.5 y=5.0 | ❌ |
| guard_borko | call_for_help | 0.634 | ❌ | x=18.0 y=7.2 | ❌ |
| maid_lusya | request_service | 0.562 | ❌ | x=11.0 y=4.0 | ❌ |
| merchant_goran | request_service | 0.708 | ❌ | x=11.0 y=4.0 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.603 | ❌ | x=16.0 y=4.0 | ❌ |
| thief_shadow | offer_job | 0.677 | ❌ | x=4.0 y=4.0 | ❌ |
