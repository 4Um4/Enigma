# ENIGMA Session State — 2026-05-28 21:07
...
_Сессия: 0.3 мин | Тиков: 2 | LLM-вызовов: 0_
...
_История: `reports/dna_history.jsonl` — 116 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.768 | ❌ | None | ❌ |
| guard_borko | OBSERVE | 0.774 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 1.649 | ❌ узел не найден | None | ❌ |
| merchant_goran | OBSERVE | 0.838 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.056 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.685 | ❌ узел не найден | None | ❌ |

**NPC с разрывом в pipeline (intent есть, traversal нет):**
  - `merchant_goran`: intent=OBSERVE, traversal=❌, coords=None
