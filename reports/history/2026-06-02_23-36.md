# ENIGMA Session State — 2026-06-02 23:36
...
_История: `reports/dna_history.jsonl` — 304 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.724 | ✅ | x=8.0 y=7.0 | ❌ |
| guard_borko | OBSERVE | 0.856 | ✅ | x=8.0 y=7.0 | ❌ |
| maid_lusya | FLEE | 1.043 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | FLEE | 0.890 | ✅ | x=8.0 y=7.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.813 | ✅ | x=8.0 y=7.0 | ❌ |
| thief_shadow | OBSERVE | 1.125 | ✅ | None | ❌ |
