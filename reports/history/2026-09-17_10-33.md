# ENIGMA Session State — 2026-09-17 10:33
...
_Сессия: 1.4 мин | Тиков: 108 | LLM-вызовов: 28_
...
| **CVS** (Causal Velocity) | 19.99/мин | ↑ +7.1 | ✅ 19.99/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 486 (idx=4.50) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 749 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1121 записей_
...
**Tick Pipeline:**
Тиков: 108 | Decisions > 0: 2/108 | LLM: 28 вызовов / 30 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.147 | ✅ | x=10.5 y=4.8 | ❌ |
| guard_borko | trade | 1.333 | ✅ | x=35.0 y=7.0 | ❌ |
| maid_lusya | flee | 1.407 | ✅ | x=13.5 y=3.0 | ❌ |
| merchant_goran | flee | 0.861 | ✅ | x=33.8 y=9.5 | ❌ |
| player | talk | 0.833 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.118 | ✅ | x=10.5 y=6.5 | ❌ |
| thief_shadow | observe | 0.541 | ✅ | None | ❌ |
