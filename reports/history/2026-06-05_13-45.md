# ENIGMA Session State — 2026-06-05 13:45
...
_История: `reports/dna_history.jsonl` — 347 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.452 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.456 | ❌ узел не найден | None | ❌ |
| maid_lusya | OFFER_JOB | 0.263 | ❌ | None | ❌ |
| merchant_goran | OFFER_JOB | 0.453 | ❌ | x=16.8 y=3.5 | ❌ |
| tavern_keeper_tornin | SPREAD_RUMOR | 0.246 | ✅ | x=4.0 y=4.0 | ❌ |
| thief_shadow | OFFER_JOB | 0.444 | ❌ | None | ❌ |
