# ENIGMA Session State — 2026-09-24 12:17
...
_Сессия: 1.6 мин | Тиков: 115 | LLM-вызовов: 30_
...
| **CVS** (Causal Velocity) | 19.12/мин | ↓ -7.5 | ✅ 19.12/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 630 (idx=5.48) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 798 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1188 записей_
...
**Tick Pipeline:**
Тиков: 115 | Decisions > 0: 3/115 | LLM: 30 вызовов / 30 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.229 | ✅ | x=10.5 y=4.8 | ❌ |
| guard_borko | talk | 1.522 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.451 | ✅ | x=10.5 y=4.8 | ❌ |
| merchant_goran | flee | 0.790 | ✅ | x=10.5 y=4.8 | ❌ |
| player | talk | 0.716 | ⏸ | None | ❌ |
| tavern_keeper_tornin | talk | 1.505 | ✅ | x=17.9 y=5.0 | ❌ |
| thief_shadow | observe | 0.698 | ✅ | x=11.5 y=11.0 | ❌ |
