# ENIGMA Session State — 2026-09-20 13:35
...
_Сессия: 6.7 мин | Тиков: 780 | LLM-вызовов: 112_
...
| **CVS** (Causal Velocity) | 16.72/мин | ↑ +2.5 | ✅ 16.72/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | ↑ -50.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 3366 (idx=4.32) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 5460 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1159 записей_
...
**Tick Pipeline:**
Тиков: 780 | Decisions > 0: 1/780 | LLM: 112 вызовов / 114 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | observe | 1.101 | ✅ | x=5.5 y=6.0 | ❌ |
| guard_borko | talk | 1.657 | ✅ | x=33.8 y=9.5 | ❌ |
| maid_lusya | flee | 1.424 | ✅ | x=10.5 y=4.8 | ❌ |
| merchant_goran | flee | 0.951 | ✅ | x=10.5 y=3.0 | ❌ |
| player | flee | 0.568 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.318 | ✅ | x=10.5 y=6.5 | ❌ |
| thief_shadow | trade | 0.505 | ✅ | x=33.8 y=9.5 | ❌ |
