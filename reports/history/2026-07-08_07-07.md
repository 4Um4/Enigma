# ENIGMA Session State — 2026-07-08 07:07
...
_История: `reports/dna_history.jsonl` — 677 записей_
...
| guard_borko | block_path | 0.335 | ❌ | x=18.4 y=7.7 | ❌ |
| maid_lusya | seek_ally | 0.188 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | request_service | 0.302 | ❌ | x=10.4 y=3.5 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.224 | ❌ | x=16.6 y=3.5 | ❌ |
| thief_shadow | change_role | 0.396 | ❌ | None | ❌ |
