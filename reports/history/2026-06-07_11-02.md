# ENIGMA Session State — 2026-06-07 11:02
...
| **PFI** (Pre-Bus Failure) | 233% | ↓ +233.3% | ⛔ 7 пред-шинных отказов — pipeline молча умирает, CDS слеп |

**Системные сигналы (требуют внимания):**
- SCF упал с 1.0 до 0.0: spatial fallback + node_not_found = регрессия spatial слоя

_История: `reports/dna_history.jsonl` — 390 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.419 | ❌ | None | ❌ |
| guard_borko | AMBUSH | 0.446 | ❌ узел не найден | None | ❌ |
| maid_lusya | SPREAD_RUMOR | 0.191 | ❌ | None | ❌ |
| merchant_goran | OFFER_JOB | 0.372 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | SPREAD_RUMOR | 0.316 | ❌ | None | ❌ |
| thief_shadow | OFFER_JOB | 0.393 | ❌ | None | ❌ |
