# ENIGMA Session State — 2026-05-29 19:31
...
_История: `reports/dna_history.jsonl` — 193 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.361 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.524 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.353 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.314 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.414 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.033 | ❌ узел не найден | None | ❌ |
