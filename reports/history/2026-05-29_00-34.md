# ENIGMA Session State — 2026-05-29 00:34
...
_История: `reports/dna_history.jsonl` — 135 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.004 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.230 | ❌ | None | ❌ |
| maid_lusya | FLEE | 2.313 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.276 | ❌ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.407 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.929 | ❌ узел не найден | None | ❌ |
