# ENIGMA Session State — 2026-05-30 13:30
...
_История: `reports/dna_history.jsonl` — 232 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.348 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.668 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.394 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.465 | ❌ | x=16.0 y=4.5 | ❌ |
| tavern_keeper_tornin | FLEE | 1.428 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.205 | ❌ узел не найден | None | ❌ |
