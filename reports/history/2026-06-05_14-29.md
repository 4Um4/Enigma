# ENIGMA Session State — 2026-06-05 14:29
...
_Сессия: 0.7 мин | Тиков: 5 | LLM-вызовов: 2_
...
| **CVS** (Causal Velocity) | 2.73/мин | ↑ +0.6 | ✅ 2.73/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 120% | → +0.0% | ⛔ 6 пред-шинных отказов — pipeline молча умирает, CDS слеп |
...
_История: `reports/dna_history.jsonl` — 354 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.423 | ❌ | None | ❌ |
| guard_borko | SEEK_ALLY | 0.364 | ❌ узел не найден | None | ❌ |
| maid_lusya | CALL_FOR_HELP | 0.276 | ✅ | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.348 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | CALL_FOR_HELP | 0.216 | ❌ | x=4.0 y=2.5 | ❌ |
| thief_shadow | REQUEST_SERVICE | 0.400 | ❌ | None | ❌ |
