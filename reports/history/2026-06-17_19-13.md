# ENIGMA Session State — 2026-06-17 19:13
...
_История: `reports/dna_history.jsonl` — 589 записей_
...
- NPC с известными координатами (1):
  - `tavern_keeper_tornin`: x=5.7 y=4.0
...
| tavern_keeper_tornin | ? | 0.000 | ✅ | x=5.7 y=4.0 | ❌ |
