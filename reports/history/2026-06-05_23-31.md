# ENIGMA Session State — 2026-06-05 23:31
...
| **CVS** (Causal Velocity) | 1.76/мин | ↓ -0.8 | ✅ 1.76/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 20% | → +0.0% | ⛔ 1 пред-шинных отказов — pipeline молча умирает, CDS слеп |
...
_История: `reports/dna_history.jsonl` — 366 записей_
...
| guard_borko | AMBUSH | 0.441 | ❌ узел не найден | None | ❌ |
| maid_lusya | CHANGE_ROLE | 0.268 | ❌ | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.425 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | CALL_FOR_HELP | 0.324 | ❌ | None | ❌ |
| thief_shadow | BLOCK_PATH | 0.354 | ❌ | None | ❌ |
