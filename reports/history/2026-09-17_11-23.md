# ENIGMA Session State — 2026-09-17 11:23
...
_Сессия: 0.3 мин | Тиков: 26 | LLM-вызовов: 6_
...
| **CVS** (Causal Velocity) | 21.11/мин | ↑ +6.9 | ✅ 21.11/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 117 (idx=4.50) | → | ✅ Убеждения формируются |
...
_История: `reports/dna_history.jsonl` — 1124 записей_
...
**Tick Pipeline:**
Тиков: 26 | Decisions > 0: 1/26 | LLM: 6 вызовов / 6 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | help | 0.632 | ✅ | x=5.5 y=6.0 | ❌ |
| guard_borko | block_path | 0.715 | ✅ | x=35.0 y=7.0 | ❌ |
| maid_lusya | flee | 1.396 | ✅ | x=10.5 y=6.5 | ❌ |
| merchant_goran | warn | 0.206 | ✅ | x=5.5 y=6.0 | ❌ |
| player | flee | 0.692 | ⏸ | None | ❌ |
| tavern_keeper_tornin | help | 0.660 | ✅ | x=10.5 y=3.0 | ❌ |
| thief_shadow | observe | 0.656 | ⏸ | None | ❌ |
