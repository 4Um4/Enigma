# ENIGMA Session State — 2026-06-05 23:25
...
_Сессия: 1.9 мин | Тиков: 6 | LLM-вызовов: 4_
...
| **CVS** (Causal Velocity) | 2.11/мин | ↑ +1.1 | ✅ 2.11/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 17% | ↑ -23.3% | ⚠️ 1 пред-шинных отказов — CDS слеп к части крахов |
...
_История: `reports/dna_history.jsonl` — 365 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.502 | ❌ | None | ❌ |
| guard_borko | SPREAD_RUMOR | 0.305 | ❌ узел не найден | None | ❌ |
| maid_lusya | SPREAD_RUMOR | 0.263 | ✅ | None | ❌ |
| merchant_goran | CHANGE_ROLE | 0.447 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | SEEK_ALLY | 0.263 | ❌ | None | ❌ |
| thief_shadow | CHANGE_ROLE | 0.382 | ❌ | None | ❌ |
