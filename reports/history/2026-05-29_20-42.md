# ENIGMA Session State — 2026-05-29 20:42
...
_История: `reports/dna_history.jsonl` — 198 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.182 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.193 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 1.798 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.244 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.268 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.980 | ❌ узел не найден | None | ❌ |
