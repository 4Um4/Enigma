# ENIGMA Session State — 2026-07-18 08:54
...
_Сессия: 1.8 мин | Тиков: 3 | LLM-вызовов: 6_
...
| **CVS** (Causal Velocity) | 3.41/мин | ↓ -5.4 | ✅ 3.41/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 738 записей_
...
- NPC с известными координатами (5):
  - `maid_lusya`: x=8.0 y=6.4
  - `blacksmith_orm`: x=11.8 y=9.8
  - `thief_shadow`: x=8.2 y=6.5
  - `merchant_goran`: x=15.6 y=6.4
  - `tavern_keeper_tornin`: x=8.1 y=3.5
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | change_role | 0.569 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | seek_ally | 0.279 | ❌ | None | ❌ |
| maid_lusya | idle | 0.000 | ❌ | x=8.0 y=6.4 | ❌ |
| merchant_goran | change_role | 0.252 | ❌ | x=15.6 y=6.4 | ❌ |
| player | request_service | 0.322 | ❌ | None | ❌ |
| tavern_keeper_tornin | idle | 0.000 | ❌ | x=8.1 y=3.5 | ❌ |
| thief_shadow | ambush | 0.281 | ❌ | x=8.2 y=6.5 | ❌ |
