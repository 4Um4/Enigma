# ENIGMA Session State — 2026-09-26 14:18
...
_Сессия: 3.1 мин | Тиков: 137 | LLM-вызовов: 90_
...
| **CVS** (Causal Velocity) | 29.29/мин | ↑ +27.7 | ✅ 29.29/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 913 (idx=6.66) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 959 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1247 записей_
...
**Tick Pipeline:**
Тиков: 137 | Decisions > 0: 3/137 | LLM: 90 вызовов / 92 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | warn | 1.847 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | talk | 1.544 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | spread_rumor | 2.338 | ✅ | x=16.7 y=2.4 | ❌ |
