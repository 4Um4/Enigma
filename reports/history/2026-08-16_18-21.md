# ENIGMA Session State — 2026-08-16 18:21
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -55.5 | LLM не вызывалась: сессия без действий игрока |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 18 (AttrErr=0, TypeErr=0) | → | ⚠️ КРИТИЧНО: невидимые регрессии (Tracebacks) |
...
_История: `reports/dna_history.jsonl` — 1024 записей_
