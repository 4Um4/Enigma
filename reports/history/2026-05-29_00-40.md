# ENIGMA Session State — 2026-05-29 00:40
...
_История: `reports/dna_history.jsonl` — 137 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.167 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.206 | ❌ | None | ❌ |
| maid_lusya | FLEE | 2.380 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.217 | ❌ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.417 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.945 | ❌ узел не найден | None | ❌ |
