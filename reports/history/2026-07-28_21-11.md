# ENIGMA Session State — 2026-07-28 21:11

Кампания: `Open_road` | Игрок: `weg`
...
| **PFI** (Pre-Bus Failure) | 1300% | ↓ +1300.0% | ⛔ 13 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 873 записей_
...
**Предупреждения:**
  - ⚠️ КРИТИЧНО: 13 пред-шинных отказов (pipeline=0, causality=0, phase8=0, tick_orch=13) — CDS слеп к этим багам без Инварианта 3
