# ENIGMA Session State — 2026-05-26 23:32
...
_История: `reports/dna_history.jsonl` — 88 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.475 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.548 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 1.581 | ✅ | None | ❌ |
| merchant_goran | OFFER_JOB | 0.481 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.809 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.368 | ✅ | None | ❌ |
