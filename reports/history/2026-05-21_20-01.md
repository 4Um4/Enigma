# ENIGMA Session State — 2026-05-21 20:01
...
_История: `reports/dna_history.jsonl` — 29 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.311 | ❌ | x=16.4 y=5.5 | ❌ |
| guard_borko | FLEE | 0.275 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.291 | ✅ | x=8.0 y=7.0 | ❌ |
| merchant_goran | FLEE | 0.314 | ❌ | x=14.5 y=5.5 | ❌ |
| player | ? | 0.000 | ❌ | x=6.6 y=5.2 | ❌ |
| tavern_keeper_tornin | FLEE | 0.226 | ✅ | x=4.0 y=4.0 | ❌ |
| thief_shadow | FLEE | 0.332 | ✅ | None | ❌ |
