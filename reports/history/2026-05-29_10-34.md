# ENIGMA Session State — 2026-05-29 10:34
...
_История: `reports/dna_history.jsonl` — 158 записей_
...
- NPC с известными координатами (2):
  - `guard_borko`: x=1.9 y=1.9
  - `merchant_goran`: x=2.1 y=2.1
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.196 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.464 | ❌ | x=1.9 y=1.9 | ❌ |
| maid_lusya | FLEE | 2.437 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.371 | ❌ | x=2.1 y=2.1 | ❌ |
| tavern_keeper_tornin | FLEE | 1.488 | ❌ узел не найден | None | ❌ |
