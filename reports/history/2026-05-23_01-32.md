# ENIGMA Session State — 2026-05-23 01:32
...
_Сессия: 0.9 мин | Тиков: 3 | LLM-вызовов: 0_
...
_История: `reports/dna_history.jsonl` — 41 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.310 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.362 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 0.437 | ✅ | None | ❌ |
| merchant_goran | OFFER_JOB | 0.259 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.407 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.567 | ❌ | x=8.0 y=7.0 | ❌ |
