# ENIGMA Session State — 2026-09-17 11:57
...
_Сессия: 1.2 мин | Тиков: 167 | LLM-вызовов: 22_
...
| **CVS** (Causal Velocity) | 18.12/мин | ↓ -12.1 | ✅ 18.12/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 711 (idx=4.26) | → | ✅ Убеждения формируются |
...
_История: `reports/dna_history.jsonl` — 1128 записей_
...
**Tick Pipeline:**
Тиков: 167 | Decisions > 0: 2/167 | LLM: 22 вызовов / 24 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | talk | 1.236 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | talk | 1.623 | ✅ | x=35.0 y=7.0 | ❌ |
| maid_lusya | flee | 1.500 | ✅ | x=10.5 y=6.5 | ❌ |
| merchant_goran | flee | 0.811 | ✅ | x=10.5 y=6.5 | ❌ |
| player | trade | 0.721 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.380 | ✅ | x=10.5 y=6.5 | ❌ |
| thief_shadow | observe | 0.776 | ⏸ | None | ❌ |
