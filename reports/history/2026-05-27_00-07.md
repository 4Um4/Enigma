# ENIGMA Session State — 2026-05-27 00:07
...
_История: `reports/dna_history.jsonl` — 92 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.485 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.622 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 1.532 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.527 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.746 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.542 | ✅ | None | ❌ |
