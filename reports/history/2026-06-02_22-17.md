# ENIGMA Session State — 2026-06-02 22:17
...
_История: `reports/dna_history.jsonl` — 297 записей_
...
- NPC с известными координатами (5):
  ...
  - `tavern_keeper_tornin`: x=8.0 y=7.0
  - `blacksmith_orm`: x=8.0 y=7.0
  - `guard_borko`: x=8.0 y=7.0
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.873 | ❌ | x=8.0 y=7.0 | ❌ |
| guard_borko | ATTACK | 1.243 | ❌ | x=8.0 y=7.0 | ❌ |
| maid_lusya | OBSERVE | 1.201 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.839 | ❌ | x=8.0 y=7.0 | ❌ |
| tavern_keeper_tornin | ATTACK | 1.507 | ❌ узел не найден | x=8.0 y=7.0 | ❌ |
| thief_shadow | OBSERVE | 1.224 | ❌ | None | ❌ |
