# ENIGMA Session State — 2026-06-07 19:31
...
_Сессия: 1.5 мин | Тиков: 2 | LLM-вызовов: 0_
...
| **PFI** (Pre-Bus Failure) | 200% | → +0.0% | ⛔ 4 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 407 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.417 | ❌ | None | ❌ |
| guard_borko | AMBUSH | 0.428 | ❌ узел не найден | x=4.0 y=2.5 | ❌ |
| maid_lusya | REQUEST_SERVICE | 0.263 | ❌ | None | ❌ |
| merchant_goran | CHANGE_ROLE | 0.404 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | SPREAD_RUMOR | 0.238 | ❌ | None | ❌ |
| thief_shadow | CHANGE_ROLE | 0.423 | ❌ | None | ❌ |
