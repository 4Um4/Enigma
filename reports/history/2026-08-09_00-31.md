# ENIGMA Session State — 2026-08-09 00:31
...
_Сессия: 2.2 мин | Тиков: 1 | LLM-вызовов: 5_
...
| **CVS** (Causal Velocity) | 2.23/мин | ↑ +2.2 | ✅ 2.23/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 988 записей_
...
| guard_borko | ? | 0.000 | ❌ | x=13.5 y=9.5 | ❌ |
| maid_lusya | ? | 0.000 | ❌ | x=10.5 y=3.0 | ❌ |
