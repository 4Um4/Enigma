# ENIGMA Session State — 2026-06-03 01:11
...
_Сессия: 0.7 мин | Тиков: 3 | LLM-вызовов: 0_
...
| **NPI** (NPC Pipeline) | 57% | ↓ -9.6% | ⚠️ 4/7 NPC с координатами: есть потери в traversal |
...
_История: `reports/dna_history.jsonl` — 318 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.232 | ❌ | None | ❌ |
| guard_borko | AMBUSH | 0.244 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | OBSERVE | 0.300 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.202 | ❌ | x=14.5 y=5.5 | ❌ |
| player | ? | 0.000 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.220 | ❌ узел не найден | x=4.5 y=2.5 | ❌ |
| thief_shadow | OBSERVE | 0.228 | ❌ | None | ❌ |
