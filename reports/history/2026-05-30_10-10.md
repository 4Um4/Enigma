# ENIGMA Session State — 2026-05-30 10:10
...
_История: `reports/dna_history.jsonl` — 220 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.279 | ❌ | None | ❌ |
| guard_borko | AMBUSH | 0.280 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.426 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.358 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.381 | ❌ узел не найден | None | ❌ |
| thief_shadow | REQUEST_SERVICE | 0.287 | ❌ узел не найден | None | ❌ |

**NPC с разрывом в pipeline (intent есть, traversal нет):**
  - `maid_lusya`: intent=FLEE, traversal=❌, coords=None
  - `thief_shadow`: intent=REQUEST_SERVICE, traversal=❌, coords=None
