# ENIGMA Session State — 2026-08-08 23:47
...
_Сессия: 1.2 мин | Тиков: 72 | LLM-вызовов: 60_
...
| **CVS** (Causal Velocity) | 48.42/мин | ↑ +33.0 | ✅ 48.42/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 500 (idx=6.94) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 431 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 982 записей_
...
**Tick Pipeline:**
Тиков: 72 | Decisions > 0: 4/72 | LLM: 60 вызовов / 60 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.981 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | ambush | 0.240 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | call_for_help | 0.180 | ❌ | x=12.0 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.649 | ❌ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.208 | ❌ | None | ❌ |
| tavern_keeper_tornin | seek_ally | 0.210 | ❌ | x=10.5 y=3.0 | ❌ |
