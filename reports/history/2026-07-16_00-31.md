# ENIGMA Session State — 2026-07-16 00:31
...
_История: `reports/dna_history.jsonl` — 715 записей_
...
- LLM CJK-галлюцинации: 40 строк
- Стартап backend: ✅
- LLM сервер: ✅

**Предупреждения:**
  - ⚠️ LLM галлюцинирует на китайском: 40 строк

**Movement Pipeline (по NPC):**
| NPC | Intent | Score | Traversal | Координаты | Виден игроку |
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.962 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | ambush | 0.226 | ❌ | None | ❌ |
| maid_lusya | change_role | 0.280 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | offer_job | 0.454 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.223 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | request_service | 0.333 | ❌ | x=11.6 y=9.8 | ❌ |
