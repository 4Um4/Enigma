# ENIGMA Session State — 2026-06-02 23:40
...
_История: `reports/dna_history.jsonl` — 305 записей_
...
- NPC с известными координатами (5):
  ...
  - `tavern_keeper_tornin`: x=19.5 y=4.4
  - `blacksmith_orm`: x=18.1 y=2.9
  - `guard_borko`: x=16.8 y=4.1
  - `merchant_goran`: x=17.4 y=6.8
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.843 | ❌ | x=18.1 y=2.9 | ❌ |
| guard_borko | FLEE | 0.869 | ❌ | x=16.8 y=4.1 | ❌ |
| maid_lusya | FLEE | 1.086 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.861 | ❌ | x=17.4 y=6.8 | ❌ |
| tavern_keeper_tornin | FLEE | 0.852 | ❌ узел не найден | x=19.5 y=4.4 | ❌ |
| thief_shadow | FLEE | 1.098 | ✅ | None | ❌ |
