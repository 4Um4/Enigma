# ENIGMA Session State — 2026-09-24 12:53
...
_Сессия: 2.0 мин | Тиков: 97 | LLM-вызовов: 46_
...
| **CVS** (Causal Velocity) | 23.13/мин | ↓ -6.4 | ✅ 23.13/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 459 (idx=4.73) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 674 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1196 записей_
...
**Tick Pipeline:**
Тиков: 97 | Decisions > 0: 4/97 | LLM: 46 вызовов / 46 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.139 | ✅ | x=10.5 y=3.0 | ❌ |
| guard_borko | talk | 1.208 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.360 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | flee | 0.950 | ✅ | x=10.5 y=3.0 | ❌ |
| player | talk | 0.704 | ⏸ | None | ❌ |
| tavern_keeper_tornin | talk | 1.452 | ✅ | x=17.3 y=3.7 | ❌ |
| thief_shadow | observe | 0.733 | ✅ | x=11.5 y=11.0 | ❌ |
