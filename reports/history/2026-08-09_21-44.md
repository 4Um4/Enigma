# ENIGMA Session State — 2026-08-09 21:44
...
**Tick Pipeline:**
Тиков: 9 | Decisions > 0: 2/9 | LLM: 12 вызовов / 8 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.897 | ❌ | x=10.5 y=6.5 | ❌ |
| guard_borko | spread_rumor | 0.230 | ❌ | x=13.5 y=3.0 | ❌ |
| maid_lusya | seek_ally | 0.158 | ❌ | x=10.5 y=3.0 | ❌ |
| merchant_goran | request_service | 0.650 | ❌ | x=9.2 y=6.2 | ❌ |
| tavern_keeper_tornin | seek_ally | 0.206 | ❌ | x=9.2 y=6.2 | ❌ |
| thief_shadow | block_path | 0.542 | ❌ | x=13.5 y=3.0 | ❌ |
