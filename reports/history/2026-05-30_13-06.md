# ENIGMA Session State — 2026-05-30 13:06
...
_История: `reports/dna_history.jsonl` — 231 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.288 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.509 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.337 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.520 | ❌ | x=16.0 y=4.5 | ❌ |
| tavern_keeper_tornin | FLEE | 1.548 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.074 | ❌ узел не найден | None | ❌ |
