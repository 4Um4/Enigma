# ENIGMA Session State — 2026-08-09 00:41
...
_Сессия: 5.0 мин | Тиков: 0 | LLM-вызовов: 6_
...
| **CVS** (Causal Velocity) | 1.21/мин | ↓ -1.0 | ✅ 1.21/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 56 (AttrErr=3, TypeErr=54) | → | ⚠️ КРИТИЧНО: невидимые регрессии (Tracebacks) |
| **BCI** (Belief Crystallization) | 0 (idx=0.00) | → | ⚠️ Память не кристаллизуется (BCI=0) |
| **BPI** (Break Progress) | 321 (broken=0) | → | ⚠️ NPC не ломаются (BPI=0) |
...
_История: `reports/dna_history.jsonl` — 990 записей_
...
**Tick Pipeline:**
Тиков: 0 | Decisions > 0: 0/0 | LLM: 6 вызовов / 6 ответов | Симуляция: ✅ живёт
