# ENIGMA Session State — 2026-07-15 23:43
...
_История: `reports/dna_history.jsonl` — 711 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.871 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | spread_rumor | 0.248 | ❌ | x=12.4 y=10.4 | ❌ |
| maid_lusya | call_for_help | 0.254 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | offer_job | 0.458 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.273 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | change_role | 0.264 | ❌ | x=11.6 y=9.8 | ❌ |
