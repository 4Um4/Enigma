# ENIGMA Session State — 2026-05-27 23:05
...
_Сессия: 1.1 мин | Тиков: 5 | LLM-вызовов: 2_
...
| **CVS** (Causal Velocity) | 1.80/мин | ↓ -3.0 | ✅ 1.80/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 108 записей_
...
- LLM CJK-галлюцинации: 3 строк
- Стартап backend: ✅
- LLM сервер: ✅

**Предупреждения:**
  - ⚠️ КРИТИЧНО: все тики вернули 0 decisions — симуляция заморожена
  - ⚠️ LLM галлюцинирует на китайском: 3 строк

**Movement Pipeline (по NPC):**
| NPC | Intent | Score | Traversal | Координаты | Виден игроку |
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.356 | ❌ | None | ❌ |
| guard_borko | OBSERVE | 0.263 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.288 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.336 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.276 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.263 | ❌ узел не найден | None | ❌ |
