# ENIGMA Session State — 2026-07-24 23:55
...
_Сессия: 25.5 мин | Тиков: 0 | LLM-вызовов: 638_
...
| **CVS** (Causal Velocity) | 25.04/мин | ↑ +2.2 | ✅ 25.04/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 777 записей_
...
- NPC с известными координатами (6):
  - `guard_borko`: x=15.4 y=4.3
  - `merchant_goran`: x=5.4 y=7.5
  - `maid_lusya`: x=4.5 y=5.0
  - `blacksmith_orm`: x=5.8 y=7.8
  - `thief_shadow`: x=5.5 y=7.8
  - `tavern_keeper_tornin`: x=8.6 y=11.1
...
**Tick Pipeline:**
Тиков: 0 | Decisions > 0: 1/0 | LLM: 638 вызовов / 636 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.836 | ❌ | x=5.8 y=7.8 | ❌ |
| guard_borko | block_path | 0.244 | ❌ | x=15.4 y=4.3 | ❌ |
| maid_lusya | flee | 0.236 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | change_role | 0.194 | ❌ | x=5.4 y=7.5 | ❌ |
| player | flee | 0.238 | ❌ | None | ❌ |
| tavern_keeper_tornin | flee | 0.199 | ❌ | x=8.6 y=11.1 | ❌ |
| thief_shadow | request_service | 0.206 | ❌ | x=5.5 y=7.8 | ❌ |
