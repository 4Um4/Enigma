# ENIGMA Session State — 2026-05-25 21:13
...
_История: `reports/dna_history.jsonl` — 69 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | APPROACH | 0.554 | ❌ | None | ❌ |
| guard_borko | TALK | 0.525 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 1.392 | ✅ | None | ❌ |
| merchant_goran | APPROACH | 0.493 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.422 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.329 | ✅ | x=16.0 y=4.0 | ❌ |
