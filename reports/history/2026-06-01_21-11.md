# ENIGMA Session State — 2026-06-01 21:11
...
_История: `reports/dna_history.jsonl` — 269 записей_
...
| maid_lusya | FLEE | 1.462 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.292 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.676 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.390 | ❌ узел не найден | None | ❌ |
