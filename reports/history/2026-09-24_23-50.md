# ENIGMA Session State — 2026-09-24 23:50
...
_Сессия: 5.0 мин | Тиков: 102 | LLM-вызовов: 24_
...
| **CVS** (Causal Velocity) | 4.79/мин | ↓ -16.4 | ✅ 4.79/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 6 (AttrErr=6, TypeErr=0) | → | ⚠️ КРИТИЧНО: невидимые регрессии (Tracebacks) |
| **BCI** (Belief Crystallization) | 570 (idx=5.59) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 728 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1204 записей_
...
**Tick Pipeline:**
Тиков: 102 | Decisions > 0: 2/102 | LLM: 24 вызовов / 26 ответов | Симуляция: ❌ МЕРТВА
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.237 | ✅ | x=12.0 y=3.9 | ❌ |
| guard_borko | talk | 1.329 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.376 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | flee | 0.788 | ✅ | x=10.5 y=3.0 | ❌ |
| player | talk | 0.841 | ⏸ | None | ❌ |
| tavern_keeper_tornin | talk | 1.510 | ✅ | x=16.7 y=2.4 | ❌ |
| thief_shadow | observe | 0.580 | ✅ | x=11.5 y=11.0 | ❌ |
