# ENIGMA Session State — 2026-07-05 10:29
...
| **CVS** (Causal Velocity) | 1.06/мин | ↑ +1.1 | ✅ 1.06/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | ↑ -15600.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 649 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | change_role | 0.389 | ❌ | x=16.0 y=4.0 | ❌ |
| guard_borko | call_for_help | 0.256 | ❌ | x=18.0 y=7.2 | ❌ |
| maid_lusya | offer_job | 0.289 | ❌ | x=11.0 y=4.0 | ❌ |
| merchant_goran | change_role | 0.281 | ❌ | x=11.0 y=4.0 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.227 | ❌ | x=11.0 y=4.0 | ❌ |
| thief_shadow | request_service | 0.314 | ❌ | x=4.0 y=4.0 | ❌ |
