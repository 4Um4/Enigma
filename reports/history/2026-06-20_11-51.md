# ENIGMA Session State — 2026-06-20 11:51
...
_Сессия: 1.3 мин | Тиков: 0 | LLM-вызовов: 1_
...
| **CVS** (Causal Velocity) | 0.75/мин | ↑ +0.8 | ✅ 0.75/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 1800% | ↓ +1800.0% | ⛔ 18 пред-шинных отказов — pipeline молча умирает, CDS слеп |
...
_История: `reports/dna_history.jsonl` — 591 записей_
...
**Предупреждения:**
  - ⚠️ КРИТИЧНО: 18 пред-шинных отказов (pipeline=0, causality=0, phase8=0, tick_orch=18) — CDS слеп к этим багам без Инварианта 3

**Movement Pipeline (по NPC):**
| NPC | Intent | Score | Traversal | Координаты | Виден игроку |
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | APPROACH | 0.257 | ✅ | None | ❌ |
| guard_borko | REPORT | 0.360 | ✅ | None | ❌ |
| maid_lusya | OBSERVE | 0.375 | ✅ | None | ❌ |
| merchant_goran | TRADE | 0.159 | ✅ | None | ❌ |
| tavern_keeper_tornin | WARN | 0.239 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.238 | ✅ | None | ❌ |
