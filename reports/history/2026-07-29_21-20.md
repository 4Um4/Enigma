# ENIGMA Session State — 2026-07-29 21:20
...
_Сессия: 0.3 мин | Тиков: 0 | LLM-вызовов: 8_
...
| **CVS** (Causal Velocity) | 24.51/мин | ↑ +6.9 | ✅ 24.51/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 886 записей_
...
- NPC с известными координатами (6):
  ...
  - `thief_shadow`: x=4.1 y=7.4
  - `tavern_keeper_tornin`: x=9.4 y=2.5
...
**Tick Pipeline:**
Тиков: 0 | Decisions > 0: 1/0 | LLM: 8 вызовов / 4 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.808 | ❌ | x=6.3 y=5.3 | ❌ |
| guard_borko | idle | 0.203 | ❌ | x=10.9 y=7.0 | ❌ |
| maid_lusya | flee | 0.216 | ❌ | x=13.5 y=3.1 | ❌ |
| merchant_goran | offer_job | 0.181 | ❌ | x=5.9 y=5.0 | ❌ |
| tavern_keeper_tornin | observe | 0.242 | ❌ | x=9.4 y=2.5 | ❌ |
| thief_shadow | idle | 0.000 | ❌ | x=4.1 y=7.4 | ❌ |
