# ENIGMA Session State — 2026-05-23 12:38
...
_История: `reports/dna_history.jsonl` — 43 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.272 | ❌ | None | ❌ |
| guard_borko | OBSERVE | 0.260 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 0.434 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.392 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.230 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.299 | ✅ | x=8.0 y=7.0 | ❌ |
