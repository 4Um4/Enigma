# ENIGMA Session State — 2026-08-08 21:21
...
_Сессия: 0.4 мин | Тиков: 26 | LLM-вызовов: 28_
...
| **CVS** (Causal Velocity) | 70.63/мин | ↑ +70.6 | ✅ 70.63/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 154 (idx=5.92) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 156 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 957 записей_
...
**Tick Pipeline:**
Тиков: 26 | Decisions > 0: 1/26 | LLM: 28 вызовов / 26 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.662 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | block_path | 0.276 | ❌ | x=6.0 y=8.0 | ❌ |
| maid_lusya | flee | 0.234 | ❌ | x=10.5 y=6.5 | ❌ |
| merchant_goran | request_service | 0.677 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.206 | ❌ | x=10.5 y=3.0 | ❌ |
