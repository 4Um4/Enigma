# ENIGMA Session State — 2026-08-08 18:35
...
| **CVS** (Causal Velocity) | 10.14/мин | ↓ -86.0 | ✅ 10.14/мин: активная сессия |
...
| **DRI** (Response Integrity) | 100% | ↑ +6.2% | ✅ LLM отвечает на все запросы |
| **DPI** (Dialogue Pipeline) | 100% | → +0.0% | ✅ Конвейер диалогов стабилен |

_История: `reports/dna_history.jsonl` — 938 записей_
...
| guard_borko | spread_rumor | 0.209 | ❌ | x=11.0 y=10.0 | ❌ |
