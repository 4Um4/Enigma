# ENIGMA Session State — 2026-06-01 17:02
...
| **CVS** (Causal Velocity) | 3.27/мин | ↑ +3.3 | ✅ 3.27/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 258 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.373 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.244 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 0.347 | ❌ | None | ❌ |
| merchant_goran | FLEE | 0.373 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.402 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.306 | ❌ узел не найден | None | ❌ |
