# ENIGMA Session State — 2026-05-30 10:12
...
_История: `reports/dna_history.jsonl` — 222 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.290 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.269 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.446 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.366 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.350 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.325 | ❌ узел не найден | None | ❌ |
