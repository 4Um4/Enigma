# ENIGMA Session State — 2026-06-23 22:18
...
_Сессия: 3.5 мин | Тиков: 7 | LLM-вызовов: 7_
...
| **NPI** (NPC Pipeline) | 67% | ↑ +66.7% | ⚠️ 4/6 NPC с координатами: есть потери в traversal |
...
| **CVS** (Causal Velocity) | 1.99/мин | ↑ +0.8 | ✅ 1.99/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 71% | ↑ -928.6% | ⛔ 5 пред-шинных отказов — pipeline молча умирает, CDS слеп |
...
_История: `reports/dna_history.jsonl` — 594 записей_
...
- NPC с известными координатами (4):
  - `merchant_goran`: x=4.0 y=2.5
  - `blacksmith_orm`: x=8.0 y=12.0
  - `tavern_keeper_tornin`: x=11.4 y=3.7
...
**Tick Pipeline:**
Тиков: 7 | Decisions > 0: 0/7 | LLM: 7 вызовов / 7 ответов | Симуляция: ❌ МЕРТВА
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.431 | ❌ | x=8.0 y=12.0 | ❌ |
| guard_borko | SEEK_ALLY | 0.363 | ❌ | x=16.7 y=5.1 | ❌ |
| maid_lusya | SPREAD_RUMOR | 0.238 | ✅ | None | ❌ |
| merchant_goran | OFFER_JOB | 0.451 | ✅ | x=4.0 y=2.5 | ❌ |
| tavern_keeper_tornin | SPREAD_RUMOR | 0.299 | ✅ | x=11.4 y=3.7 | ❌ |
| thief_shadow | REQUEST_SERVICE | 0.409 | ✅ | None | ❌ |
