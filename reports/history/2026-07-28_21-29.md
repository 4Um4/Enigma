# ENIGMA Session State — 2026-07-28 21:29

Кампания: `Open_road` | Игрок: `фца`
...
_Сессия: 1.8 мин | Тиков: 0 | LLM-вызовов: 4_
...
| **CVS** (Causal Velocity) | 2.26/мин | ↑ +2.3 | ✅ 2.26/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | ↑ -1300.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
...
_История: `reports/dna_history.jsonl` — 875 записей_
...
- NPC с известными координатами (6):
  - `guard_borko`: x=10.9 y=3.5
  - `merchant_goran`: x=9.9 y=6.0
  - `maid_lusya`: x=10.5 y=6.7
  - `blacksmith_orm`: x=9.7 y=5.3
  - `thief_shadow`: x=7.4 y=4.5
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.738 | ❌ | x=9.7 y=5.3 | ❌ |
| guard_borko | flee | 0.236 | ❌ | x=10.9 y=3.5 | ❌ |
| maid_lusya | observe | 0.192 | ❌ | x=10.5 y=6.7 | ❌ |
| merchant_goran | observe | 0.201 | ❌ | x=9.9 y=6.0 | ❌ |
| tavern_keeper_tornin | idle | 0.205 | ❌ | x=11.1 y=6.0 | ❌ |
| thief_shadow | observe | 0.239 | ❌ | x=7.4 y=4.5 | ❌ |
