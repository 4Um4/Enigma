# ENIGMA Session State — 2026-08-08 22:54
...
_Сессия: 2.7 мин | Тиков: 0 | LLM-вызовов: 0_
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -11.4 | LLM не вызывалась: сессия без действий игрока |
...
| **DRI** (Response Integrity) | 100% | ↑ +1.4% | ✅ LLM отвечает на все запросы |
...
_История: `reports/dna_history.jsonl` — 969 записей_
