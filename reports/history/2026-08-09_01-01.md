# ENIGMA Session State — 2026-08-09 01:01
...
_Сессия: 7.8 мин | Тиков: 1 | LLM-вызовов: 8_
...
| **NPI** (NPC Pipeline) | 100% | → +0.0% | ✅ 5/5 NPC с реальными координатами |
...
| **CVS** (Causal Velocity) | 1.03/мин | ↓ -4.4 | ✅ 1.03/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 993 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ? | 0.000 | ❌ | x=7.0 y=6.5 | ❌ |
| guard_borko | ? | 0.000 | ❌ | x=5.5 y=6.0 | ❌ |
| maid_lusya | ? | 0.000 | ❌ | x=10.5 y=6.5 | ❌ |
| merchant_goran | ? | 0.000 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | ? | 0.000 | ❌ | x=10.5 y=6.5 | ❌ |
