# ENIGMA Session State — 2026-05-28 22:35
...
| **NPI** (NPC Pipeline) | 0% | ↓ -33.3% | ⛔ 0/6 NPC имеют координаты: traversal полностью сломан |
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -6.4 | LLM не вызывалась: сессия без действий игрока |

**Системные сигналы (требуют внимания):**
- NPI упал на -33%: spatial pipeline деградировал между сессиями

_История: `reports/dna_history.jsonl` — 129 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.933 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.859 | ❌ | None | ❌ |
| maid_lusya | FLEE | 1.615 | ❌ узел не найден | None | ❌ |
| merchant_goran | OBSERVE | 0.820 | ❌ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.017 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.865 | ❌ узел не найден | None | ❌ |
