# ENIGMA Session State — 2026-06-01 21:18
...
_История: `reports/dna_history.jsonl` — 270 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | APPROACH | 0.344 | ❌ | None | ❌ |
| guard_borko | OBSERVE | 0.445 | ✅ | None | ❌ |
| maid_lusya | OBSERVE | 1.071 | ✅ | None | ❌ |
| merchant_goran | APPROACH | 0.411 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.626 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.507 | ✅ | None | ❌ |
