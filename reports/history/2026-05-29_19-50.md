# ENIGMA Session State — 2026-05-29 19:50
...
_История: `reports/dna_history.jsonl` — 195 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.313 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.489 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.423 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.514 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.494 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.018 | ❌ узел не найден | None | ❌ |
