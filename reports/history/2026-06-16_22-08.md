# ENIGMA Session State — 2026-06-16 22:08
...
| **NPI** (NPC Pipeline) | 17% | ↓ -3.3% | ⚠️ 1/6 NPC с координатами: spatial pipeline частично сломан |
...
_История: `reports/dna_history.jsonl` — 587 записей_
