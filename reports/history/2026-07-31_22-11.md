# ENIGMA Session State — 2026-07-31 22:11

Кампания: `Open_road` | Игрок: `sdf`
...
_Сессия: 1.7 мин | Тиков: 1 | LLM-вызовов: 0_
...
_История: `reports/dna_history.jsonl` — 893 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.813 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | talk | 0.341 | ❌ | x=17.2 y=4.0 | ❌ |
| maid_lusya | idle | 0.000 | ❌ | x=15.1 y=2.7 | ❌ |
| merchant_goran | request_service | 0.712 | ❌ | x=6.5 y=5.5 | ❌ |
| player | seek_ally | 0.312 | ❌ | None | ❌ |
| tavern_keeper_tornin | talk | 0.320 | ❌ | x=9.2 y=3.8 | ❌ |
