# ENIGMA Session State — 2026-05-26 20:38
...
_История: `reports/dna_history.jsonl` — 86 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | APPROACH | 0.455 | ❌ | None | ❌ |
| guard_borko | OBSERVE | 0.661 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 1.660 | ❌ | None | ❌ |
| merchant_goran | OBSERVE | 0.505 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.893 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.603 | ✅ | None | ❌ |
