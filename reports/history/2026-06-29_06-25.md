# ENIGMA Session State — 2026-06-29 06:25
...
| **CVS** (Causal Velocity) | 3.40/мин | → +0.5 | ✅ 3.40/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 625 записей_
...
| guard_borko | spread_rumor | 0.310 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | offer_job | 0.270 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | request_service | 0.413 | ❌ | x=9.0 y=9.0 | ❌ |
| tavern_keeper_tornin | seek_ally | 0.281 | ❌ | x=4.5 y=2.5 | ❌ |
| thief_shadow | request_service | 0.378 | ❌ | x=11.5 y=9.5 | ❌ |
