# ENIGMA Session State — 2026-06-05 01:33
...
| **CVS** (Causal Velocity) | 3.09/мин | ↓ -1.0 | ✅ 3.09/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 17% | ↑ -33.3% | ⚠️ 1 пред-шинных отказов — CDS слеп к части крахов |

_История: `reports/dna_history.jsonl` — 339 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ATTACK | 1.516 | ✅ | None | ❌ |
| guard_borko | FLEE | 0.732 | ✅ | x=8.0 y=12.0 | ❌ |
| maid_lusya | FLEE | 0.931 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.743 | ✅ | x=18.0 y=4.7 | ❌ |
| tavern_keeper_tornin | ATTACK | 0.900 | ✅ | x=4.0 y=2.5 | ❌ |
| thief_shadow | ATTACK | 0.617 | ✅ | None | ❌ |
