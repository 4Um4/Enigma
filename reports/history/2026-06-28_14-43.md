# ENIGMA Session State — 2026-06-28 14:43
...
| **CVS** (Causal Velocity) | 2.92/мин | → +0.4 | ✅ 2.92/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 623 записей_
...
| maid_lusya | request_service | 0.256 | ❌ | x=4.5 y=5.0 | ❌ |
