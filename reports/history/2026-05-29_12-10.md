# ENIGMA Session State — 2026-05-29 12:10
...
_История: `reports/dna_history.jsonl` — 168 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.131 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.218 | ❌ | x=13.7 y=2.3 | ❌ |
| maid_lusya | FLEE | 1.781 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.083 | ❌ | x=13.7 y=1.6 | ❌ |
| tavern_keeper_tornin | FLEE | 1.175 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.961 | ❌ узел не найден | None | ❌ |
