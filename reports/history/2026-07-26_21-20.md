# ENIGMA Session State — 2026-07-26 21:20

Кампания: `Open_road` | Игрок: `Чокер`
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -37.8 | LLM не вызывалась: сессия без действий игрока |
...
_История: `reports/dna_history.jsonl` — 819 записей_
