# ENIGMA Session State — 2026-05-29 15:21
...
| **NPI** (NPC Pipeline) | 0% | ↓ -33.3% | нет данных о NPC |
| **OBI** (Obedience) | 0% | → +0.0% | нет директив в сессии — OBI не применим |
| **SCF** (Spatial Coherence) | 1.0 | ↑ +0.7 | ✅ пространство целостно: граф загружен корректно |
...
_История: `reports/dna_history.jsonl` — 174 записей_
