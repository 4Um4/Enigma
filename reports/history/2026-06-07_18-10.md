# ENIGMA Session State — 2026-06-07 18:10
...
| **NPI** (NPC Pipeline) | 0% | → +0.0% | ⛔ 0/2 NPC имеют координаты: traversal полностью сломан |
...
_История: `reports/dna_history.jsonl` — 403 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| guard_borko | ? | 0.000 | ❌ узел не найден | None | ❌ |
