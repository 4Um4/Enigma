# ENIGMA Session State — 2026-05-30 09:44
...
_История: `reports/dna_history.jsonl` — 216 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.337 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.346 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 1.750 | ❌ узел не найден | None | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.277 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.279 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 0.377 | ❌ узел не найден | None | ❌ |
