# ENIGMA Session State — 2026-06-09 03:01
...
_История: `reports/dna_history.jsonl` — 445 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ATTACK | 0.624 | ❌ | None | ❌ |
| guard_borko | ATTACK | 0.769 | ❌ | None | ❌ |
| maid_lusya | FLEE | 1.218 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.472 | ✅ | x=4.0 y=2.5 | ❌ |
| tavern_keeper_tornin | ATTACK | 0.858 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.763 | ✅ | None | ❌ |
