# ENIGMA Session State — 2026-07-26 20:08
...
| **CVS** (Causal Velocity) | 20.47/мин | ↑ +15.6 | ✅ 20.47/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 804 записей_
...
**Tick Pipeline:**
Тиков: 1 | Decisions > 0: 2/1 | LLM: 12 вызовов / 14 ответов | Симуляция: ✅ живёт
