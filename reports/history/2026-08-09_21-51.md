# ENIGMA Session State — 2026-08-09 21:51
...
_Сессия: 1.1 мин | Тиков: 61 | LLM-вызовов: 72_
...
| **CVS** (Causal Velocity) | 66.58/мин | ↑ +54.9 | ✅ 66.58/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 384 (idx=6.30) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 365 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1007 записей_
...
**Tick Pipeline:**
Тиков: 61 | Decisions > 0: 2/61 | LLM: 72 вызовов / 72 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.981 | ❌ | x=5.5 y=6.0 | ❌ |
| guard_borko | ambush | 0.240 | ❌ | None | ❌ |
| maid_lusya | call_for_help | 0.180 | ❌ | x=12.0 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.649 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | seek_ally | 0.210 | ❌ | x=12.0 y=3.0 | ❌ |
