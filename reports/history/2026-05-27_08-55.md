# ENIGMA Session State — 2026-05-27 08:55
...
_История: `reports/dna_history.jsonl` — 95 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.595 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.954 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 2.264 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.891 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.126 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.761 | ✅ | None | ❌ |
