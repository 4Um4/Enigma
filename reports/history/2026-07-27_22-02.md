# ENIGMA Session State — 2026-07-27 22:02
...
_Сессия: 3.2 мин | Тиков: 4 | LLM-вызовов: 48_
...
| **CVS** (Causal Velocity) | 14.95/мин | ↑ +14.9 | ✅ 14.95/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 858 записей_
...
**Tick Pipeline:**
Тиков: 4 | Decisions > 0: 1/4 | LLM: 48 вызовов / 48 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.665 | ❌ | x=6.3 y=5.3 | ❌ |
| guard_borko | idle | 0.239 | ❌ | x=10.9 y=7.0 | ❌ |
| maid_lusya | idle | 0.000 | ❌ | x=6.5 y=5.7 | ❌ |
| merchant_goran | idle | 0.000 | ❌ | x=1.6 y=5.5 | ❌ |
| player | idle | 0.188 | ❌ | None | ❌ |
| tavern_keeper_tornin | observe | 0.170 | ❌ | x=2.8 y=5.5 | ❌ |
| thief_shadow | observe | 0.245 | ❌ | x=6.0 y=5.3 | ❌ |
