# ENIGMA Session State — 2026-05-30 11:05
...
_История: `reports/dna_history.jsonl` — 226 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.334 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.600 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.411 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.429 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.556 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.101 | ❌ узел не найден | None | ❌ |
