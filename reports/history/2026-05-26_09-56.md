# ENIGMA Session State — 2026-05-26 09:56
...
_История: `reports/dna_history.jsonl` — 84 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | WARN | 0.576 | ❌ | None | ❌ |
| guard_borko | WARN | 0.692 | ❌ узел не найден | None | ❌ |
| maid_lusya | FLEE | 2.189 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.548 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.991 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.605 | ✅ | None | ❌ |
