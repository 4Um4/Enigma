# ENIGMA Session State — 2026-05-29 23:05
...
_История: `reports/dna_history.jsonl` — 206 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.357 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.536 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.348 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.357 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.494 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.026 | ❌ узел не найден | None | ❌ |
