# ENIGMA Session State — 2026-05-24 18:33
...
_История: `reports/dna_history.jsonl` — 60 записей_
...
- NPC без координат (lerp не работает, 5):
  ...
  - `tavern_keeper_tornin` (intent=HELP)
...
| guard_borko | TALK | 0.503 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 1.174 | ✅ | None | ❌ |
| merchant_goran | APPROACH | 0.567 | ✅ | None | ❌ |
| tavern_keeper_tornin | HELP | 0.433 | ✅ | None | ❌ |
| thief_shadow | FLEE | 1.255 | ✅ | x=16.0 y=4.0 | ❌ |
