# ENIGMA Session State — 2026-06-09 00:34
...
| **NPI** (NPC Pipeline) | 67% | ↑ +33.4% | ⚠️ 2/3 NPC с координатами: есть потери в traversal |
...
_История: `reports/dna_history.jsonl` — 426 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| guard_borko | ? | 0.000 | ❌ | x=9.3 y=3.1 | ❌ |
| merchant_goran | ? | 0.000 | ❌ | x=18.3 y=2.5 | ❌ |
