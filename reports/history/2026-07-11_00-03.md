# ENIGMA Session State — 2026-07-11 00:03
...
| **PFI** (Pre-Bus Failure) | 0% | ↑ -900.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

**Системные сигналы (требуют внимания):**
- NPI упал на -100%: spatial pipeline деградировал между сессиями

_История: `reports/dna_history.jsonl` — 684 записей_
