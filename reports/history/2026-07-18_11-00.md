# ENIGMA Session State — 2026-07-18 11:00
...
| **NPI** (NPC Pipeline) | 83% | ↑ +11.9% | ⚠️ 5/6 NPC с координатами: есть потери в traversal |
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -4.0 | LLM не вызывалась: сессия без действий игрока |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 744 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.472 | ❌ | x=10.5 y=5.0 | ❌ |
| guard_borko | ambush | 0.259 | ❌ | None | ❌ |
| maid_lusya | idle | 0.232 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | offer_job | 0.317 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | idle | 0.217 | ❌ | x=4.6 y=3.5 | ❌ |
