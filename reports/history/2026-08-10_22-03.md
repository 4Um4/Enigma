# ENIGMA Session State — 2026-08-10 22:03
...
_Сессия: 1.9 мин | Тиков: 68 | LLM-вызовов: 134_
...
| **CVS** (Causal Velocity) | 70.62/мин | ↑ +39.3 | ✅ 70.62/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 544 (idx=8.00) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 408 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1008 записей_
...
**Tick Pipeline:**
Тиков: 68 | Decisions > 0: 3/68 | LLM: 134 вызовов / 134 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.925 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | ambush | 0.239 | ✅ | x=19.0 y=4.5 | ❌ |
| maid_lusya | flee | 0.228 | ✅ | x=6.5 y=5.5 | ❌ |
| merchant_goran | request_service | 0.686 | ✅ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.187 | ✅ | x=10.5 y=6.5 | ❌ |
| thief_shadow | trade | 0.157 | ✅ | None | ❌ |
