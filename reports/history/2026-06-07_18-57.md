# ENIGMA Session State — 2026-06-07 18:57
...
_История: `reports/dna_history.jsonl` — 405 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.450 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.370 | ❌ узел не найден | None | ❌ |
| maid_lusya | REQUEST_SERVICE | 0.257 | ❌ | None | ❌ |
| merchant_goran | OFFER_JOB | 0.406 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | SPREAD_RUMOR | 0.256 | ❌ | None | ❌ |
| thief_shadow | OFFER_JOB | 0.415 | ❌ | None | ❌ |
