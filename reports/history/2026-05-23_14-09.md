# ENIGMA Session State — 2026-05-23 14:09
...
_История: `reports/dna_history.jsonl` — 45 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.258 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.354 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 0.547 | ✅ | None | ❌ |
| merchant_goran | CHANGE_ROLE | 0.229 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 0.269 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.327 | ✅ | x=8.0 y=7.0 | ❌ |
