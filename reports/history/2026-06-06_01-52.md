# ENIGMA Session State — 2026-06-06 01:52
...
_Сессия: 2.0 мин | Тиков: 7 | LLM-вызовов: 6_
...
| **CVS** (Causal Velocity) | 3.07/мин | ↑ +3.1 | ✅ 3.07/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 86% | ↓ +85.7% | ⛔ 6 пред-шинных отказов — pipeline молча умирает, CDS слеп |

**Системные сигналы (требуют внимания):**
- SCF упал с 1.0 до 0.0: spatial fallback + node_not_found = регрессия spatial слоя

_История: `reports/dna_history.jsonl` — 372 записей_
...
**Tick Pipeline:**
Тиков: 7 | Decisions > 0: 4/7 | LLM: 6 вызовов / 6 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OBSERVE | 0.525 | ❌ | None | ❌ |
| guard_borko | WARN | 0.421 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 0.691 | ❌ | None | ❌ |
| merchant_goran | OBSERVE | 0.549 | ❌ узел не найден | None | ❌ |
| player | ? | 0.000 | ✅ | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.561 | ✅ | None | ❌ |
| thief_shadow | OBSERVE | 0.556 | ❌ | None | ❌ |

**NPC с разрывом в pipeline (intent есть, traversal нет):**
  - `guard_borko`: intent=WARN, traversal=❌, coords=None
