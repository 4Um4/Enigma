# ENIGMA Session State — 2026-06-03 11:58
...
| **NPI** (NPC Pipeline) | 67% | → +0.0% | ⚠️ 4/6 NPC с координатами: есть потери в traversal |
...
_История: `reports/dna_history.jsonl` — 319 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | REQUEST_SERVICE | 0.334 | ❌ | None | ❌ |
| guard_borko | AMBUSH | 0.248 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.344 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | CHANGE_ROLE | 0.278 | ❌ | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.162 | ❌ узел не найден | x=4.5 y=2.5 | ❌ |
| thief_shadow | OFFER_JOB | 0.212 | ❌ | None | ❌ |
