# ENIGMA Session State — 2026-05-29 19:13
...
_История: `reports/dna_history.jsonl` — 188 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.296 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.451 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.435 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.358 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.436 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.999 | ❌ узел не найден | None | ❌ |
