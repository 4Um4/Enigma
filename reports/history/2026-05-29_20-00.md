# ENIGMA Session State — 2026-05-29 20:00
...
_История: `reports/dna_history.jsonl` — 196 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.188 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.402 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.347 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.423 | ❌ | x=14.0 y=2.0 | ❌ |
