# ENIGMA Session State — 2026-08-08 20:34
...
_Сессия: 0.7 мин | Тиков: 63 | LLM-вызовов: 58_
...
| **CVS** (Causal Velocity) | 81.98/мин | ↓ -6.0 | ✅ 81.98/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 367 (idx=5.83) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 372 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 951 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.825 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | talk | 0.224 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | call_for_help | 0.178 | ❌ | x=10.5 y=3.0 | ❌ |
| merchant_goran | offer_job | 0.670 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.268 | ❌ | x=10.5 y=6.5 | ❌ |
