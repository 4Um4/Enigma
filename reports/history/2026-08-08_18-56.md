# ENIGMA Session State — 2026-08-08 18:56
...
_Сессия: 0.6 мин | Тиков: 19 | LLM-вызовов: 20_
...
| **CVS** (Causal Velocity) | 32.77/мин | ↑ +22.6 | ✅ 32.77/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 105 (idx=5.53) | → | ✅ Убеждения формируются |
...
_История: `reports/dna_history.jsonl` — 940 записей_
...
**Tick Pipeline:**
Тиков: 19 | Decisions > 0: 1/19 | LLM: 20 вызовов / 20 ответов | Симуляция: ✅ живёт
