# ENIGMA Session State — 2026-05-29 17:58
...
_История: `reports/dna_history.jsonl` — 182 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.330 | ❌ | None | ❌ |
| guard_borko | BLOCK_PATH | 0.273 | ❌ | x=2.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 0.466 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.358 | ❌ | x=2.0 y=2.0 | ❌ |
