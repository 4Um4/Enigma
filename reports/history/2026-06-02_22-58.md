# ENIGMA Session State — 2026-06-02 22:58
...
_История: `reports/dna_history.jsonl` — 301 записей_
...
- NPC с известными координатами (5):
  ...
  - `blacksmith_orm`: x=6.2 y=9.9
  - `guard_borko`: x=8.0 y=7.0
  - `merchant_goran`: x=7.0 y=8.6
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.821 | ❌ | x=6.2 y=9.9 | ❌ |
| guard_borko | FLEE | 0.901 | ❌ | x=8.0 y=7.0 | ❌ |
| maid_lusya | FLEE | 1.046 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | OBSERVE | 0.823 | ❌ | x=7.0 y=8.6 | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.745 | ❌ узел не найден | x=8.0 y=7.0 | ❌ |
| thief_shadow | OBSERVE | 1.093 | ✅ | None | ❌ |
