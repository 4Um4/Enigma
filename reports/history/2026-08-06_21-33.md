# ENIGMA Session State — 2026-08-06 21:33
...
_Сессия: 1.6 мин | Тиков: 0 | LLM-вызовов: 182_
...
| **CVS** (Causal Velocity) | 113.07/мин | ↑ +77.2 | ✅ 113.07/мин: активная сессия |
...
| **BCI** (Belief Crystallization) | 385 (idx=0.00) | → | ⚠️ Память не кристаллизуется (BCI=0) |
| **BPI** (Break Progress) | 368 (broken=0) | → | ⚠️ NPC не ломаются (BPI=0) |
| **NEI** (Need Urgency) | 0 (critical=0) | → | ⚠️ NPC слишком комфортны (NEI=0) |
| **DRI** (Response Integrity) | 100% | ↑ +22.9% | ✅ LLM отвечает на все запросы |
...
_История: `reports/dna_history.jsonl` — 920 записей_
...
**Tick Pipeline:**
Тиков: 0 | Decisions > 0: 1/0 | LLM: 182 вызовов / 182 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.694 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | block_path | 0.214 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | flee | 0.217 | ❌ | x=10.5 y=6.5 | ❌ |
| merchant_goran | offer_job | 0.629 | ❌ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.208 | ❌ | None | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.221 | ❌ | x=10.5 y=3.0 | ❌ |
