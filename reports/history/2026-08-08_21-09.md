# ENIGMA Session State — 2026-08-08 21:09
...
_Сессия: 0.7 мин | Тиков: 63 | LLM-вызовов: 62_
...
**Tick Pipeline:**
Тиков: 63 | Decisions > 0: 1/63 | LLM: 62 вызовов / 62 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.684 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | spread_rumor | 0.229 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | observe | 0.242 | ❌ | x=10.5 y=4.8 | ❌ |
| merchant_goran | offer_job | 0.589 | ❌ | x=6.5 y=5.5 | ❌ |
| tavern_keeper_tornin | call_for_help | 0.281 | ❌ | x=10.5 y=3.0 | ❌ |
