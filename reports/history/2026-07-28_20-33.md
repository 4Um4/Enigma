# ENIGMA Session State — 2026-07-28 20:33
...
_История: `reports/dna_history.jsonl` — 869 записей_
...
**Tick Pipeline:**
Тиков: 0 | Decisions > 0: 1/0 | LLM: 2 вызовов / 4 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.760 | ❌ | x=9.0 y=3.7 | ❌ |
| guard_borko | observe | 0.240 | ❌ | x=10.9 y=5.2 | ❌ |
| maid_lusya | flee | 0.268 | ❌ | x=10.5 y=6.7 | ❌ |
| merchant_goran | observe | 0.224 | ❌ | x=3.9 y=6.0 | ❌ |
| tavern_keeper_tornin | idle | 0.184 | ❌ | x=11.1 y=6.0 | ❌ |
| thief_shadow | observe | 0.205 | ❌ | x=10.1 y=4.6 | ❌ |
