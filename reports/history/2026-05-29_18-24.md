# ENIGMA Session State — 2026-05-29 18:24
...
_История: `reports/dna_history.jsonl` — 186 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.181 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.538 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.460 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.366 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.540 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.115 | ❌ узел не найден | None | ❌ |
