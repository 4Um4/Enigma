# ENIGMA Session State — 2026-07-28 19:52

Кампания: `Open_road` | Игрок: `ывп`
...
_Сессия: 1.6 мин | Тиков: 0 | LLM-вызовов: 2_
...
| **CVS** (Causal Velocity) | 1.27/мин | ↑ +1.3 | ✅ 1.27/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 866 записей_
...
- NPC с известными координатами (6):
  ...
  - `thief_shadow`: x=11.8 y=3.7
  - `tavern_keeper_tornin`: x=14.6 y=2.5
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.765 | ❌ | x=6.3 y=5.3 | ❌ |
| guard_borko | idle | 0.250 | ❌ | x=10.9 y=3.5 | ❌ |
| maid_lusya | observe | 0.216 | ❌ | x=10.5 y=4.9 | ❌ |
| merchant_goran | request_service | 0.166 | ❌ | x=5.9 y=5.0 | ❌ |
| tavern_keeper_tornin | flee | 0.197 | ❌ | x=14.6 y=2.5 | ❌ |
| thief_shadow | idle | 0.192 | ❌ | x=11.8 y=3.7 | ❌ |
