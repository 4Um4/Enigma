# ENIGMA Session State — 2026-05-30 18:23
...
_Сессия: 3.3 мин | Тиков: 10 | LLM-вызовов: 12_
...
| **CVS** (Causal Velocity) | 3.61/мин | ↓ -2.2 | ✅ 3.61/мин: активная сессия |
...
_История: `reports/dna_history.jsonl` — 238 записей_
...
**Tick Pipeline:**
Тиков: 10 | Decisions > 0: 0/10 | LLM: 12 вызовов / 12 ответов | Симуляция: ❌ МЕРТВА
- LLM "Ничего не произошло": 6 раз
...
**Предупреждения:**
  ...
  - ⚠️ LLM возвращает 'Ничего не произошло' 6 раз подряд

**Movement Pipeline (по NPC):**
| NPC | Intent | Score | Traversal | Координаты | Виден игроку |
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | OFFER_JOB | 0.464 | ✅ | None | ❌ |
| guard_borko | FLEE | 0.463 | ✅ | None | ❌ |
| maid_lusya | FLEE | 1.396 | ✅ | None | ❌ |
| merchant_goran | FLEE | 0.438 | ✅ | x=8.0 y=7.0 | ❌ |
| tavern_keeper_tornin | FLEE | 0.349 | ✅ | None | ❌ |
| thief_shadow | FLEE | 0.636 | ✅ | None | ❌ |
