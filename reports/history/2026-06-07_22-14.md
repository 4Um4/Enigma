# ENIGMA Session State — 2026-06-07 22:14
...
_История: `reports/dna_history.jsonl` — 414 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.309 | ✅ | None | ❌ |
| guard_borko | REPORT | 0.428 | ❌ | x=5.7 y=7.9 | ❌ |
| maid_lusya | FLEE | 0.486 | ✅ | None | ❌ |
| merchant_goran | APPROACH | 0.399 | ✅ | x=6.4 y=13.7 | ❌ |
| tavern_keeper_tornin | FLEE | 0.425 | ❌ | None | ❌ |
| thief_shadow | FLEE | 0.433 | ✅ | None | ❌ |
