# ENIGMA Session State — 2026-06-03 00:59
...
_История: `reports/dna_history.jsonl` — 317 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.299 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.278 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 0.314 | ❌ узел не найден | x=4.5 y=5.0 | ❌ |
| merchant_goran | REQUEST_SERVICE | 0.260 | ❌ | x=14.5 y=5.5 | ❌ |
| tavern_keeper_tornin | FLEE | 0.182 | ❌ узел не найден | x=4.5 y=2.5 | ❌ |
| thief_shadow | REQUEST_SERVICE | 0.293 | ❌ | None | ❌ |
