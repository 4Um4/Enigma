# ENIGMA Session State — 2026-06-03 20:44
...
_История: `reports/dna_history.jsonl` — 323 записей_
...
- NPC с известными координатами (3):
  - `tavern_keeper_tornin`: x=19.2 y=4.7
  - `guard_borko`: x=18.9 y=4.1
  - `merchant_goran`: x=18.5 y=3.6
...
- Узлы не найдены (NPC не могут добраться до цели): 8
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | ATTACK | 1.002 | ❌ | None | ❌ |
| guard_borko | ATTACK | 1.385 | ❌ | x=18.9 y=4.1 | ❌ |
| maid_lusya | OBSERVE | 1.411 | ✅ | None | ❌ |
| merchant_goran | OBSERVE | 1.340 | ❌ | x=18.5 y=3.6 | ❌ |
| tavern_keeper_tornin | ATTACK | 1.430 | ❌ узел не найден | x=19.2 y=4.7 | ❌ |
| thief_shadow | OBSERVE | 1.270 | ❌ узел не найден | None | ❌ |
