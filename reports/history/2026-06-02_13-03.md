# ENIGMA Session State — 2026-06-02 13:03
...
_История: `reports/dna_history.jsonl` — 285 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.293 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.708 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 0.929 | ❌ | None | ❌ |
| merchant_goran | OBSERVE | 0.597 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | OBSERVE | 0.775 | ❌ | None | ❌ |
| thief_shadow | FLEE | 1.014 | ✅ | None | ❌ |
