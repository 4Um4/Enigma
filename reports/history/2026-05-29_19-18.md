# ENIGMA Session State — 2026-05-29 19:18
...
_История: `reports/dna_history.jsonl` — 190 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.218 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.413 | ❌ | x=14.0 y=2.0 | ❌ |
| maid_lusya | FLEE | 2.366 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.397 | ❌ | x=14.0 y=2.0 | ❌ |
| tavern_keeper_tornin | FLEE | 1.533 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 2.158 | ❌ узел не найден | None | ❌ |
