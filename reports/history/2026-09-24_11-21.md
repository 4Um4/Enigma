# ENIGMA Session State — 2026-09-24 11:21
...
_Сессия: 1.7 мин | Тиков: 89 | LLM-вызовов: 36_
...
| **CVS** (Causal Velocity) | 21.33/мин | ↓ -9.1 | ✅ 21.33/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 459 (idx=5.16) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 623 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1182 записей_
...
**Tick Pipeline:**
Тиков: 89 | Decisions > 0: 4/89 | LLM: 36 вызовов / 38 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.320 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | block_path | 0.643 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.345 | ✅ | x=10.5 y=4.8 | ❌ |
| merchant_goran | flee | 0.931 | ✅ | x=10.5 y=3.0 | ❌ |
| player | trade | 0.666 | ⏸ | None | ❌ |
| tavern_keeper_tornin | talk | 1.396 | ✅ | x=16.7 y=2.4 | ❌ |
| thief_shadow | observe | 0.732 | ✅ | x=11.5 y=11.0 | ❌ |
