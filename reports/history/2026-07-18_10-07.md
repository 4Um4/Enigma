# ENIGMA Session State — 2026-07-18 10:07
...
_История: `reports/dna_history.jsonl` — 743 записей_
...
- NPC с известными координатами (6):
  - `merchant_goran`: x=9.6 y=11.9
  - `guard_borko`: x=4.5 y=3.0
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | change_role | 0.504 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | observe | 0.212 | ❌ | x=4.5 y=3.0 | ❌ |
| maid_lusya | call_for_help | 0.153 | ❌ | x=18.0 y=7.4 | ❌ |
| merchant_goran | idle | 0.000 | ❌ | x=9.6 y=11.9 | ❌ |
| player | seek_ally | 0.324 | ❌ | None | ❌ |
| tavern_keeper_tornin | flee | 0.223 | ❌ | x=4.6 y=2.0 | ❌ |
| thief_shadow | request_service | 0.278 | ❌ | x=11.6 y=9.8 | ❌ |
