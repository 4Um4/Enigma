# ENIGMA Session State — 2026-07-20 21:10
...
_Сессия: 1.3 мин | Тиков: 2 | LLM-вызовов: 34_
...
| **CVS** (Causal Velocity) | 25.94/мин | ↑ +1.3 | ✅ 25.94/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 763 записей_
...
**Tick Pipeline:**
Тиков: 2 | Decisions > 0: 3/2 | LLM: 34 вызовов / 36 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.712 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | ambush | 0.246 | ❌ | x=12.4 y=10.4 | ❌ |
| maid_lusya | observe | 0.251 | ❌ | x=8.0 y=7.2 | ❌ |
| merchant_goran | idle | 0.201 | ❌ | x=11.4 y=6.5 | ❌ |
| player | offer_job | 0.325 | ❌ | None | ❌ |
| tavern_keeper_tornin | observe | 0.201 | ❌ | x=4.6 y=2.0 | ❌ |
| thief_shadow | request_service | 0.272 | ❌ | x=7.5 y=6.8 | ❌ |
