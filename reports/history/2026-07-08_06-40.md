# ENIGMA Session State — 2026-07-08 06:40
...
| **CVS** (Causal Velocity) | 2.25/мин | ↓ -0.7 | ✅ 2.25/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

_История: `reports/dna_history.jsonl` — 672 записей_
...
| guard_borko | spread_rumor | 0.266 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | change_role | 0.311 | ❌ | x=4.5 y=5.0 | ❌ |
| merchant_goran | change_role | 0.282 | ❌ | x=9.0 y=9.0 | ❌ |
| player | block_path | 0.280 | ❌ | None | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.182 | ❌ | x=4.5 y=2.5 | ❌ |
| thief_shadow | offer_job | 0.338 | ❌ | x=11.5 y=9.5 | ❌ |
