# ENIGMA Session State — 2026-05-27 23:27
...
| **SCF** (Spatial Coherence) | 0.0 | → -0.3 | ⛔ РАЗРУШЕНО: узлы не найдены → NPC не могут двигаться |
...
_История: `reports/dna_history.jsonl` — 113 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 0.848 | ❌ | None | ❌ |
| guard_borko | FLEE | 0.897 | ❌ | x=12.0 y=9.0 | ❌ |
| maid_lusya | FLEE | 1.771 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 0.789 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.062 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.750 | ❌ узел не найден | None | ❌ |
