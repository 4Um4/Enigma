# ENIGMA Session State — 2026-09-24 02:00
...
_Сессия: 1.9 мин | Тиков: 62 | LLM-вызовов: 32_
...
| **CVS** (Causal Velocity) | 17.25/мин | ↑ +17.2 | ✅ 17.25/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 315 (idx=5.08) | → | ✅ Убеждения формируются |
| **BPI** (Break Progress) | 427 (broken=0) | → | ✅ Давление доходит |
...
_История: `reports/dna_history.jsonl` — 1181 записей_
...
**Tick Pipeline:**
Тиков: 62 | Decisions > 0: 3/62 | LLM: 32 вызовов / 34 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 1.147 | ✅ | x=6.5 y=5.5 | ❌ |
| guard_borko | block_path | 0.574 | ✅ | x=16.7 y=3.8 | ❌ |
| maid_lusya | flee | 1.361 | ✅ | x=10.5 y=6.5 | ❌ |
| merchant_goran | offer_job | 0.584 | ✅ | x=6.5 y=5.5 | ❌ |
| player | flee | 0.691 | ⏸ | None | ❌ |
| tavern_keeper_tornin | talk | 1.184 | ✅ | x=16.7 y=2.4 | ❌ |
| thief_shadow | observe | 0.660 | ✅ | x=11.5 y=11.0 | ❌ |
