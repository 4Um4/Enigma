# ENIGMA Session State — 2026-07-26 20:46
...
| **PFI** (Pre-Bus Failure) | 0% | ↑ -300.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |

**Системные сигналы (требуют внимания):**
- NPI упал на -100%: spatial pipeline деградировал между сессиями

_История: `reports/dna_history.jsonl` — 811 записей_
