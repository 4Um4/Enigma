# ENIGMA Session State — 2026-06-06 22:29
...
_История: `reports/dna_history.jsonl` — 378 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | APPROACH | 0.243 | ✅ | None | ❌ |
| guard_borko | WARN | 0.501 | ❌ узел не найден | None | ❌ |
| maid_lusya | OBSERVE | 0.633 | ❌ | None | ❌ |
| merchant_goran | OBSERVE | 0.291 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | REPORT | 0.234 | ❌ | None | ❌ |
| thief_shadow | OBSERVE | 0.461 | ❌ | None | ❌ |
