# ENIGMA Session State — 2026-05-31 23:21
...
_История: `reports/dna_history.jsonl` — 252 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.465 | ✅ | None | ❌ |
| guard_borko | FLEE | 1.696 | ✅ | None | ❌ |
| maid_lusya | FLEE | 2.465 | ✅ | None | ❌ |
| merchant_goran | FLEE | 1.606 | ✅ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.493 | ✅ | None | ❌ |
| thief_shadow | FLEE | 2.109 | ✅ | None | ❌ |
