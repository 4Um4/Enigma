# ENIGMA Session State — 2026-06-05 23:43
...
| **PFI** (Pre-Bus Failure) | 33% | ↓ +16.7% | ⛔ 1 пред-шинных отказов — pipeline молча умирает, CDS слеп |

_История: `reports/dna_history.jsonl` — 367 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | CHANGE_ROLE | 0.463 | ❌ | None | ❌ |
| guard_borko | SPREAD_RUMOR | 0.342 | ❌ узел не найден | None | ❌ |
| maid_lusya | CHANGE_ROLE | 0.280 | ❌ | None | ❌ |
| merchant_goran | OFFER_JOB | 0.450 | ❌ узел не найден | None | ❌ |
| tavern_keeper_tornin | WARN | 0.197 | ❌ | None | ❌ |
| thief_shadow | CHANGE_ROLE | 0.439 | ❌ | None | ❌ |
