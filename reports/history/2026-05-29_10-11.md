# ENIGMA Session State — 2026-05-29 10:11
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -1.3 | LLM не вызывалась: сессия без действий игрока |

_История: `reports/dna_history.jsonl` — 151 записей_
...
- NPC с известными координатами (2):
  - `guard_borko`: x=14.3 y=1.7
  - `merchant_goran`: x=14.2 y=1.7
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.058 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.158 | ❌ | x=14.3 y=1.7 | ❌ |
| maid_lusya | FLEE | 1.757 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.009 | ❌ | x=14.2 y=1.7 | ❌ |
| tavern_keeper_tornin | FLEE | 1.114 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.858 | ❌ узел не найден | None | ❌ |
