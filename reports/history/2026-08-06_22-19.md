# ENIGMA Session State — 2026-08-06 22:19
...
| **CVS** (Causal Velocity) | 0.00/мин | ↓ -105.2 | LLM не вызывалась: сессия без действий игрока |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 11 (AttrErr=0, TypeErr=0) | → | ⚠️ КРИТИЧНО: невидимые регрессии (Tracebacks) |
...
_История: `reports/dna_history.jsonl` — 925 записей_
