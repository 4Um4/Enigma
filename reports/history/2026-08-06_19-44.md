# ENIGMA Session State — 2026-08-06 19:44
...
_Сессия: 0.8 мин | Тиков: 2 | LLM-вызовов: 91_
...
| **CVS** (Causal Velocity) | 113.02/мин | ↑ +17.1 | ✅ 113.02/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **DRI** (Response Integrity) | 91% | ↓ -8.8% | ✅ LLM отвечает на все запросы |
| **DPI** (Dialogue Pipeline) | 100% | → +0.0% | ✅ Конвейер диалогов стабилен |

_История: `reports/dna_history.jsonl` — 916 записей_
...
**Tick Pipeline:**
Тиков: 2 | Decisions > 0: 3/2 | LLM: 91 вызовов / 80 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.800 | ❌ | x=6.5 y=5.5 | ❌ |
| guard_borko | block_path | 0.265 | ❌ | x=19.0 y=4.5 | ❌ |
| maid_lusya | flee | 0.217 | ❌ | x=10.5 y=6.5 | ❌ |
| merchant_goran | request_service | 0.672 | ❌ | x=6.5 y=5.5 | ❌ |
| player | observe | 0.221 | ❌ | None | ❌ |
| tavern_keeper_tornin | call_for_help | 0.225 | ❌ | x=7.8 y=5.8 | ❌ |
