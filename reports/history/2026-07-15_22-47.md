# ENIGMA Session State — 2026-07-15 22:47
...
_История: `reports/dna_history.jsonl` — 702 записей_
...
- NPC без координат (lerp не работает, 1):
  - `guard_borko` (intent=call_for_help)
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | request_service | 0.850 | ❌ | x=11.8 y=9.8 | ❌ |
| guard_borko | call_for_help | 0.234 | ❌ | None | ❌ |
| maid_lusya | call_for_help | 0.262 | ❌ | x=4.0 y=4.2 | ❌ |
| merchant_goran | request_service | 0.421 | ❌ | x=11.4 y=9.6 | ❌ |
| tavern_keeper_tornin | spread_rumor | 0.250 | ❌ | x=4.6 y=3.5 | ❌ |
| thief_shadow | change_role | 0.306 | ❌ | x=11.6 y=9.8 | ❌ |

**NPC с разрывом в pipeline (intent есть, traversal нет):**
  - `guard_borko`: intent=call_for_help, traversal=❌, coords=None
