# ENIGMA Session State — 2026-09-17 10:52
...
_Сессия: 0.7 мин | Тиков: 105 | LLM-вызовов: 10_
...
| **CVS** (Causal Velocity) | 14.23/мин | ↓ -3.7 | ✅ 14.23/мин: активная сессия |
| **PFI** (Pre-Bus Failure) | 0% | → +0.0% | ✅ норма: пред-шинных отказов нет — CDS видит всё |
| **Tracebacks** | 0 (AttrErr=0, TypeErr=0) | → | ✅ норма |
| **BCI** (Belief Crystallization) | 459 (idx=4.37) | → | ✅ Убеждения формируются |
...
_История: `reports/dna_history.jsonl` — 1122 записей_
...
**Tick Pipeline:**
Тиков: 105 | Decisions > 0: 1/105 | LLM: 10 вызовов / 12 ответов | Симуляция: ✅ живёт
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | talk | 1.016 | ✅ | x=5.5 y=6.0 | ❌ |
| guard_borko | block_path | 0.718 | ✅ | x=35.0 y=7.0 | ❌ |
| maid_lusya | flee | 1.407 | ✅ | x=10.5 y=3.0 | ❌ |
| merchant_goran | flee | 0.861 | ✅ | x=10.5 y=3.0 | ❌ |
| player | talk | 0.829 | ✅ | None | ❌ |
| tavern_keeper_tornin | talk | 1.116 | ✅ | x=10.5 y=6.5 | ❌ |
| thief_shadow | observe | 0.539 | ⏸ | None | ❌ |
