# ENIGMA Session State — 2026-05-29 00:38
...
_История: `reports/dna_history.jsonl` — 136 записей_
...
|-----|--------|-------|-----------|------------|--------------|
| blacksmith_orm | FLEE | 1.044 | ❌ | None | ❌ |
| guard_borko | FLEE | 1.240 | ❌ | None | ❌ |
| maid_lusya | FLEE | 2.320 | ❌ узел не найден | None | ❌ |
| merchant_goran | FLEE | 1.267 | ❌ | None | ❌ |
| tavern_keeper_tornin | FLEE | 1.282 | ❌ узел не найден | None | ❌ |
| thief_shadow | FLEE | 1.969 | ❌ узел не найден | None | ❌ |
