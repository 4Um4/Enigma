...
**Date:** 2026-08-19 19:54:40

## Metrics

- Intent Preservation (Average): 55.0% (Target: >=85%)
  - REVEAL_SECRET: 80.0%
  - FLIRT: 0.0%
  - COMFORT: 60.0%
  - INTIMIDATE: 80.0%
...
| Мне с тобой так хорошо. | FLIRT | build_rapport | None | ('FLIRT', 'build_rapport', 'target', False, False) |
...
| Можно я приглашу тебя на танец? | DIALOGUE | obtain_cooperation | None | ('DIALOGUE', 'obtain_cooperation', 'you', False, False) |
| Ты сводишь меня с ума. | FLIRT | build_rapport | None | ('FLIRT', 'build_rapport', 'NPC', False, False) |
...
| Ты сильная, ты справишься. | DIALOGUE | comfort | None | ('DIALOGUE', 'comfort', 'you', False, False) |
