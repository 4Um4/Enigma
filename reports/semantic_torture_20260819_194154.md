...
**Date:** 2026-08-19 19:41:54

## Metrics

- Intent Preservation (Average): 56.2% (Target: >=85%)
  - REVEAL_SECRET: 80.0%
  - FLIRT: 65.0%
  - COMFORT: 55.0%
  - INTIMIDATE: 25.0%
...
| Не молчи. Скажи мне правду. | DIALOGUE | obtain_information | None | ('DIALOGUE', 'obtain_information', 'target', False, False) |
...
| Phrase | Action | Social Intent | Speech Act | Causal Class |
|--------|--------|---------------|------------|--------------|
| Ты сегодня прекрасно выглядишь. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'target', False, False) |
| Мне нравится твоя улыбка. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'target', False, False) |
| Ты такая красивая, что я теряюсь. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'target', False, False) |
| У тебя потрясающие глаза. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'target', False, False) |
| Я не могу оторвать от тебя взгляд. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'UNDEFINED', False, False) |
| Ты очаровательна. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'target', False, False) |
| Мне с тобой так хорошо. | DIALOGUE | build_rapport | None | ('DIALOGUE', 'build_rapport', 'target', False, False) |
| Ты украла моё сердце. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'NPC', False, False) |
| Я думаю о тебе постоянно. | DIALOGUE | build_rapport | None | ('DIALOGUE', 'build_rapport', '', False, False) |
| Ты — само совершенство. | DIALOGUE | build_rapport | None | ('DIALOGUE', 'build_rapport', 'NPC', False, False) |
| Можно я приглашу тебя на танец? | DIALOGUE | obtain_cooperation | request | ('DIALOGUE', 'obtain_cooperation', 'you', False, False) |
| Ты сводишь меня с ума. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'target', False, False) |
| Я хочу узнать тебя ближе. | DIALOGUE | build_rapport | None | ('DIALOGUE', 'build_rapport', 'you', False, False) |
| Ты такая нежная. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'you', False, False) |
| Мне нравится твой характер. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'character', False, False) |
| Ты такая умная и красивая. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'target', False, False) |
| Я счастлив, что встретил тебя. | DIALOGUE | build_rapport | None | ('DIALOGUE', 'build_rapport', 'UNDEFINED', False, False) |
| Ты мне очень нравишься. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'target', False, False) |
| Давай проведём вечер вместе. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'target', False, False) |
...
| Мне жаль, что тебе так больно. | DIALOGUE | comfort | None | ('DIALOGUE', 'comfort', 'UNDEFINED', False, False) |
...
| Ты заслуживаешь лучшего. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'target', False, False) |
| Я всегда выслушаю тебя. | DIALOGUE | build_rapport | None | ('DIALOGUE', 'build_rapport', 'UNDEFINED', False, False) |
| Ты можешь опереться на моё плечо. | GIVE | build_rapport | None | ('GIVE', 'build_rapport', 'my shoulder', False, False) |
...
| Ты пожалеешь, если не замолчишь. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', 'you', False, False) |
| Я тебя уничтожу. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', 'you', False, False) |
| Ты у меня попляшешь. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', 'you', False, False) |
| Не зли меня, иначе будет хуже. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', '', False, False) |
| Я знаю, где ты живёшь. | DIALOGUE | obtain_information | None | ('DIALOGUE', 'obtain_information', 'UNDEFINED', True, False) |
| Твои дни сочтены. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', 'you', False, False) |
| Ты пожалеешь о сказанном. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', 'you', False, False) |
| Я могу сделать так, что ты исчезнешь. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', 'you', True, False) |
| Не испытывай моё терпение. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', 'player', False, False) |
| Ты играешь с огнём. | FLIRT | flirt | None | ('FLIRT', 'flirt', '对方', False, False) |
| Я тебя сломаю. | ATTACK | intimidate | None | ('ATTACK', 'intimidate', 'you', False, False) |
| Ты ничего не значишь. | DIALOGUE | neutral | None | ('DIALOGUE', 'neutral', 'target', False, False) |
| Ты жалкий червяк. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', 'you', False, False) |
| Я размажу тебя по стенке. | ATTACK | intimidate | None | ('ATTACK', 'intimidate', 'you', False, False) |
| Ты труп. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', 'you', False, False) |
| Я выпью твою кровь. | ATTACK | intimidate | None | ('ATTACK', 'intimidate', 'you', True, False) |
| Ты не жилец здесь. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', 'you', False, False) |
| Я избавлю мир от тебя. | ATTACK | intimidate | None | ('ATTACK', 'intimidate', 'world', True, False) |
| Ты пожалеешь, что родился. | THREATEN | obtain_compliance | None | ('THREATEN', 'obtain_compliance', 'you', False, False) |
