...
| Ты украла моё сердце. | FLIRT | flirt | None | ('FLIRT', 'flirt', 'target', False, False) |
...
| Давай я обниму тебя. | DIALOGUE | comfort | None | ('DIALOGUE', 'comfort', 'you', False, False) |
...
| Я помогу тебе, чем смогу. | DIALOGUE | comfort | None | ('DIALOGUE', 'comfort', 'you', False, False) |
...
| Ты можешь опереться на моё плечо. | DIALOGUE | build_rapport | None | ('DIALOGUE', 'build_rapport', 'player', False, False) |
...
| Не испытывай моё терпение. | THREATEN | intimidate | None | ('THREATEN', 'intimidate', 'player', False, False) |
...
| И? | DIALOGUE | neutral | None | ('DIALOGUE', 'neutral', '', False, False) |
