...
L = {
    ...
    # ── UI: Смерть ──
    "ui:death_title": "ВЫ МЕРТВЫ",  # noqa: F601
    "ui:death_subtitle": "Смерть необратима. Мир продолжает жить без вас.",  # noqa: F601
    # ── UI: Прочее ──
    "ui:narrator": "Рассказчик",  # noqa: F601
    # ── UI: Меню (ТЗ-6 C2) ──
    ...
    "ui:toggle_continuity_on": "Мир: Наследие (C)",
    "ui:end_screen_title": "Эпистемическая Оценка",
    "ui:end_screen_score": "Счёт",
    "ui:end_screen_secrets_found": "Секретов найдено",
    ...
    "ui:death_title": "ВЫ МЕРТВЫ",  # noqa: F601
    "ui:death_subtitle": "Смерть необратима. Мир продолжает жить без вас.",  # noqa: F601
    "ui:journal_title": "--- Журнал Диалогов (J) ---",  # noqa: F601
