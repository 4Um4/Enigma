...
# Полностью перезаписываем узлы безопасной, связной топологией
data["nodes"] = {
    "entrance": {
      "x": 8.0, "y": 11.5, "label": "Вход", "role": "entrance",
      "connections": ["main_hall_west", "corner_table"]
    },
    "main_hall_west": {
      "x": 6.0, "y": 8.0, "label": "Западный проход", "role": "default",
      "connections": ["entrance", "main_hall_south", "bar_area"]
    },
    "main_hall_south": {
      "x": 6.0, "y": 6.0, "label": "Юго-запад зала", "role": "default",
      "connections": ["main_hall_west", "main_hall"]
    },
    "main_hall": {
      "x": 8.0, "y": 6.0, "label": "Центр зала", "role": "default",
    ...
    "bar_area": {
      "x": 4.5, "y": 6.5, "label": "У стойки", "role": "bar",
      "connections": ["main_hall_west", "bar_west"]
    },
    "bar_west": {
      "x": 4.5, "y": 4.5, "label": "У южной стойки", "role": "default",
      "connections": ["bar_area", "bar_pass_north"]
    },
    "bar_pass_north": {
      "x": 2.5, "y": 6.0, "label": "Северный обход стойки", "role": "default",
      "connections": ["bar_west", "bar_side"]
    },
    "bar_side": {
      "x": 2.5, "y": 3.5, "label": "Обход стойки", "role": "default",
      "connections": ["bar_pass_north", "bar_pass_south"]
    },
    "bar_pass_south": {
      "x": 2.5, "y": 3.0, "label": "Южный обход стойки", "role": "default",
      "connections": ["bar_side", "behind_bar"]
    },
    "behind_bar": {
      "x": 4.0, "y": 3.0, "label": "За стойкой", "role": "inn_desk",
      "tags": ["workplace:tavern_keeper", "inn_desk"],
      "connections": ["bar_pass_south"]
    },
    "fireplace": {
    ...
    "right_table": {
      "x": 10.0, "y": 6.0, "label": "За правым столом", "role": "table",
...
print("[FIXED] tavern.json nodes fully overwritten with safe topology.")