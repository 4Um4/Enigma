...
_TOPIC_KEYWORDS: dict[str, str] = {
    "торговля": "торговля", "купить": "торговля", "продать": "торговля",
    "цена": "торговля", "монет": "торговля",
    "гильдия": "гильдия", "воры": "гильдия",
    "подвал": "подвал", "тайник": "тайник", "ход": "проход",
    "борко": "стража", "страж": "стража", "охран": "стража",
    "кузнец": "кузнец", "орм": "кузнец",
    "торнин": "таверна", "таверна": "таверна",
    "оружие": "оружие", "меч": "оружие", "лук": "оружие",
    "зелье": "зелья", "эликсир": "зелья",
    "квест": "задание", "работа": "задание", "доставка": "задание",
}
