# backend\tests\test_verbalization_chain copy.py
...
class TestTokenBudget:
    ...
    # Реальные лимиты: system(~200) + шаблон(~250) + секции(~1250) = ~1700
    MAX_PROMPT_CHARS = 1950   # system(~350) + шаблон(~250) + секции(~1350)
    MIN_PROMPT_CHARS = 750    # system(~350) + шаблон(~250) + MINOR пустой(~100)
