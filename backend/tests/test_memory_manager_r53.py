...
def test_run_decay_skips_before_interval() -> None:
    ...
    mm._working.push("camp_1:npc_01", EventMemory(
        event_type="combat", target_id="player", emotion_tag="neutral",
        day=1, importance=0.7, clarity=0.8, confidence=0.9,
        decay_rate=0.05, stage=MemoryStage.FRESH, summary="", npc_id="npc_01",
    ))
