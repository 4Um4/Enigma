...
def test_player_body_state_survives_save_load():
    ...
    real_dict = {
        ...
        "body_state": {
            ...
            "injuries": [
                {"target_zone": "chest", "structural_damage": 0.8, "damage_type": "slash"}
            ],
    ...
    assert saved_dict["perceptual_kernel"].get("initiative_suppression") == 0.6, "initiative_suppression потерян при save!"
