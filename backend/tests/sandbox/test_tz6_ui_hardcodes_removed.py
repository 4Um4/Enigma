...
from i18n import L, t, activity_ru
from constants import (
    RENDER_COLORS, AGGRESSION_COLORS, 
    COLOR_TEXT_DEFAULT, COLOR_DEATH_TITLE, COLOR_NARRATOR,
    FONT_NAME_MAIN, SCALE_PIXELS_PER_METER
)
...
REQUIRED_I18N_KEYS = [
    "ui:campaign_select_title", "ui:campaign_not_found", "ui:btn_back", "ui:btn_play",
    "ui:char_select_title", "ui:char_not_found", "ui:btn_create_char", "ui:btn_select",
    "ui:new_char_title", "ui:field_name", "ui:field_archetype", "ui:field_temperament",
    "ui:btn_create", "ui:btn_cancel", "ui:char_level",
    "ui:sys_binding", "ui:sys_system", "ui:male_unknown", "ui:female_unknown",
    "ui:unknown_speaker", "ui:death_title", "ui:death_subtitle", "ui:journal_title",
    "ui:journal_empty", "ui:narrator", "ui:npc_label", "ui:nothing_happened",
    "ui:going_to", "intent:observe", "intent:talk", "dir:north", "dir:south"
]
...
REQUIRED_CONSTANTS = [
    ...
    "RENDER_COLORS", "AGGRESSION_COLORS", "FONT_NAME_MAIN", "FONT_NAME_UI",
