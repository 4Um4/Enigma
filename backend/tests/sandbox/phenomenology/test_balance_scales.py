...
import pytest
from app.models.cfrm import CausalAxis, DisturbanceVector, FieldDisturbance
...
class TestPhysicalProjectionBalance:
    ...
    def test_energy_loss_is_exponential(self, calm_kernel):
        ...
        dist = FieldDisturbance(
            ...
            magnitude=2.0,
            vectors=(DisturbanceVector.KINETIC,),
            source_entity="s",
        )
...
class TestCognitiveProjectionBalance:
    ...
    def test_stress_amplifies_cognitive_signal(self):
        ...
        dist = FieldDisturbance(
            origin_cluster="c1",
            disturbance_type=CausalAxis.COGNITIVE,
            magnitude=0.5,
        ...
        assert p_stressed.perceived_intensity > p_calm.perceived_intensity, (
            "Стресс должен усиливать когнитивное восприятие угрозы"
        )
...
class TestSocialProjectionBalance:
    ...
    def test_intermediate_membrane_amplifies_rumor(self, calm_kernel):
        ...
        dist = FieldDisturbance(
            origin_cluster="c1",
            disturbance_type=CausalAxis.SOCIAL,
            magnitude=1.0,
            vectors=(DisturbanceVector.BEHAVIORAL,),
            source_entity="s",
