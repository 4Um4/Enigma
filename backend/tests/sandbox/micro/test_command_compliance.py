...
def test_command_pressure_crushes_attack_utility():
    ...
    pressure = PsychologicalPressure(fear=0.9, uncertainty=0.2, dominance_shift=0.8, directive_obedience=0.7)
    ...
    mock_scores = {"ATTACK": 1.0, "INTIMIDATE": 0.8, "FLEE": 0.5, "APPROACH": 0.4}
