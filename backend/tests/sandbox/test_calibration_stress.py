...
if __name__ == "__main__":
    ...
    print("TEST A (Recovery): 1000 threat → 49000 calm")
    ...
    # Нагрев
    for _ in range(1000):
        l3_stable, l3_prev_b, strain_b = engine_b.stabilize(
            EffectiveDrives.from_dict({"fear": 0.9, "control": 0.1}), l3_prev_b, L0, strain_b
        )
    for _ in range(5000):
        l3_stable, l3_prev_b, strain_b = engine_b.stabilize(EffectiveDrives.from_dict(L0), l3_prev_b, L0, strain_b)
    # Вторая травма
    ...
    print("TEST B (Re-trauma): 1000 threat → 5000 calm → 100 threat")
    ...
    print("TEST C (Noise Resistance): 10000 cycles (5 threat / 5 calm)")
    ...
    print("TEST D (Permanent Trauma): 100000 threat")
