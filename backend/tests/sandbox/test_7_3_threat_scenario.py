...
from app.models.npc_state import Intent, NPCPersonality, NPCState, NPCTier
...
def run_threat_scenario():
    ...
    l3_drives = EffectiveDrives(values={"fear": 0.75, "control": 0.60, "significance": 0.20, "desire": 0.10})
    ...
    result = hub.compute(state=state, personality=personality, event=event, effective_drives=l3_drives)
