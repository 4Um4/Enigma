...
### Frontend / UI
1. ❌ ~~**Полноценный Desktop UI**~~ — есть базовый Web UI, но требует доработки
2. ⚠️ ~~**Web-интерфейс**~~ — исправлен путь в main.py, исправлен HTML
...
| Web UI | ⚠️ Базовый | Исправлен путь в main.py и HTML |
...
1. ~~Исправить баги в index.html~~ ✅ Исправлено
2. Исправить путь к Frontend в main.py ✅ Исправлено
3. Добавить обработку команд (/roll, /clear, /help)
4. Добавить панель игроков (HP, инвентарь)
