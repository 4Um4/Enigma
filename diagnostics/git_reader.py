...
class GitInfo:
    ...
    mutations_last: List[str] = field(
        default_factory=list
    )  # последние 3 записи MUTATIONS.md
...
class GitReader:
    ...
    def read(self) -> GitInfo:
        ...
        info.current_architect_action = self._extract_current_action(
            info.mutations_last
        )
    ...
    def _read_mutations(self) -> List[str]:
        ...
        try:
            ...
            lines = self._mutations_path.read_text(
